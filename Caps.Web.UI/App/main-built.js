...
define('plugins/router',["durandal/system","durandal/app","durandal/activator","durandal/events","durandal/composition","plugins/history","knockout","jquery"],function(e,t,n,r,i,a,o,s){function l(e){return e=e.replace(b,"\\$&").replace(m,"(?:$1)?").replace(v,function(e,t){return t?e:"([^/]+)"}).replace(g,"(.*?)"),new RegExp("^"+e+"$",w?void 0:"i")}function u(e){var t=e.indexOf(":"),n=t>0?t-1:e.length;return e.substring(0,n)}function c(e,t){return-1!==e.indexOf(t,e.length-t.length)}function d(e,t){if(!e||!t)return!1;if(e.length!=t.length)return!1;for(var n=0,r=e.length;r>n;n++)if(e[n]!=t[n])return!1;return!0}function f(e){return e.queryString?e.fragment+"?"+e.queryString:e.fragment}var h,p,m=/\((.*?)\)/g,v=/(\(\?)?:\w+/g,g=/\*\w+/g,b=/[\-{}\[\]+?.,\\\^$|#\s]/g,y=/\/$/,w=!1,k=function(){function i(e,t){return e.router&&e.router.parent==t}function s(e){_&&_.config.isActive&&_.config.isActive(e)}function m(t,n){e.log("Navigation Complete",t,n);var r=e.getModuleId(S);r&&A.trigger("router:navigation:from:"+r),S=t,s(!1),_=n,s(!0);var a=e.getModuleId(S);a&&A.trigger("router:navigation:to:"+a),i(t,A)||A.updateDocumentTitle(t,n),E(!1),p.explicitNavigation=!1,p.navigatingBack=!1,A.trigger("router:navigation:complete",t,n,A)}function v(t,n){e.log("Navigation Cancelled"),A.activeInstruction(_),_&&A.navigate(f(_),!1),E(!1),p.explicitNavigation=!1,p.navigatingBack=!1,A.trigger("router:navigation:cancelled",t,n,A)}function g(t){e.log("Navigation Redirecting"),E(!1),p.explicitNavigation=!1,p.navigatingBack=!1,A.navigate(t,{trigger:!0,replace:!0})}function b(t,n,r){p.navigatingBack=!p.explicitNavigation&&S!=r.fragment,A.trigger("router:route:activating",n,r,A),t.activateItem(n,r.params).then(function(e){if(e){var a=S;if(m(n,r),i(n,A)){var o=r.fragment;r.queryString&&(o+="?"+r.queryString),n.router.loadUrl(o)}a==n&&(A.attached(),A.compositionComplete())}else t.settings.lifecycleData&&t.settings.lifecycleData.redirect?g(t.settings.lifecycleData.redirect):v(n,r);h&&(h.resolve(),h=null)}).fail(function(t){e.error(t)})}function w(t,n,r){var i=A.guardRoute(n,r);i?i.then?i.then(function(i){i?e.isString(i)?g(i):b(t,n,r):v(n,r)}):e.isString(i)?g(i):b(t,n,r):v(n,r)}function x(e,t,n){A.guardRoute?w(e,t,n):b(e,t,n)}function D(e){return _&&_.config.moduleId==e.config.moduleId&&S&&(S.canReuseForRoute&&S.canReuseForRoute.apply(S,e.params)||!S.canReuseForRoute&&S.router&&S.router.loadUrl)}function C(){if(!E()){var t=P.shift();P=[],t&&(E(!0),A.activeInstruction(t),D(t)?x(n.create(),S,t):e.acquire(t.config.moduleId).then(function(n){var r=e.resolveObject(n);x(T,r,t)}).fail(function(n){e.error("Failed to load routed module ("+t.config.moduleId+"). Details: "+n.message)}))}}function N(e){P.unshift(e),C()}function F(e,t,n){for(var r=e.exec(t).slice(1),i=0;i<r.length;i++){var a=r[i];r[i]=a?decodeURIComponent(a):null}var o=A.parseQueryString(n);return o&&r.push(o),{params:r,queryParams:o}}function I(t){A.trigger("router:route:before-config",t,A),e.isRegExp(t)?t.routePattern=t.route:(t.title=t.title||A.convertRouteToTitle(t.route),t.moduleId=t.moduleId||A.convertRouteToModuleId(t.route),t.hash=t.hash||A.convertRouteToHash(t.route),t.routePattern=l(t.route)),t.isActive=t.isActive||o.observable(!1),A.trigger("router:route:after-config",t,A),A.routes.push(t),A.route(t.routePattern,function(e,n){var r=F(t.routePattern,e,n);N({fragment:e,queryString:n,config:t,params:r.params,queryParams:r.queryParams})})}function M(t){if(e.isArray(t.route))for(var n=t.isActive||o.observable(!1),r=0,i=t.route.length;i>r;r++){var a=e.extend({},t);a.route=t.route[r],a.isActive=n,r>0&&delete a.nav,I(a)}else I(t);return A}var S,_,P=[],E=o.observable(!1),T=n.create(),A={handlers:[],routes:[],navigationModel:o.observableArray([]),activeItem:T,isNavigating:o.computed(function(){var e=T(),t=E(),n=e&&e.router&&e.router!=A&&e.router.isNavigating()?!0:!1;return t||n}),activeInstruction:o.observable(null),__router__:!0};return r.includeIn(A),T.settings.areSameItem=function(e,t,n,r){return e==t?d(n,r):!1},A.parseQueryString=function(e){var t,n;if(!e)return null;if(n=e.split("&"),0==n.length)return null;t={};for(var r=0;r<n.length;r++){var i=n[r];if(""!==i){var a=i.split("=");t[a[0]]=a[1]&&decodeURIComponent(a[1].replace(/\+/g," "))}}return t},A.route=function(e,t){A.handlers.push({routePattern:e,callback:t})},A.loadUrl=function(t){var n=A.handlers,r=null,i=t,o=t.indexOf("?");if(-1!=o&&(i=t.substring(0,o),r=t.substr(o+1)),A.relativeToParentRouter){var s=this.parent.activeInstruction();i=s.params.join("/"),i&&"/"==i.charAt(0)&&(i=i.substr(1)),i||(i=""),i=i.replace("//","/").replace("//","/")}i=i.replace(y,"");for(var l=0;l<n.length;l++){var u=n[l];if(u.routePattern.test(i))return u.callback(i,r),!0}return e.log("Route Not Found"),A.trigger("router:route:not-found",t,A),_&&a.navigate(f(_),{trigger:!1,replace:!0}),p.explicitNavigation=!1,p.navigatingBack=!1,!1},A.updateDocumentTitle=function(e,n){n.config.title?document.title=t.title?n.config.title+" | "+t.title:n.config.title:t.title&&(document.title=t.title)},A.navigate=function(e,t){return e&&-1!=e.indexOf("://")?(window.location.href=e,!0):(p.explicitNavigation=!0,a.navigate(e,t))},A.navigateBack=function(){a.navigateBack()},A.attached=function(){A.trigger("router:navigation:attached",S,_,A)},A.compositionComplete=function(){E(!1),A.trigger("router:navigation:composition-complete",S,_,A),C()},A.convertRouteToHash=function(e){if(A.relativeToParentRouter){var t=A.parent.activeInstruction(),n=t.config.hash+"/"+e;return a._hasPushState&&(n="/"+n),n=n.replace("//","/").replace("//","/")}return a._hasPushState?e:"#"+e},A.convertRouteToModuleId=function(e){return u(e)},A.convertRouteToTitle=function(e){var t=u(e);return t.substring(0,1).toUpperCase()+t.substring(1)},A.map=function(t,n){if(e.isArray(t)){for(var r=0;r<t.length;r++)A.map(t[r]);return A}return e.isString(t)||e.isRegExp(t)?(n?e.isString(n)&&(n={moduleId:n}):n={},n.route=t):n=t,M(n)},A.buildNavigationModel=function(t){for(var n=[],r=A.routes,i=t||100,a=0;a<r.length;a++){var o=r[a];o.nav&&(e.isNumber(o.nav)||(o.nav=++i),n.push(o))}return n.sort(function(e,t){return e.nav-t.nav}),A.navigationModel(n),A},A.mapUnknownRoutes=function(t,n){var r="*catchall",i=l(r);return A.route(i,function(o,s){var l=F(i,o,s),u={fragment:o,queryString:s,config:{route:r,routePattern:i},params:l.params,queryParams:l.queryParams};if(t)if(e.isString(t))u.config.moduleId=t,n&&a.navigate(n,{trigger:!1,replace:!0});else if(e.isFunction(t)){var c=t(u);if(c&&c.then)return c.then(function(){A.trigger("router:route:before-config",u.config,A),A.trigger("router:route:after-config",u.config,A),N(u)}),void 0}else u.config=t,u.config.route=r,u.config.routePattern=i;else u.config.moduleId=o;A.trigger("router:route:before-config",u.config,A),A.trigger("router:route:after-config",u.config,A),N(u)}),A},A.reset=function(){return _=S=void 0,A.handlers=[],A.routes=[],A.off(),delete A.options,A},A.makeRelative=function(t){return e.isString(t)&&(t={moduleId:t,route:t}),t.moduleId&&!c(t.moduleId,"/")&&(t.moduleId+="/"),t.route&&!c(t.route,"/")&&(t.route+="/"),t.fromParent&&(A.relativeToParentRouter=!0),A.on("router:route:before-config").then(function(e){t.moduleId&&(e.moduleId=t.moduleId+e.moduleId),t.route&&(e.route=""===e.route?t.route.substring(0,t.route.length-1):t.route+e.route)}),A},A.createChildRouter=function(){var e=k();return e.parent=A,e},A};return p=k(),p.explicitNavigation=!1,p.navigatingBack=!1,p.makeRoutesCaseSensitive=function(){w=!0},p.targetIsThisWindow=function(e){var t=s(e.target).attr("target");return!t||t===window.name||"_self"===t||"top"===t&&window===window.top?!0:!1},p.activate=function(t){return e.defer(function(n){if(h=n,p.options=e.extend({routeHandler:p.loadUrl},p.options,t),a.activate(p.options),a._hasPushState)for(var r=p.routes,i=r.length;i--;){var o=r[i];o.hash=o.hash.replace("#","")}s(document).delegate("a","click",function(e){if(a._hasPushState){if(!e.altKey&&!e.ctrlKey&&!e.metaKey&&!e.shiftKey&&p.targetIsThisWindow(e)){var t=s(this).attr("href");null==t||"#"===t.charAt(0)||/^[a-z]+:/i.test(t)||(p.explicitNavigation=!0,e.preventDefault(),a.navigate(t))}}else p.explicitNavigation=!0}),a.options.silent&&h&&(h.resolve(),h=null)}).promise()},p.deactivate=function(){a.deactivate()},p.install=function(){o.bindingHandlers.router={init:function(){return{controlsDescendantBindings:!0}},update:function(e,t,n,r,a){var s=o.utils.unwrapObservable(t())||{};if(s.__router__)s={model:s.activeItem(),attached:s.attached,compositionComplete:s.compositionComplete,activate:!1};else{var l=o.utils.unwrapObservable(s.router||r.router)||p;s.model=l.activeItem(),s.attached=l.attached,s.compositionComplete=l.compositionComplete,s.activate=!1}i.compose(e,s,a)}},o.virtualElements.allowedBindings.router=!0},p});
//! moment.js
//! version : 2.4.0
...
define('modules/contentfile/viewmodels/detail',["durandal/system","durandal/app","knockout","../module","../datacontext","moment","infrastructure/utils","infrastructure/tagService"],function(e,t,n,r,i,a,o,s){function l(){return e.defer(function(e){c(!0),i.fetchFile(u()).then(function(){d(i.localGetFile(u())),e.resolve(d())}).fail(e.fail).done(function(){c(!1)})}).promise()}var u=n.observable(0),d=n.observable(),c=n.observable(!1),f=n.observable(),h=n.observable(!1),p={fileId:u,file:d,isLoading:c,activate:function(e){return d(null),u(e),f(null),h(!1),l().fail(function(e){alert(e.message)})},refresh:function(){return l()},navigateBack:function(){r.router.navigate(r.routeConfig.hash)},previewTemplate:function(e){return e&&e.isImage()?"file-preview-image":"file-preview-general"},addTagUIVisible:h,tagNames:n.computed(function(){return n.utils.arrayMap(s.tags(),function(e){return e.Name()})}),tagName:f,addTag:function(){h(!0);var e=f();e&&e.length&&s.getOrCreateTag(e).then(function(e){return i.addFileTag(d(),e)}).fail(function(e){window.alert(e.message||e.responseText)}).done(function(){t.trigger("caps:tag:added",f()),f("")})},cancelAddTag:function(){f(null),h(!1)},updateTagName:function(e,t,n){f(n.value)},removeTag:function(e){i.removeFileTag(d(),e).then(function(e){var r=n.utils.arrayFilter(e.entities,function(e){return"Tag"==e.entityType.shortName});n.utils.arrayForEach(r,function(e){t.trigger("caps:tag:deleted",e)})}).fail(function(){alert(err.message||err.responseText)}).done(function(){t.trigger("caps:tag:removed",e)})},moment:a,utils:o};return p});
...
define('modules/contentfile/viewmodels/index',["ko","durandal/system","durandal/app","../module","../datacontext","infrastructure/virtualListModel","infrastructure/filterModel","infrastructure/listSortModel","jquery","toastr","Q","doubleTap","infrastructure/tagService","./fileListItem","./uploadManager","./fileSearchControl"],function(e,t,n,i,a,o,s,l,u,d,c,f,h,p,m,v){function g(e){var n=S;return console.log("loadPage called. pageNumber="+e+", Filter="+n.currentFilter),t.defer(function(t){D(!0),a.searchFiles(n.searchWords(),e,x.itemsPerPage(),n.sortOptions.getOrderBy(),n.currentFilter).then(function(n){x.addPage(n,e),t.resolve()}).fail(t.reject).done(function(){D(!1)})}).promise()}function b(e){function t(){x.selectedItem()===e&&x.resetSelection(),x.removeItem(e)}function n(){dialog.showMessage("Die Datei konnte nicht gelöscht werden.","Nicht erfolgreich")}return a.deleteFile(e.data()).then(t).fail(n)}function y(){return new m({uploadStarted:function(e,t){e.listItem=x.insertItem(void 0,t),e.listItem.isUploading(!0)},uploadDone:function(e,t){var n=t.listItem;a.fetchFile(e.Id).then(function(){n.data(a.localGetFile(e.Id)),n.isUploading(!1)}).fail(function(){d.error("Die Datei "+r.FileName+" konnte nicht geladen werden.")})}})}var w,k=!1,x=new o.VirtualList(35,null,p),D=e.observable(!1),C=y(),N=e.observable(!1),F=e.observable(0),S=new v;return i.router.on("router:navigation:attached",function(e){e==w&&N(!0)}),n.on("caps:tags:added",function(e){S.addTagFilter(e)}),n.on("caps:tag:deleted",function(e){S.removeTagFilter(e)}),S.refreshResults=function(){w.refresh()},w={list:x,isLoading:D,uploadManager:C,selectedFile:x.selectedItem,selectedFiles:x.selectedItems,scrollTop:F,isInteractive:N,searchControl:S,activate:function(){k||(k=!0,g(1))},deactivate:function(){N(!1)},deleteFile:function(e){var t="Datei löschen",r="Abbrechen";n.showMessage("Soll die Datei "+e.data().FileName()+" wirklich gelöscht werden?","Datei löschen",[t,r]).then(function(n){n===t&&b(e)})},deleteSelection:function(){var t=this.selectedFiles();if(0!==t.length){if(1==t.length)return this.deleteFile(t[0]);var r="Auswahl löschen";n.showMessage("Sollen die "+t.length+" ausgewählten Dateien wirklich endgültig gelöscht werden?","Auswahl löschen",[r,"Abbrechen"]).then(function(n){if(n===r){x.suspendEvents=!0;var i=e.utils.arrayMap(t,function(e){return b(e)});c.all(i).then(function(){x.suspendEvents=!1,x.raiseItemsChanged()})}})}},refresh:function(){F(0),x.resetSelection(),x.removeAll(),g(1)},resetSelectedItem:function(){x.resetSelection()},showSelectedFile:function(){this.showDetail(x.selectedItem())},showDetail:function(e){e&&(x.selectItem(e),i.router.navigate("#files/detail/"+e.data().Id()))},loadHandler:function(e,t){function n(e){var n=x.findPage(e);n.isLoaded||n.isLoading||(x.markPageLoading(e),g(e).then(function(){x.markPageLoaded(e),t.pageLoaded(e)}))}if(console.log("loadHandler called. First visible: "+t.firstVisible.index+" (Page #"+t.firstVisible.page+"); Last visible: "+t.lastVisible.index+" (Page #"+t.lastVisible.page+")"),N()){var r=t.firstVisible.viewModel?x.findItemPage(t.firstVisible.viewModel):void 0,i=t.lastVisible.viewModel?x.findItemPage(t.lastVisible.viewModel):void 0;if(r&&i)for(var a=r.index;a<=i.index;a++)n(a+1)}}}});
...
define('modules/draft/viewmodels/editor',["durandal/app","durandal/system","../module","../datacontext","../entities","entityManagerProvider","breeze","ko","Q","./editor/navigation","./editor/draftTemplate","./editor/draftProperties","./editor/draftFiles","./editor/contentPartEditor","./editor/templateEditor","./editor/draftNotes","./editorModel","authentication"],function(e,t,n,r,i,a,o,s,l,u,c,d,f,h,p,m,v,g){function b(){function l(e,t){t=t||"de",r.getTemplate(e).then(function(n){var r=n,i=T.createEntity("Draft",{TemplateName:e,Version:1,OriginalLanguage:t,Status:"NEW"});i.Template(JSON.stringify(r)),i.Created().At(new Date),i.Created().By(g.user().userName()),i.Modified().At(new Date),i.Modified().By(g.user().userName()),_.entity(i);for(var a=0;a<r.rows.length;a++)for(var o=r.rows[a],s=0;s<o.cells.length;s++){var l=o.cells[s],u=_.getOrCreateContentPart(l);l.content&&u.getResource("de").Content(l.content)}})}function v(e){var t=o.EntityQuery.from("Drafts").where("Id","==",e).expand("ContentParts.Resources, Files.Resources.FileVersion.File");return T.executeQuery(t).then(function(e){_.entity(e.results[0])})}function b(){_.entity().setDeleted(),T.saveChanges().then(_.navigateBack)}function y(){C=C||new u(_);var e=P.activeInstruction().queryParams;if(e&&e.t)if("DraftProperties"===e.t)_.showProperties();else if("DraftFiles"===e.t)_.showFiles();else{var t=_.entity().findContentPart(e.t);t&&_.showContentPartEditor(t)}_.currentContent()||(F=F||new c(_),_.currentContent(F)),_.currentNavigation(C)}function w(){var e=_.entity();e&&(k(),e.entityAspect.propertyChanged.subscribe(x))}function k(){var e=_.entity();e&&_.template(e.deserializeTemplate())}function x(){n.routeConfig.hasUnsavedChanges(T.hasChanges())}function D(e){var t=s.utils.arrayFirst(E,function(t){return t.contentPart===e});return t||(t=new h(_,e),E.push(t)),t}var C,F,N,S,M,I,_=this,T=a.createManager(),E=[],P=n.router;_.currentContent=s.observable(),_.currentNavigation=s.observable(),_.entity=s.observable(),_.entity.subscribe(w),_.template=s.observable(),_.isNewDraft=s.observable(!1),_.draftStates=i.supportedDraftStates,_.activate=function(e){return t.defer(function(t){e&&/^[0-9]+$/.test(e)?v(e).then(function(){y(),t.resolve()}):(_.isNewDraft(!0),l(e),y(),t.resolve())}).promise()},_.shouldActivate=function(e,t,n){return t[0]!==n[0]},_.showEditorMain=function(){F=F||new c(_),_.currentContent(F)},_.showFiles=function(){N=N||new f(_),_.currentContent(N)},_.showProperties=function(){S=S||new d(_),_.currentContent(S)},_.showContentPartEditor=function(e){var t=D(e);t&&_.currentContent(t)},_.showTemplateEditor=function(){M=M||new p(_),_.currentContent(M)},_.showDraftNotes=function(){I=I||new m(_),_.currentContent(I)},_.navigateBack=function(){return!_.currentContent()||"ContentPartEditor"!==_.currentContent().name&&"TemplateEditor"!==_.currentContent().name?(_.showDraftsIndex(),void 0):(_.showEditorMain(),void 0)},_.showDraftsIndex=function(){n.routeConfig.hasUnsavedChanges(!1),n.router.navigate(n.routeConfig.hash)},_.saveChanges=function(){_.entity().Modified().At(new Date),_.entity().Modified().By(g.user().userName()),T.saveChanges().then(function(){e.trigger("caps:draft:saved",{entity:_.entity(),isNewDraft:_.isNewDraft()}),_.showDraftsIndex()})},_.deleteDraft=function(){var t="Entwurf löschen",n="Abbrechen";e.showMessage("Soll der Entwurf wirklich gelöscht werden?","Entwurf löschen",[t,n]).then(function(e){e===t&&b()})},_.getOrCreateContentPart=function(e){var t=_.entity().findContentPart(e.name);if(!t){t=T.createEntity("DraftContentPart",{DraftId:_.entity().Id(),Name:e.name,ContentType:e.contentType||"markdown"}),T.addEntity(t);var n=T.createEntity("DraftContentPartResource",{DraftContentPartId:_.entity().Id(),Language:"de",Content:""});T.addEntity(n),t.Resources.push(n),_.entity().ContentParts.push(t)}return t},_.createDraftFile=function(e){var t=o.EntityQuery.from("Files").where("Id","==",e.Id()).expand("Versions.File");return T.executeQuery(t).then(function(t){var n=t.results[0],r=T.createEntity("DraftFile",{Name:e.FileName()});T.addEntity(r);var i=T.createEntity("DraftFileResource",{Language:"de",DbFileVersionId:n.latestVersion().Id()});return T.addEntity(i),r.Resources.push(i),r.DraftId(_.entity().Id()),_.entity().Files.push(r),r})}}return b});
...
define('modules/draft/viewmodels/templateGallery',["ko","../datacontext","../module","breeze","entityManagerProvider","durandal/system"],function(e,t,n,r,i,a){function o(e,t,n){this.title=e,this.name=t,this.template=n}function s(){return a.defer(function(n){var r=t.getTemplates();l().then(function(t){var i=e.utils.arrayMap(t,function(e){var t=u(e.TemplateContent());return new o(e.Name(),e.Name(),t)}),a=e.utils.arrayMap(r,function(e){return new o(e.name,e.name,e)}),s=a.concat(i);c(s),n.resolve()}).fail(n.reject)})}function l(){var e=(new d).from("Websites").expand("DraftTemplates");return f.executeQuery(e).then(function(e){return e.results[0].DraftTemplates()})}function u(e){var t;try{t=JSON.parse(e)}catch(n){a.log(n.message)}return t}var c=e.observableArray(),d=r.EntityQuery,f=i.createManager();return{activate:function(){s()},listItems:c,createDraft:function(e){n.router.navigate("#drafts/create/"+e.name)},cancel:function(){n.router.navigate("#drafts")}}});
...
define('modules/sitemap/viewmodels/index',["../module","ko","infrastructure/datacontext","plugins/router","entityManagerProvider","breeze","durandal/system","durandal/app","localization","infrastructure/contentReferences","infrastructure/urlHelper","infrastructure/treeViewModel","moment","./siteMapViewModel"],function(e,t,n,r,i,a,o,s,l,u,c,d,f,h){function p(e){g(e)&&y(e.Id()).then(function(){D()&&D().refreshTree(),m()})}function m(){if(N(null),F()&&F().ContentId()){var e=(new x).from("Publications").where("Id","==",F().ContentId()).expand("ContentParts.Resources, Files.Resources.FileVersion.File");k.executeQuery(e).then(function(){var e=new w(F());N(e)}).fail(function(e){alert(e.message)})}}function v(e){return t.utils.arrayFirst(_.sitemaps(),function(t){return t.entity()===e})}function g(e){var t=D();return e&&t&&e.SiteMapId()===t.entity().Id()}function b(){var e=(new x).from("Websites").expand("SiteMapVersions").take(1);return k.executeQuery(e)}function y(e){var t=(new x).from("SiteMapNodes").where("Id","==",e).expand("Resources");return k.executeQuery(t)}function w(e){var n=this;n.sitemapNode=e,n.template=t.observable(),e&&e.Content()&&n.template(e.Content().template()),n.findContentPart=function(e){if(F()&&F().Content()){var t=F().Content().getContentPart(e.name);if(t){var n=F().Content(),r=t.getResource("de").Content();return S.replaceReferences(n,r,"de")}}return""}}var k=i.createManager(),x=a.EntityQuery,C=t.observable(),D=t.observable(),F=t.observable(),N=t.observable(),M=l.website.supportedTranslations(),I=!1,S=new u({replaceFileReference:function(e,t){var n=e.context,r=n.findFile(e.fileName),i=r.getResource(t),a=null!==i?i.FileVersion():void 0;return c.getFileUrl(e.fileName,a,e.query)},replacePublicationReference:function(e,t){return c.getPublicationUrl(e.id,t,e.query)}});D.subscribe(function(e){F(null),e&&e.fetchTree().then(function(){e.entity().rootNodes().length&&e.selectNodeByKey(e.entity().rootNodes()[0].Id())})}),F.subscribe(m),s.on("caps:sitemapnode:saved",function(e){g(e)&&y(e.Id())}),s.on("caps:publication:created",p),s.on("caps:publication:refreshed",p);var _={website:C,sitemaps:t.computed(function(){var e=C()?C().sortedSiteMapVersions():[];return t.utils.arrayMap(e,function(e){var t=new h(e,k);return t.selectedNodeChanged=function(e){e&&F(e.entity())},t})}),selectedSitemap:D,selectedNode:F,supportedTranslations:M,contentPreview:N,activate:function(){I||(I=!0,b().then(function(e){C(e.results[0]),D(v(C().latestSitemap()))}))},createSitemapVersion:function(){function e(e){var t=e.createEntity("DbSiteMap",{WebsiteId:C().Id(),Version:n}),r=e.createEntity("DbSiteMapNode",{NodeType:"ROOT",Name:"HOME"}),i=r.getOrCreateResource("de",e);return r.SiteMapId(t.Id()),i.Title("Startseite"),e.addEntity(r),t}try{if(C()){var t=C().latestSitemap(),n=t?t.Version()+1:1,r=t?t.createNewVersion(n,k):e(k);k.saveChanges().then(function(){D(v(r))}).fail(function(e){o.log(e)})}}catch(i){alert(i.message)}},deleteSitemapVersion:function(){var e=D().entity();if(e){var t=e.nextVersion()||e.previousVersion();try{e.setDeleted(),D(v(t))}catch(n){alert("Die Version konnte nicht gelöscht werden.")}k.saveChanges().fail(function(e){alert(e.message)})}},publishSitemapVersion:function(){D().entity().PublishedFrom(new Date),D().entity().PublishedBy("me"),k.saveChanges()},createSitemapNode:function(){var e=D();if(e&&F()){var t=k.createEntity("DbSiteMapNode",{NodeType:"PAGE"});k.addEntity(t),t.ParentNodeId(F().Id()),t.SiteMapId(e.entity().Id());var n=t.getOrCreateResource("de",k);n.Title("Seite "+(new Date).toLocaleTimeString()),k.saveChanges().then(function(){e.refreshTree(),e.selectNodeByKey(t.Id())}).fail(function(e){alert(e.message)})}},deleteSitemapNode:function(){function e(e){return e.setDeleted(),k.saveChanges()}var t=D();if(t&&F()){var n="Seite löschen",r="Abbrechen";s.showMessage("Soll die Seite wirklich gelöscht werden?","Seite löschen",[n,r]).then(function(r){if(r===n){var i=F(),a=i.nextNode()||i.previousNode()||i.ParentNode();e(i).then(function(){t.refreshTree(),a&&t.selectNodeByKey(a.Id())}).fail(function(e){alert(e.message)})}})}},editWebsite:function(){r.navigate("#website")},editTranslation:function(t){F()&&e.router.navigate("#sitemap/translate/"+F().Id()+"/"+t.culture)},editSitemapNode:function(){F()&&e.router.navigate("#sitemap/edit/"+F().Id())},moveSelectedNodeUp:function(){F()&&(F().moveUp(),k.saveChanges().then(function(){D()&&D().refreshTree()}))},moveSelectedNodeDown:function(){F()&&(F().moveDown(),k.saveChanges().then(function(){D()&&D().refreshTree()}))},moveSelectedNode:function(){function t(e){return e.Id()!==F().Id()}if(D()){var n=D(),r=F();s.selectSiteMapNode({module:e,nodeFilter:t,siteMapId:n.entity().Id(),canSelectSiteMap:!1}).then(function(e){e.dialogResult&&e.selectedNode&&e.selectedNode.Id()!==r.ParentNodeId()&&(r.reparent(e.selectedNode),k.saveChanges().then(function(){n.refreshTree(),n.tree().selectedNode().ensureVisible()}))})}},doTest1:function(){e.router.navigate("#sitemap/test1")}};return _});
