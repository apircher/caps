...
define('modules/contentfile/viewmodels/index',["ko","durandal/system","durandal/app","../module","../datacontext","infrastructure/virtualListModel","infrastructure/filterModel","infrastructure/listSortModel","jquery","toastr","Q","doubleTap","infrastructure/tagService","./fileListItem","./uploadManager","./fileSearchControl","infrastructure/serverUtil","./fileUploadDialog"],function(e,t,n,i,a,o,s,l,c,d,u,f,h,p,m,v,g,b){function y(e){var n=M;return console.log("loadPage called. pageNumber="+e+", Filter="+n.currentFilter),t.defer(function(t){D(!0),a.searchFiles(n.searchWords(),e,S.itemsPerPage(),n.sortOptions.getOrderBy(),n.currentFilter).then(function(n){S.addPage(n,e),t.resolve()}).fail(t.reject).done(function(){D(!1)})}).promise()}function w(e){function t(){S.selectedItem()===e&&S.resetSelection(),S.removeItem(e)}function r(){n.showMessage("Die Datei konnte nicht gelöscht werden.","Nicht erfolgreich")}return a.deleteFile(e.data()).then(t).fail(r)}function k(){return new m({beforeUpload:function(t,r,i){var o=e.utils.arrayMap(t,function(e){return e.name});a.getFileInfo(o).then(function(t){var r=e.utils.arrayFilter(t,function(e){return e.count>0});if(r.length>0){var a=new b(t);n.showDialog(a).then(function(e){e&&i(e)})}else i()})},uploadStarted:function(e,t,n){var r=n&&"replace"===n.storageAction;r||(e.listItem=S.insertItem(void 0,t),e.listItem.isUploading(!0))},uploadDone:function(e,t){var n=t.listItem||S.findItem(function(t){return t.data()&&t.data().Id()===e.id});a.fetchFile(e.id).then(function(){n&&(n.data(a.localGetFile(e.id)),n.isUploading(!1))}).fail(function(){d.error("Die Datei "+r.FileName+" konnte nicht geladen werden.")})}})}var x,N=!1,S=new o.VirtualList(35,null,p),D=e.observable(!1),C=k(),I=e.observable(!1),F=e.observable(0),M=new v;return i.router.on("router:navigation:attached",function(e){e==x&&I(!0)}),n.on("caps:tags:added",function(e){M.addTagFilter(e)}),n.on("caps:tag:deleted",function(e){M.removeTagFilter(e)}),n.on("caps:file:deleted",function(e){var t=S.findItem(function(t){return t.data().Id()==e.Id()});t&&(S.selectedItem()===t&&S.resetSelection(),S.removeItem(t))}),M.refreshResults=function(){x.refresh()},x={list:S,isLoading:D,uploadManager:C,selectedFile:S.selectedItem,selectedFiles:S.selectedItems,scrollTop:F,isInteractive:I,searchControl:M,server:g,activate:function(){N||(N=!0,y(1))},deactivate:function(){I(!1)},deleteFile:function(e){var t="Datei löschen",r="Abbrechen";n.showMessage("Soll die Datei "+e.data().FileName()+" wirklich gelöscht werden?","Datei löschen",[t,r]).then(function(n){n===t&&w(e)})},deleteSelection:function(){var t=this.selectedFiles();if(0!==t.length){if(1==t.length)return this.deleteFile(t[0]);var r="Auswahl löschen";n.showMessage("Sollen die "+t.length+" ausgewählten Dateien wirklich endgültig gelöscht werden?","Auswahl löschen",[r,"Abbrechen"]).then(function(n){if(n===r){S.suspendEvents=!0;var i=e.utils.arrayMap(t,function(e){return w(e)});u.all(i).then(function(){S.suspendEvents=!1,S.raiseItemsChanged()})}})}},refresh:function(){F(0),S.resetSelection(),S.removeAll(),y(1)},resetSelectedItem:function(){S.resetSelection()},showSelectedFile:function(){this.showDetail(S.selectedItem())},showDetail:function(e){e&&(S.selectItem(e),i.router.navigate("#files/detail/"+e.data().Id()))},loadHandler:function(e,t){function n(e){var n=S.findPage(e);n.isLoaded||n.isLoading||(S.markPageLoading(e),y(e).then(function(){S.markPageLoaded(e),t.pageLoaded(e)}))}if(console.log("loadHandler called. First visible: "+t.firstVisible.index+" (Page #"+t.firstVisible.page+"); Last visible: "+t.lastVisible.index+" (Page #"+t.lastVisible.page+")"),I()){var r=t.firstVisible.viewModel?S.findItemPage(t.firstVisible.viewModel):void 0,i=t.lastVisible.viewModel?S.findItemPage(t.lastVisible.viewModel):void 0;if(r&&i)for(var a=r.index;a<=i.index;a++)n(a+1)}}}});
