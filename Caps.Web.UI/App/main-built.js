...
define('modules/sitemap/viewmodels/siteMapViewModel',["ko","moment","breeze","durandal/system","infrastructure/treeViewModel","../datacontext"],function(e,t,n,r,i,a){function o(n){var r=this;r.entity=e.observable(n),r.tree=e.observable(),r.publishedFromNow=e.computed(function(){return t.utc(r.entity().PublishedFrom()).fromNow()}),r.title=e.computed(function(){return"Version "+r.entity().Version()})}return n.EntityQuery,o.prototype.fetchTree=function(){var e=this;return r.defer(function(t){a.fetchSiteMapNodes(e.entity().Id()).then(function(){e.buildTree(),t.resolve()}).fail(t.reject)}).promise()},o.prototype.buildTree=function(){function t(n,r){e.utils.arrayForEach(r,function(e){var r=a.createNode();r.entity(e),n.addChildNode(r),t(r,e.childNodes())})}var n=this,r=n.entity(),a=new i.TreeViewModel;a.keyName("Id"),t(a.root,r.rootNodes()),a.expandRootNodes(),a.selectedNode.subscribe(function(){n.selectedNodeChanged.call(n,a.selectedNode())}),n.tree(a)},o.prototype.selectedNodeChanged=function(){},o.prototype.refreshTree=function(){var e=this.entity(),t=[];this.tree()&&(t=this.tree().saveState()),this.buildTree(e),this.tree()&&t&&this.tree().restoreState(t)},o.prototype.selectNodeByKey=function(e){this.tree()&&this.tree().selectNodeByKey(e)},o.prototype.selectRootNode=function(){if(this.tree()){var e=this.tree().rootNodes(),t=e.length?e[0]:void 0;t&&this.tree().selectedNode(t)}},o.prototype.containsNode=function(e){return e&&this.entity().containsNode(e)},o});
define('modules/sitemap/viewmodels/publicationViewModel',["ko","infrastructure/contentReferences","infrastructure/urlHelper"],function(e,t,n){function r(t){var n=this,r=null!=t?t.Content():null;n.publication=r,n.template=e.observable(r?r.template():null),n.files=e.computed(function(){return r?r.Files():[]}),n.findContentPart=function(e){if(r){var t=r.getContentPart(e.name);if(t){var n=t.getResource("de").Content();return i.replaceReferences(r,n,"de")}}return""}}var i=new t({replaceFileReference:function(e,t){var r=e.context,i=r.findFile(e.fileName),a=i.getResource(t),o=null!==a?a.FileVersion():void 0;return n.getFileUrl(e.fileName,o,e.query)},replacePublicationReference:function(e,t){return n.getPublicationUrl(e.id,t,e.query)}});return r});
define('modules/sitemap/viewmodels/index',["../module","ko","plugins/router","durandal/system","durandal/app","localization","./siteMapViewModel","./publicationViewModel","infrastructure/publicationService","authentication","../datacontext"],function(e,t,n,r,i,a,o,s,l,u,c){function d(e){v(e)&&c.fetchSiteMapNode(e.Id()).then(function(){y()&&y().refreshTree(),p()})}function f(e){w(null),e&&e.fetchTree().then(function(){e.selectRootNode()})}function p(){k(null),w()&&w().ContentId()&&c.fetchPublication(w().ContentId()).then(function(){var e=new s(w());k(e)}).fail(g)}function h(e){var n=t.utils.arrayFirst(D.siteMapVersions(),function(t){return t.entity()===e});y(n)}function m(e){var t=new o(e);return t.selectedNodeChanged=function(e){e&&w(e.entity())},t}function v(e){return y()&&y().containsNode(e)}function g(e){r.log(e.message),alert(e.message)}var b=t.observable(),y=t.observable(),w=t.observable(),k=t.observable(),x=a.website.supportedTranslations(),C=!1;y.subscribe(f),w.subscribe(p),i.on("caps:sitemapnode:saved",function(e){v(e)&&c.fetchSiteMapNode(e.Id())}),i.on("caps:publication:created",d),i.on("caps:publication:refreshed",d);var D={website:b,siteMapVersions:t.computed(function(){var e=b()?b().sortedSiteMapVersions():[];return t.utils.arrayMap(e,m)}),selectedSiteMap:y,selectedNode:w,selectedPublication:k,teasers:t.computed(function(){return w()?t.utils.arrayFilter(w().childNodes(),function(e){return"teaser"===e.NodeType().toLowerCase()}):[]}),supportedTranslations:x,activate:function(){C||(C=!0,c.fetchFirstWebsite().then(function(e){b(e.results[0]),h(b().latestSiteMap())}).fail(g))},createSiteMapVersion:function(){c.createNewSiteMapVersion(b()).then(h).fail(g)},deleteSiteMapVersion:function(){var e="Sitemap-Version verwerfen",t="Abbrechen",n=y().entity();n&&i.showMessage("Soll diese Version wirklich verworfen werden?","Sitemap-Version verwerfen?",[e,t]).then(function(t){if(t===e){var r=n.nextVersion()||n.previousVersion();h(r),c.deleteSiteMapVersion(n).fail(g)}})},publishSiteMapVersion:function(){c.publishSiteMap(y().entity(),u.user().userName())},createSiteMapNode:function(){y()&&w()&&c.createSiteMapNode(y().entity(),w()).then(function(e){siteMap.refreshTree(),siteMap.selectNodeByKey(e.Id())}).fail(g)},deleteSiteMapNode:function(){var e=y();if(e&&w()){var t="Seite löschen",n="Abbrechen";i.showMessage("Soll die Seite wirklich gelöscht werden?","Seite löschen",[t,n]).then(function(n){if(n===t){var r=w(),i=r.nextNode()||r.previousNode()||r.ParentNode();c.deleteSiteMapNode(r).then(function(){e.refreshTree(),i&&e.selectNodeByKey(i.Id())}).fail(g)}})}},editWebsite:function(){n.navigate("#website")},editTranslation:function(t){w()&&e.router.navigate("#sitemap/translate/"+w().Id()+"/"+t.culture)},editSiteMapNode:function(){w()&&e.router.navigate("#sitemap/edit/"+w().Id())},moveSelectedNodeUp:function(){w()&&(w().moveUp(),c.saveChanges().then(function(){y()&&y().refreshTree()}))},moveSelectedNodeDown:function(){w()&&(w().moveDown(),c.saveChanges().then(function(){y()&&y().refreshTree()}))},moveSelectedNode:function(){function t(e){return!e.isTeaser()&&e.Id()!==w().Id()}if(y()){var n=y(),r=w();i.selectSiteMapNode({module:e,nodeFilter:t,siteMapId:n.entity().Id(),canSelectSiteMap:!1}).then(function(e){e.dialogResult&&e.selectedNode&&e.selectedNode.Id()!==r.ParentNodeId()&&(r.reparent(e.selectedNode),c.saveChanges().then(function(){n.refreshTree(),n.tree().selectedNode().ensureVisible()}))})}},createTeaser:function(){if(w()){var e=y().entity().Id(),t=y().tree().root.childNodes()[0].entity().Id();l.createTeaser(e,t,w().Id())}},canCreateTeaser:function(){return w()?"ROOT"==w().NodeType()||w().hasTeasers()?!1:!0:!1}};return D});
