...
define('modules/contentfile/viewmodels/detail',["durandal/system","durandal/app","knockout","../module","../datacontext","moment","infrastructure/utils","infrastructure/tagService","infrastructure/serverUtil","durandal/composition","moment","./uploadManager"],function(e,t,n,r,i,a,o,s,l,c,a,d){function u(){return e.defer(function(e){b(!0),i.fetchFile(p()).then(function(){v(i.localGetFile(p())),e.resolve(v())}).fail(e.fail).done(function(){b(!1)})}).promise()}function f(e){var r=this;r.entity=e,r.isCurrentVersion=n.computed(function(){return m()&&r.entity.Id()===m().entity.Id()}),r.isInUse=n.computed(function(){return r.entity.DraftFileResources().length>0||r.entity.PublicationFileResources().length>0}),r.remove=function(){g.remove(r)},r.select=function(){m(r)},r.navigateToResourceOwner=function(e){t.trigger("caps:contentfile:navigateToResourceOwner",e)}}function h(){return new d({uploadStarted:function(){b(!0)},uploadDone:function(){b(!1),u().then(function(){t.trigger("caps:contentfile:uploadDone",v())})}})}var p=n.observable(0),v=n.observable(),m=n.observable(),g=n.observableArray(),b=n.observable(!1),y=n.observable(),w=n.observable(!1),k=h();t.on("caps:sitemapnode:deleted",function(e){var t=e.ContentId();i.detachPublicationFileResources(t)}),t.on("caps:draft:deleted",function(e){i.detachDraftFileResources(e)}),t.on("caps:draft:saved",function(e){e.deletedFiles&&e.deletedFiles.length&&e.deletedFiles.forEach(function(e){i.detachDraftFile(e)})});var x=$(window);r.on("module:compositionComplete",function(e,t){t===N&&x.trigger("forceViewportHeight:refresh")});var N={fileId:p,file:v,fileVersion:m,versions:g,isLoading:b,uploadManager:k,uploadedFromNowBy:n.computed(function(){return m()&&m().entity?a(m().entity.Modified().At()).fromNow()+" von "+m().entity.Modified().By():""}),uploadedAt:n.computed(function(){return m()&&m().entity?a(m().entity.Modified().At()).format("LLLL"):""}),activate:function(e){return v(null),p(e),y(null),w(!1),u().then(function(){g(n.utils.arrayMap(v().Versions(),function(e){return new f(e)})),m(g()[0])}).fail(function(e){alert(e.message)})},refresh:function(){return u()},navigateBack:function(){r.router.navigate(r.routeConfig.hash)},previewTemplate:function(e){return e&&e.File()&&e.File().isImage()?"file-preview-image":"file-preview-general"},addTagUIVisible:w,tagNames:n.computed(function(){return n.utils.arrayMap(s.tags(),function(e){return e.Name()})}),tagName:y,addTag:function(){w(!0);var e=y();e&&e.length&&s.getOrCreateTag(e).then(function(e){return i.addFileTag(v(),e)}).fail(function(e){window.alert(e.message||e.responseText)}).done(function(){t.trigger("caps:tag:added",y()),y("")})},cancelAddTag:function(){y(null),w(!1)},updateTagName:function(e,t,n){y(n.value)},removeTag:function(e){i.removeFileTag(v(),e).then(function(e){var r=n.utils.arrayFilter(e.entities,function(e){return"Tag"==e.entityType.shortName});n.utils.arrayForEach(r,function(e){t.trigger("caps:tag:deleted",e)})}).fail(function(){alert(err.message||err.responseText)}).done(function(){t.trigger("caps:tag:removed",e)})},deleteVersion:function(e){t.showMessage("Soll die Version wirklich gelöscht werden?","Version löschen?",["Ok","Abbrechen"]).then(function(t){"Ok"===t&&i.deleteFileVersion(e.entity).then(function(){if(e.remove(),e.isCurrentVersion()){var t=v().nextVersion(e)||v().previousVersion(e);m(new f(t))}})})},deleteFile:function(){t.showMessage("Soll die Datei wirklich gelöscht werden?","Datei löschen?",["Ok","Abbrechen"]).then(function(e){"Ok"===e&&i.deleteFile(v()).then(function(){t.trigger("caps:file:deleted",v()),N.navigateBack()})})},moment:a,utils:o,server:l};return N});
