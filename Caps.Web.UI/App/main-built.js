...
define('modules/draft/viewmodels/editor',["durandal/app","durandal/system","../module","../datacontext","entityManagerProvider","breeze","ko","Q","./editor/navigation","./editor/draftTemplate","./editor/draftProperties","./editor/draftFiles","./editor/contentPartEditor","./editor/templateEditor","./editorModel","authentication"],function(e,t,n,r,i,a,o,s,l,u,c,d,f,h,p,m){function v(){function s(e){var t=r.getTemplate(e),n=_.createEntity("Draft",{Template:e,Version:1});n.TemplateContent(JSON.stringify(t)),n.Created().At(new Date),n.Created().By(m.user().userName()),n.Modified().At(new Date),n.Modified().By(m.user().userName());var i=_.createEntity("DraftResource",{Language:"de"});n.Resources.push(i),F.entity(n)}function p(e){var t=a.EntityQuery.from("Drafts").where("Id","==",e).expand("Resources, ContentParts.Resources, Files.Resources.FileVersion.File");return _.executeQuery(t).then(function(e){F.entity(e.results[0])})}function v(){F.entity().setDeleted(),_.saveChanges().then(F.navigateBack)}function g(){x=x||new l(F);var e=I.activeInstruction().queryParams;if(e&&e.t)if("DraftProperties"===e.t)F.showProperties();else if("DraftFiles"===e.t)F.showFiles();else{var t=F.entity().findContentPart(e.t);t&&F.showContentPartEditor(t)}F.currentContent()||(D=D||new u(F),F.currentContent(D)),F.currentNavigation(x)}function b(){var e=F.entity();e&&(y(),e.entityAspect.propertyChanged.subscribe(w))}function y(){var e=F.entity();e&&F.template(e.deserializeTemplate())}function w(){n.routeConfig.hasUnsavedChanges(_.hasChanges())}function k(e){var t=o.utils.arrayFirst(N,function(t){return t.contentPart===e});return t||(t=new f(F,e),N.push(t)),t}var x,D,C,M,S,F=this,_=i.createManager(),N=[],I=n.router;F.currentContent=o.observable(),F.currentNavigation=o.observable(),F.entity=o.observable(),F.entity.subscribe(b),F.template=o.observable(),F.isNewDraft=o.observable(!1),F.activate=function(e){return t.defer(function(t){e&&/^[0-9]+$/.test(e)?p(e).then(function(){g(),t.resolve()}):(F.isNewDraft(!0),s(e),g(),t.resolve())}).promise()},F.shouldActivate=function(e,t,n){return t[0]!==n[0]},F.showEditorMain=function(){D=D||new u(F),F.currentContent(D)},F.showFiles=function(){C=C||new d(F),F.currentContent(C)},F.showProperties=function(){M=M||new c(F,F.entity().getOrCreateResource("de",_)),F.currentContent(M)},F.showContentPartEditor=function(e){var t=k(e);t&&F.currentContent(t)},F.showTemplateEditor=function(){S=S||new h(F),F.currentContent(S)},F.navigateBack=function(){return!F.currentContent()||"ContentPartEditor"!==F.currentContent().name&&"TemplateEditor"!==F.currentContent().name?(F.showDraftsIndex(),void 0):(F.showEditorMain(),void 0)},F.showDraftsIndex=function(){n.routeConfig.hasUnsavedChanges(!1),n.router.navigate(n.routeConfig.hash)},F.saveChanges=function(){F.entity().Modified().At(new Date),F.entity().Modified().By(m.user().userName()),_.saveChanges().then(function(){e.trigger("caps:draft:saved",{entity:F.entity(),isNewDraft:F.isNewDraft()}),F.showDraftsIndex()})},F.deleteDraft=function(){var t="Entwurf löschen",n="Abbrechen";e.showMessage("Soll der Entwurf wirklich gelöscht werden?","Entwurf löschen",[t,n]).then(function(e){e===t&&v()})},F.getOrCreateContentPart=function(e){var t=F.entity().findContentPart(e);if(!t){t=_.createEntity("DraftContentPart",{DraftId:F.entity().Id(),PartType:e,ContentType:"markdown"}),_.addEntity(t);var n=_.createEntity("DraftContentPartResource",{DraftContentPartId:F.entity().Id(),Language:"de",Content:""});_.addEntity(n),t.Resources.push(n),F.entity().ContentParts.push(t)}return t},F.createDraftFile=function(e){var t=a.EntityQuery.from("Files").where("Id","==",e.Id()).expand("Versions.File");_.executeQuery(t).then(function(t){var n=t.results[0],r=_.createEntity("DraftFile",{Name:e.FileName()});_.addEntity(r);var i=_.createEntity("DraftFileResource",{Language:"de",DbFileVersionId:n.latestVersion().Id()});_.addEntity(i),r.Resources.push(i),r.DraftId(F.entity().Id()),F.entity().Files.push(r)})}}return v});
define('modules/draft/viewmodels/index',["../module","../datacontext","ko","durandal/app","moment","localization","infrastructure/publicationService","../contentGenerator","infrastructure/listSortModel","../commands/deleteDraft","./draftSearchControl"],function(e,t,n,r,i,a,o,s,l,u,c){function d(e){if(e&&w()){var t=e.Content();t&&t.EntityKey()==w().draftId()&&p(w().draftId(),k())}}function f(){var e=F;return D(!0),t.searchDrafts(e.searchWords(),e.sortOptions.getOrderBy()).then(function(e){var t=n.utils.arrayMap(e.results,function(e){return new g(e)});y(t),D(!1)})}function h(e){return t.getDraft(e).then(function(t){var n=t.results[0],r=s.createTemplateContent(t.results[0],"de"),i=new v(n,r);k(i),p(e,i)})}function p(e,r){t.fetchPublications(e).then(function(e){r.publications(n.utils.arrayMap(e,function(e){return new b(r.entity(),e)}))}).fail(function(e){alert(e.message)})}function m(){y().length&&M.selectDraft(y()[0])}function v(t,r){var o=this;o.entity=n.observable(t),o.resource=n.observable(t.getResource("de")),o.template=n.observable(r),o.defaultCulture=a.website.defaultLanguage,o.supportedTranslations=a.website.supportedTranslations(),o.publications=n.observableArray(),o.createdAt=n.computed(function(){return i(t.Created().At()).format("LLLL")}),o.createdFromNow=n.computed(function(){return i(t.Created().At()).fromNow()}),o.modifiedAt=n.computed(function(){return i(t.Modified().At()).format("LLLL")}),o.modifiedFromNow=n.computed(function(){return i(t.Modified().At()).fromNow()}),o.translateDraft=function(n){e.router.navigate("#drafts/translate/"+t.Id()+"/"+n.culture)}}function g(e){var t=this;t.draftId=n.computed(function(){return e.Id()}),t.createdAt=n.computed(function(){return t.formatDate(e.Created().At())}),t.modifiedAt=n.computed(function(){return t.formatDate(e.Modified().At())}),t.title=n.computed(function(){return e.Name()}),t.isSelected=n.computed(function(){return w()&&w().draftId()===t.draftId()})}function b(e,t){var r=this;r.draft=n.observable(e),r.sitemapNode=n.observable(t),r.title=n.computed(function(){return r.sitemapNode().path()}),r.contentVersion=n.computed(function(){return r.sitemapNode().Content()?"v."+r.sitemapNode().Content().ContentVersion():""}),r.createdAt=n.computed(function(){return i.utc(r.sitemapNode().Created().At()).fromNow()}),r.createdBy=n.computed(function(){return r.sitemapNode().Created().By()}),r.isOutdated=n.computed(function(){return r.sitemapNode().Content()?r.sitemapNode().Content().ContentVersion()<r.draft().Version():!1}),r.republish=function(){var e=s.createPublicationContent(this.draft());o.republish(this.sitemapNode().Id(),e)}}var y=n.observableArray(),w=n.observable(),k=n.observable(),x=!1,D=n.observable(!1),C=new u,F=new c;F.refreshResults=function(){M.refresh()},r.on("caps:draft:saved",function(e){var t=e.entity;w()&&w().draftId()===t.Id()&&h(w().draftId()),e.isNewDraft&&f().then(function(){M.selectDraftById(t.Id())})}),r.on("caps:draft:deleted",function(){f().then(m)}),r.on("caps:publication:created",d),r.on("caps:publication:refreshed",d);var M={items:y,selectedItem:w,draftPreview:k,isLoading:D,searchControl:F,activate:function(){x||(x=!0,f().then(m))},addDraft:function(){e.router.navigate("#drafts/create")},editDraft:function(t){e.router.navigate("#drafts/edit/"+t.draftId())},editSelectedDraft:function(){M.editDraft(w())},selectDraft:function(e){w(e),k(null),h(e.draftId())},selectDraftById:function(e){var t=n.utils.arrayFirst(y(),function(t){return t.draftId()===e});t&&M.selectDraft(t)},publishDraft:function(){try{var t=s.createPublicationContent(k().entity());r.selectSiteMapNode({module:e,okTitle:"Veröffentlichen"}).then(function(e){e.dialogResult&&o.publish(t,e.selectedNode).fail(function(e){alert(e.message)})})}catch(n){alert(n.message)}},refresh:function(){f()},deleteDraft:function(){C.execute(w().draftId())}};return g.prototype.formatDate=function(e){return i(e).calendar()},M});
