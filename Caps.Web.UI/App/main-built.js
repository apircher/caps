...
define('authentication',["Q","durandal/system","durandal/app","plugins/router","ko","infrastructure/antiForgeryToken","moment"],function(e,t,n,r,o,i,a){function s(){return t.defer(function(e){$.ajax("~/api/account/authmetadata",{method:"get"}).then(function(t){b.lockoutPeriod=t.lockoutPeriod,b.minRequiredPasswordLength=t.minRequiredPasswordLength,e.resolve()}).fail(function(n){t.log("getMetadata failed: "+n.message),e.reject(n)})}).promise()}function u(){return t.defer(function(e){$.ajax("~/api/account/userinfo",{method:"get"}).then(function(t){p(new g(t.isAuthenticated,t.userName,t.roles,t)),t.IsAuthenticated&&n.trigger("caps:authentication:loggedOn",p()),e.resolve(p())}).fail(function(n){t.log("getCurrentUser failed: "+n.responseJSON.message),401==n.status?(p(new g(!1)),e.resolve(p())):e.reject(n)})}).promise()}function c(){return t.defer(function(e){k()&&!p().isExpired()?e.resolve(p()):p().isExpired()?u().then(e.resolve).fail(e.reject):e.resolve(p())}).promise()}function l(r,o,a){return t.defer(function(s){function c(r){if(!r.userName||!r.access_token)return l(new Error(m(r))),void 0;var o=a?localStorage:sessionStorage;o.accessToken=r.access_token,t.log("logon successful"),e.fcall(i.initToken).then(u).then(function(){n.trigger("caps:authentication:loggedOn",p()),s.resolve(r)}).fail(l)}function l(e){t.log("logon failed: "+e.message||e.error),s.reject(e)}$.ajax("~/Token?rememberMe="+a,{method:"post",data:{grant_type:"password",UserName:r,Password:o}}).done(c).fail(l)}).promise()}function d(){return t.defer(function(e){$.ajax("~/api/account/logout",{method:"post"}).then(i.initToken).then(function(){t.log("logoff successful"),n.trigger("caps:authentication:loggedOff"),p(new g),localStorage.removeItem("accessToken"),sessionStorage.removeItem("accessToken"),e.resolve()}).fail(e.reject)}).promise()}function f(e,n){return t.defer(function(t){$.ajax("~/api/account/changepassword",{method:"post",data:{OldPassword:e,NewPassword:n}}).then(u).then(t.resolve).fail(t.reject)}).promise()}function g(e,t,n,r,i){var a=this;r=r||{},this.expirationTicket=new h(i),this.isAuthenticated=o.observable(e||!1),this.userName=o.observable(t||""),this.roles=o.observable(n||[]),this.creationDate=o.observable(r.creationDate||new Date),this.lastPasswordChangedDate=o.observable(r.lastPasswordChangedDate),this.firstName=o.observable(r.firstName||""),this.lastName=o.observable(r.lastName||""),this.displayName=o.computed(function(){return a.firstName().length>0?a.firstName():a.lastName().length>0?a.lastName():a.userName()}),this.fullName=o.computed(function(){return"{0} {1}".replace(/\{0\}/,a.firstName()).replace(/\{1\}/,a.lastName()).trim()}),this.hasEverChangedPassword=o.computed(function(){return a.lastPasswordChangedDate()>a.creationDate()}),this.isInRole=function(e){for(var t=0;t<this.roles().length;t++)if(this.roles()[t]==e)return!0;return!1},this.isInAnyRole=function(e){if(!e||0===e.length)return!0;for(var t=0;t<e.length;t++)if(this.isInRole(e[t]))return!0;return!1}}function h(e){this.created=new Date,this.expiration=e||!1}function m(e){var t="Die Anmeldung ist fehlgeschlagen. Versuche es in einigen Minuten nochmal. Melde das Problem, wenn es weiterhin besteht.";if(e){var n=e.Error;if(n){if("ERROR_LOCKED"==n){var r="Dein Konto wurde aufgrund zu vieler ungültiger Anmelde-Versuche gesperrt. Die Sperrung wird nach {0} Minuten automatisch aufgehoben.";return r.replace(/\{0\}/gi,b.lockoutPeriod)}if("ERROR_NOTAPPROVED"==n)return"Dein Konto wurde noch nicht bestätigt.";if("ERROR_USER_OR_PASSWORD_INVALID"==n)return"Der Benutzername oder das Passwort sind ungültig.";if("Bad request"==n)return t}}return e.Error||t}var p=o.observable(new g),v="viewmodels/login",w="login",R="",b={lockoutPeriod:15,minRequiredPasswordLength:6};$(document).ajaxSend(function(e,t){var n=sessionStorage.accessToken||localStorage.accessToken;n&&t.setRequestHeader("Authorization","Bearer "+n)});var k=o.computed(function(){return p().isAuthenticated()});return r.logon=function(e){if(e.config.moduleId===v)throw new Error("The logon-Function may not be called with the logon-route.");return r.logonSuccessRoute=e,w},r.redirectFromLogonView=function(){var e=R;if(r.logonSuccessRoute){var t=r.logonSuccessRoute;delete r.logonSuccessRoute,e=t.config.hash}r.navigate(e,{trigger:!0,replace:!0})},r.guardRoute=function(e,n){return t.defer(function(e){c().then(function(){k()||n.config.moduleId===v?(n.config.roles&&!p().isInAnyRole(n.config.roles)&&e.resolve("forbidden"),e.resolve(!0)):e.resolve(r.logon(n))}).fail(e.reject)}).promise()},g.prototype.isExpired=function(){return this.expirationTicket.isExpired()},h.prototype.isExpired=function(){return this.expiration?a(this.created).add("seconds",this.expiration)<new Date:!1},{metadata:b,user:p,logon:l,logoff:d,changePassword:f,isAuthenticated:k,initialize:function(){return s().then(u)},UserModel:g}});
...
define('modules/sitemap/viewmodels/index',["../module","ko","plugins/router","durandal/system","durandal/app","localization","./siteMapViewModel","./publicationViewModel","infrastructure/publicationService","authentication","../datacontext","durandal/composition","moment","infrastructure/keyboardHandler","infrastructure/scrollState"],function(e,t,n,r,i,a,o,s,l,u,c,d,f,p,h){function m(e){C(e)&&c.fetchSiteMapNode(e.Id()).then(function(){T()&&T().refreshTree(),b()})}function v(e){E(null),e&&e.fetchTree().then(function(){if(E()){var t=e.tree().findNodeByKey(E().Id());if(t)return t.selectNode(),void 0}e.selectRootNode()})}function g(e){_(null),b(),y(e)}function b(){P(null),E()&&E().ContentId()&&c.fetchPublication(E().ContentId()).then(function(){var e=new s(E());P(e)}).fail(x)}function y(e){R(null),e&&R(new M(e))}function w(e){var n=t.utils.arrayFirst(U.siteMapVersions(),function(t){return t.entity()===e});T(n)}function k(e){var t=new o(e);return t.selectedNodeChanged=function(e){e&&E(e.entity())},t}function C(e){return T()&&T().containsNode(e)}function x(e){r.log(e.message),alert(e.message)}function N(e){var t=T();if(t&&e){var n=e.nextNode()||e.previousNode()||e.ParentNode();c.deleteSiteMapNode(e).then(function(){t.refreshTree(),n&&t.selectNodeByKey(n.Id()),i.trigger("caps:sitemapnode:deleted",e)}).fail(x)}}function D(){c.fetchFirstWebsite().then(function(e){S(e.results[0]),w(S().latestSiteMap())}).fail(x)}function F(e){c.fetchSiteMapNodeByContentId(e).then(function(e){if(!e.results.length)return D(),void 0;var t=e.results[0],n=t.SiteMap();S(n.Website()),w(n),E(t)}).fail(x)}function I(e){var n=this;n.entity=e,n.isSelected=t.computed(function(){return _()===n}),n.selectTeaser=function(){_(n),y(n.entity)}}function M(n){var r=this;r.entity=n,r.supportedTranslations=a.website.supportedTranslations(),r.edit=function(){n&&e.router.navigate("#sitemap/edit/"+n.Id())},r.editTranslation=function(t){n&&e.router.navigate("#sitemap/translate/"+n.Id()+"/"+t.culture)},r.createTeaser=function(){if(n){var e=n.SiteMap().Id(),t=n.SiteMap().rootNodes()[0].Id();l.createTeaser(e,t,n.Id())}},r.canCreateTeaser=function(){return n?"ROOT"==n.NodeType()||n.hasTeasers()?!1:n.isTeaser()?!1:!0:!1},r.deleteTeaser=function(){var e="Aufmacher löschen",t="Abbrechen";i.showMessage('Soll der Aufmacher "'+r.entity.localeTitle("de")+'" wirklich gelöscht werden?',"Aufmacher löschen",[e,t]).then(function(t){t===e&&N(r.entity)})},r.hasOptions=t.computed(function(){return r.entity.isTeaser()||r.canCreateTeaser()}),r.hasContent=t.computed(function(){return n&&n.Content()}),r.contentSummary=t.computed(function(){if(!n.ContentId())return"Kein Inhalt festgelegt";var e=n.Content();return e?e.EntityType()+" #"+e.EntityKey()+" (v."+e.ContentVersion()+")":""}),r.authorSummary=t.computed(function(){if(!n.ContentId()||!n.Content())return"";var e=n.Content();return e.AuthorName()+" "+f(e.ContentDate()).fromNow()}),r.selectContent=function(){function t(e){l.setNodeContent(r.entity.Id(),e).fail(function(e){alert(e.message)})}isActive=!1,i.selectContent({module:e}).then(function(e){e.dialogResult&&t(e.selectedContent)}).finally(function(){isActive=!0})},r.editContent=function(){n.ContentId()&&n.Content()&&i.editContent(n.Content().EntityType(),n.Content().EntityKey())}}var S=t.observable(),T=t.observable(),E=t.observable(),P=t.observable(),_=t.observable(),R=t.observable(),L=!1,V=new p(e),A=new h(e);T.subscribe(v),E.subscribe(g),i.on("caps:sitemapnode:saved",function(e){C(e)&&c.fetchSiteMapNode(e.Id())}),i.on("caps:publication:created",m),i.on("caps:publication:refreshed",m);var O=$(window);e.on("module:compositionComplete",function(e,t){t===U&&(O.trigger("forceViewportHeight:refresh"),A.activate())});var U={website:S,siteMapVersions:t.computed(function(){var e=S()?S().sortedSiteMapVersions():[];return t.utils.arrayMap(e,k)}),selectedSiteMap:T,selectedNode:E,selectedPublication:P,properties:R,listScrollState:A,teasers:t.computed(function(){if(!E())return[];var e=t.utils.arrayFilter(E().childNodes(),function(e){return e.isTeaser()});return t.utils.arrayMap(e,function(e){return new I(e)})}),activate:function(e){L||(L=!0,e&&e.p||D()),e&&e.p&&F(e.p),V.activate()},shouldActivate:function(){return!0},deactivate:function(){V.deactivate(),A.deactivate()},createSiteMapVersion:function(){c.createNewSiteMapVersion(S()).then(w).fail(x)},deleteSiteMapVersion:function(){var e="Sitemap-Version verwerfen",t="Abbrechen",n=T().entity();n&&i.showMessage("Soll diese Version wirklich verworfen werden?","Sitemap-Version verwerfen?",[e,t]).then(function(t){if(t===e){var r=n.nextVersion()||n.previousVersion();w(r),c.deleteSiteMapVersion(n).fail(x)}})},publishSiteMapVersion:function(){c.publishSiteMap(T().entity(),u.user().userName())},createSiteMapNode:function(){T()&&E()&&c.createSiteMapNode(T().entity(),E()).then(function(e){T().refreshTree(),T().selectNodeByKey(e.Id())}).fail(x)},deleteSiteMapNode:function(){var e="Seite löschen",t="Abbrechen";i.showMessage('Soll die Seite "'+E().localeTitle("de")+'" wirklich gelöscht werden?',"Seite löschen",[e,t]).then(function(t){t===e&&N(E())})},editWebsite:function(){n.navigate("#website")},moveSelectedNodeUp:function(){E()&&(E().moveUp(),c.saveChanges().then(function(){T()&&T().refreshTree()}))},moveSelectedNodeDown:function(){E()&&(E().moveDown(),c.saveChanges().then(function(){T()&&T().refreshTree()}))},moveSelectedNode:function(){function t(e){return!e.isTeaser()&&e.Id()!==E().Id()}if(T()){var n=T(),r=E();i.selectSiteMapNode({module:e,nodeFilter:t,siteMapId:n.entity().Id(),canSelectSiteMap:!1}).then(function(e){e.dialogResult&&e.selectedNode&&e.selectedNode.Id()!==r.ParentNodeId()&&(r.reparent(e.selectedNode),c.saveChanges().then(function(){n.refreshTree(),n.tree().selectedNode().ensureVisible()}))})}}};return V.keydown=function(e){T()&&T().tree()&&T().tree().handleKeyDown(e)},U});
...
define('viewmodels/login',['require'],function(e){function t(){p(!0),i.logon(u(),c(),d()).then(function(){o.redirectFromLogonView()}).fail(function(e){a.showMessage(e.Error||e.message,"Fehlgeschlagen")}).done(function(){p(!1)})}function n(){u(null),c(null),d(!1)}function r(){var e=l("#login-form");l(".autofocus",e).each(function(){l(this).focus()})}var i=e("authentication"),a=e("durandal/app"),o=(e("durandal/system"),e("plugins/router")),s=e("knockout"),l=e("jquery"),u=s.observable().extend({required:!0}),c=s.observable().extend({required:!0}),d=s.observable(!1),f=s.observable(!1),p=s.observable(!1),h={userName:u,password:c,rememberMe:d,logon:t,isBusy:s.computed(function(){return p()||o.isNavigating()}),userNameFocused:f,activate:function(){n(),r()},compositionComplete:function(){r()}};return s.validation.group(h),h});
