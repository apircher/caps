...
define('modules/contentfile/viewmodels/detail',["durandal/system","durandal/app","knockout","../module","../datacontext","moment","infrastructure/utils","infrastructure/tagService","infrastructure/serverUtil"],function(e,t,n,r,i,a,o,s,l){function u(){return e.defer(function(e){f(!0),i.fetchFile(d()).then(function(){c(i.localGetFile(d())),e.resolve(c())}).fail(e.fail).done(function(){f(!1)})}).promise()}var d=n.observable(0),c=n.observable(),f=n.observable(!1),h=n.observable(),p=n.observable(!1),m={fileId:d,file:c,isLoading:f,activate:function(e){return c(null),d(e),h(null),p(!1),u().fail(function(e){alert(e.message)})},refresh:function(){return u()},navigateBack:function(){r.router.navigate(r.routeConfig.hash)},previewTemplate:function(e){return e&&e.isImage()?"file-preview-image":"file-preview-general"},addTagUIVisible:p,tagNames:n.computed(function(){return n.utils.arrayMap(s.tags(),function(e){return e.Name()})}),tagName:h,addTag:function(){p(!0);var e=h();e&&e.length&&s.getOrCreateTag(e).then(function(e){return i.addFileTag(c(),e)}).fail(function(e){window.alert(e.message||e.responseText)}).done(function(){t.trigger("caps:tag:added",h()),h("")})},cancelAddTag:function(){h(null),p(!1)},updateTagName:function(e,t,n){h(n.value)},removeTag:function(e){i.removeFileTag(c(),e).then(function(e){var r=n.utils.arrayFilter(e.entities,function(e){return"Tag"==e.entityType.shortName});n.utils.arrayForEach(r,function(e){t.trigger("caps:tag:deleted",e)})}).fail(function(){alert(err.message||err.responseText)}).done(function(){t.trigger("caps:tag:removed",e)})},moment:a,utils:o,server:l};return m});
...
define('modules/contentfile/viewmodels/uploadManager',["ko","durandal/system"],function(e,t){function n(n){var r=this;r.isUploading=e.observable(!1),r.progress=e.observable(0),r.addFiles=function(i,a){var o=0;return e.utils.arrayForEach(a.files,function(e){n.uploadStarted&&"function"==typeof n.uploadStarted&&n.uploadStarted(e,o++)}),r.isUploading(!0),t.defer(function(){a.submit()}).promise()},r.replaceFiles=function(t,i){var a=0;e.utils.arrayForEach(i.files,function(e){n.uploadStarted&&"function"==typeof n.uploadStarted&&n.uploadStarted(e,a++,!0)}),r.isUploading(!0),i.submit()},r.uploadDone=function(t,i){e.utils.arrayForEach(i.result,function(t){var r=e.utils.arrayFirst(i.files,function(e){return e.name===t.FileName});n.uploadDone&&"function"==typeof n.uploadDone&&n.uploadDone(t,r)}),r.isUploading(!1)},r.uploadFailed=function(t,n){e.utils.arrayForEach(n.files,function(e){e.listItem.isUploading(!1)}),r.isUploading(!1)},r.uploadProgress=function(e,t){var n=parseInt(100*(t.loaded/t.total),10);r.progress(n)},r.filesDropped=function(e){return"copy"===e.dataTransfer.dropEffect?!1:void 0}}return n});
...
define('modules/sitemap/viewmodels/index',["../module","ko","plugins/router","durandal/system","durandal/app","localization","./siteMapViewModel","./publicationViewModel","infrastructure/publicationService","authentication","../datacontext","durandal/composition","moment"],function(e,t,n,r,i,a,o,s,l,u,c,d,f){function p(e){w(e)&&c.fetchSiteMapNode(e.Id()).then(function(){S()&&S().refreshTree(),v()})}function h(e){T(null),e&&e.fetchTree().then(function(){e.selectRootNode()})}function m(e){P(null),v(),g(e)}function v(){E(null),T()&&T().ContentId()&&c.fetchPublication(T().ContentId()).then(function(){var e=new s(T());E(e)}).fail(k)}function g(e){_(null),e&&_(new F(e))}function b(e){var n=t.utils.arrayFirst(A.siteMapVersions(),function(t){return t.entity()===e});S(n)}function y(e){var t=new o(e);return t.selectedNodeChanged=function(e){e&&T(e.entity())},t}function w(e){return S()&&S().containsNode(e)}function k(e){r.log(e.message),alert(e.message)}function x(e){var t=S();if(t&&e){var n=e.nextNode()||e.previousNode()||e.ParentNode();c.deleteSiteMapNode(e).then(function(){t.refreshTree(),n&&t.selectNodeByKey(n.Id())}).fail(k)}}function C(){$(window).on("keydown",A.handleKeyDown)}function N(){$(window).off("keydown",A.handleKeyDown)}function D(){d.current.complete(function(){V.trigger("forceViewportHeight:refresh")})}function I(e){var n=this;n.entity=e,n.isSelected=t.computed(function(){return P()===n}),n.selectTeaser=function(){P(n),g(n.entity)}}function F(n){var r=this;r.entity=n,r.supportedTranslations=a.website.supportedTranslations(),r.edit=function(){n&&e.router.navigate("#sitemap/edit/"+n.Id())},r.editTranslation=function(t){n&&e.router.navigate("#sitemap/translate/"+n.Id()+"/"+t.culture)},r.createTeaser=function(){if(n){var e=n.SiteMap().Id(),t=n.SiteMap().rootNodes()[0].Id();l.createTeaser(e,t,n.Id())}},r.canCreateTeaser=function(){return n?"ROOT"==n.NodeType()||n.hasTeasers()?!1:n.isTeaser()?!1:!0:!1},r.deleteTeaser=function(){var e="Aufmacher löschen",t="Abbrechen";i.showMessage('Soll der Aufmacher "'+r.entity.localeTitle("de")+'" wirklich gelöscht werden?',"Aufmacher löschen",[e,t]).then(function(t){t===e&&x(r.entity)})},r.hasOptions=t.computed(function(){return r.entity.isTeaser()||r.canCreateTeaser()}),r.hasContent=t.computed(function(){return n&&n.Content()}),r.contentSummary=t.computed(function(){if(!n.ContentId())return"Kein Inhalt festgelegt";var e=n.Content();return e?e.EntityType()+" #"+e.EntityKey()+" (v."+e.ContentVersion()+")":""}),r.authorSummary=t.computed(function(){if(!n.ContentId()||!n.Content())return"";var e=n.Content();return e.AuthorName()+" "+f(e.ContentDate()).fromNow()}),r.selectContent=function(){function t(e){l.setNodeContent(r.entity.Id(),e).fail(function(e){alert(e.message)})}L=!1,i.selectContent({module:e}).then(function(e){e.dialogResult&&t(e.selectedContent)}).finally(function(){L=!0})},r.editContent=function(){n.ContentId()&&n.Content()&&i.editContent(n.Content().EntityType(),n.Content().EntityKey())}}var M=t.observable(),S=t.observable(),T=t.observable(),E=t.observable(),P=t.observable(),_=t.observable(),R=!1,L=!1;S.subscribe(h),T.subscribe(m),i.on("caps:sitemapnode:saved",function(e){w(e)&&c.fetchSiteMapNode(e.Id())}),i.on("caps:publication:created",p),i.on("caps:publication:refreshed",p),e.on("module:activate",function(){L&&(C(),D())}),e.on("module:deactivate",function(){L&&N()});var A={website:M,siteMapVersions:t.computed(function(){var e=M()?M().sortedSiteMapVersions():[];return t.utils.arrayMap(e,y)}),selectedSiteMap:S,selectedNode:T,selectedPublication:E,properties:_,teasers:t.computed(function(){if(!T())return[];var e=t.utils.arrayFilter(T().childNodes(),function(e){return e.isTeaser()});return t.utils.arrayMap(e,function(e){return new I(e)})}),activate:function(){R||(R=!0,c.fetchFirstWebsite().then(function(e){M(e.results[0]),b(M().latestSiteMap())}).fail(k)),C(),D(),L=!0},deactivate:function(){N(),L=!1},createSiteMapVersion:function(){c.createNewSiteMapVersion(M()).then(b).fail(k)},deleteSiteMapVersion:function(){var e="Sitemap-Version verwerfen",t="Abbrechen",n=S().entity();n&&i.showMessage("Soll diese Version wirklich verworfen werden?","Sitemap-Version verwerfen?",[e,t]).then(function(t){if(t===e){var r=n.nextVersion()||n.previousVersion();b(r),c.deleteSiteMapVersion(n).fail(k)}})},publishSiteMapVersion:function(){c.publishSiteMap(S().entity(),u.user().userName())},createSiteMapNode:function(){S()&&T()&&c.createSiteMapNode(S().entity(),T()).then(function(e){siteMap.refreshTree(),siteMap.selectNodeByKey(e.Id())}).fail(k)},deleteSiteMapNode:function(){var e="Seite löschen",t="Abbrechen";i.showMessage('Soll die Seite "'+T().localeTitle("de")+'" wirklich gelöscht werden?',"Seite löschen",[e,t]).then(function(t){t===e&&x(T())})},editWebsite:function(){n.navigate("#website")},moveSelectedNodeUp:function(){T()&&(T().moveUp(),c.saveChanges().then(function(){S()&&S().refreshTree()}))},moveSelectedNodeDown:function(){T()&&(T().moveDown(),c.saveChanges().then(function(){S()&&S().refreshTree()}))},moveSelectedNode:function(){function t(e){return!e.isTeaser()&&e.Id()!==T().Id()}if(S()){var n=S(),r=T();i.selectSiteMapNode({module:e,nodeFilter:t,siteMapId:n.entity().Id(),canSelectSiteMap:!1}).then(function(e){e.dialogResult&&e.selectedNode&&e.selectedNode.Id()!==r.ParentNodeId()&&(r.reparent(e.selectedNode),c.saveChanges().then(function(){n.refreshTree(),n.tree().selectedNode().ensureVisible()}))})}},handleKeyDown:function(e){L&&S().tree().handleKeyDown(e)}},V=$(window);return A});
