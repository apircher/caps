...
define('plugins/router',["durandal/system","durandal/app","durandal/activator","durandal/events","durandal/composition","plugins/history","knockout","jquery"],function(e,t,n,r,i,a,o,s){function l(e){return e=e.replace(b,"\\$&").replace(m,"(?:$1)?").replace(v,function(e,t){return t?e:"([^/]+)"}).replace(g,"(.*?)"),new RegExp("^"+e+"$",w?void 0:"i")}function u(e){var t=e.indexOf(":"),n=t>0?t-1:e.length;return e.substring(0,n)}function c(e,t){return-1!==e.indexOf(t,e.length-t.length)}function d(e,t){if(!e||!t)return!1;if(e.length!=t.length)return!1;for(var n=0,r=e.length;r>n;n++)if(e[n]!=t[n])return!1;return!0}function f(e){return e.queryString?e.fragment+"?"+e.queryString:e.fragment}var h,p,m=/\((.*?)\)/g,v=/(\(\?)?:\w+/g,g=/\*\w+/g,b=/[\-{}\[\]+?.,\\\^$|#\s]/g,y=/\/$/,w=!1,k=function(){function i(e,t){return e.router&&e.router.parent==t}function s(e){T&&T.config.isActive&&T.config.isActive(e)}function m(t,n){e.log("Navigation Complete",t,n);var r=e.getModuleId(M);r&&A.trigger("router:navigation:from:"+r),M=t,s(!1),T=n,s(!0);var a=e.getModuleId(M);a&&A.trigger("router:navigation:to:"+a),i(t,A)||A.updateDocumentTitle(t,n),_(!1),p.explicitNavigation=!1,p.navigatingBack=!1,A.trigger("router:navigation:complete",t,n,A)}function v(t,n){e.log("Navigation Cancelled"),A.activeInstruction(T),T&&A.navigate(f(T),!1),_(!1),p.explicitNavigation=!1,p.navigatingBack=!1,A.trigger("router:navigation:cancelled",t,n,A)}function g(t){e.log("Navigation Redirecting"),_(!1),p.explicitNavigation=!1,p.navigatingBack=!1,A.navigate(t,{trigger:!0,replace:!0})}function b(t,n,r){p.navigatingBack=!p.explicitNavigation&&M!=r.fragment,A.trigger("router:route:activating",n,r,A),t.activateItem(n,r.params).then(function(e){if(e){var a=M;if(m(n,r),i(n,A)){var o=r.fragment;r.queryString&&(o+="?"+r.queryString),n.router.loadUrl(o)}a==n&&(A.attached(),A.compositionComplete())}else t.settings.lifecycleData&&t.settings.lifecycleData.redirect?g(t.settings.lifecycleData.redirect):v(n,r);h&&(h.resolve(),h=null)}).fail(function(t){e.error(t)})}function w(t,n,r){var i=A.guardRoute(n,r);i?i.then?i.then(function(i){i?e.isString(i)?g(i):b(t,n,r):v(n,r)}):e.isString(i)?g(i):b(t,n,r):v(n,r)}function x(e,t,n){A.guardRoute?w(e,t,n):b(e,t,n)}function D(e){return T&&T.config.moduleId==e.config.moduleId&&M&&(M.canReuseForRoute&&M.canReuseForRoute.apply(M,e.params)||!M.canReuseForRoute&&M.router&&M.router.loadUrl)}function C(){if(!_()){var t=P.shift();P=[],t&&(_(!0),A.activeInstruction(t),D(t)?x(n.create(),M,t):e.acquire(t.config.moduleId).then(function(n){var r=e.resolveObject(n);x(E,r,t)}).fail(function(n){e.error("Failed to load routed module ("+t.config.moduleId+"). Details: "+n.message)}))}}function N(e){P.unshift(e),C()}function I(e,t,n){for(var r=e.exec(t).slice(1),i=0;i<r.length;i++){var a=r[i];r[i]=a?decodeURIComponent(a):null}var o=A.parseQueryString(n);return o&&r.push(o),{params:r,queryParams:o}}function F(t){A.trigger("router:route:before-config",t,A),e.isRegExp(t)?t.routePattern=t.route:(t.title=t.title||A.convertRouteToTitle(t.route),t.moduleId=t.moduleId||A.convertRouteToModuleId(t.route),t.hash=t.hash||A.convertRouteToHash(t.route),t.routePattern=l(t.route)),t.isActive=t.isActive||o.observable(!1),A.trigger("router:route:after-config",t,A),A.routes.push(t),A.route(t.routePattern,function(e,n){var r=I(t.routePattern,e,n);N({fragment:e,queryString:n,config:t,params:r.params,queryParams:r.queryParams})})}function S(t){if(e.isArray(t.route))for(var n=t.isActive||o.observable(!1),r=0,i=t.route.length;i>r;r++){var a=e.extend({},t);a.route=t.route[r],a.isActive=n,r>0&&delete a.nav,F(a)}else F(t);return A}var M,T,P=[],_=o.observable(!1),E=n.create(),A={handlers:[],routes:[],navigationModel:o.observableArray([]),activeItem:E,isNavigating:o.computed(function(){var e=E(),t=_(),n=e&&e.router&&e.router!=A&&e.router.isNavigating()?!0:!1;return t||n}),activeInstruction:o.observable(null),__router__:!0};return r.includeIn(A),E.settings.areSameItem=function(e,t,n,r){return e==t?d(n,r):!1},A.parseQueryString=function(e){var t,n;if(!e)return null;if(n=e.split("&"),0==n.length)return null;t={};for(var r=0;r<n.length;r++){var i=n[r];if(""!==i){var a=i.split("=");t[a[0]]=a[1]&&decodeURIComponent(a[1].replace(/\+/g," "))}}return t},A.route=function(e,t){A.handlers.push({routePattern:e,callback:t})},A.loadUrl=function(t){var n=A.handlers,r=null,i=t,o=t.indexOf("?");if(-1!=o&&(i=t.substring(0,o),r=t.substr(o+1)),A.relativeToParentRouter){var s=this.parent.activeInstruction();i=s.params.join("/"),i&&"/"==i.charAt(0)&&(i=i.substr(1)),i||(i=""),i=i.replace("//","/").replace("//","/")}i=i.replace(y,"");for(var l=0;l<n.length;l++){var u=n[l];if(u.routePattern.test(i))return u.callback(i,r),!0}return e.log("Route Not Found"),A.trigger("router:route:not-found",t,A),T&&a.navigate(f(T),{trigger:!1,replace:!0}),p.explicitNavigation=!1,p.navigatingBack=!1,!1},A.updateDocumentTitle=function(e,n){n.config.title?document.title=t.title?n.config.title+" | "+t.title:n.config.title:t.title&&(document.title=t.title)},A.navigate=function(e,t){return e&&-1!=e.indexOf("://")?(window.location.href=e,!0):(p.explicitNavigation=!0,a.navigate(e,t))},A.navigateBack=function(){a.navigateBack()},A.attached=function(){A.trigger("router:navigation:attached",M,T,A)},A.compositionComplete=function(){_(!1),A.trigger("router:navigation:composition-complete",M,T,A),C()},A.convertRouteToHash=function(e){if(A.relativeToParentRouter){var t=A.parent.activeInstruction(),n=t.config.hash+"/"+e;return a._hasPushState&&(n="/"+n),n=n.replace("//","/").replace("//","/")}return a._hasPushState?e:"#"+e},A.convertRouteToModuleId=function(e){return u(e)},A.convertRouteToTitle=function(e){var t=u(e);return t.substring(0,1).toUpperCase()+t.substring(1)},A.map=function(t,n){if(e.isArray(t)){for(var r=0;r<t.length;r++)A.map(t[r]);return A}return e.isString(t)||e.isRegExp(t)?(n?e.isString(n)&&(n={moduleId:n}):n={},n.route=t):n=t,S(n)},A.buildNavigationModel=function(t){for(var n=[],r=A.routes,i=t||100,a=0;a<r.length;a++){var o=r[a];o.nav&&(e.isNumber(o.nav)||(o.nav=++i),n.push(o))}return n.sort(function(e,t){return e.nav-t.nav}),A.navigationModel(n),A},A.mapUnknownRoutes=function(t,n){var r="*catchall",i=l(r);return A.route(i,function(o,s){var l=I(i,o,s),u={fragment:o,queryString:s,config:{route:r,routePattern:i},params:l.params,queryParams:l.queryParams};if(t)if(e.isString(t))u.config.moduleId=t,n&&a.navigate(n,{trigger:!1,replace:!0});else if(e.isFunction(t)){var c=t(u);if(c&&c.then)return c.then(function(){A.trigger("router:route:before-config",u.config,A),A.trigger("router:route:after-config",u.config,A),N(u)}),void 0}else u.config=t,u.config.route=r,u.config.routePattern=i;else u.config.moduleId=o;A.trigger("router:route:before-config",u.config,A),A.trigger("router:route:after-config",u.config,A),N(u)}),A},A.reset=function(){return T=M=void 0,A.handlers=[],A.routes=[],A.off(),delete A.options,A},A.makeRelative=function(t){return e.isString(t)&&(t={moduleId:t,route:t}),t.moduleId&&!c(t.moduleId,"/")&&(t.moduleId+="/"),t.route&&!c(t.route,"/")&&(t.route+="/"),t.fromParent&&(A.relativeToParentRouter=!0),A.on("router:route:before-config").then(function(e){t.moduleId&&(e.moduleId=t.moduleId+e.moduleId),t.route&&(e.route=""===e.route?t.route.substring(0,t.route.length-1):t.route+e.route)}),A},A.createChildRouter=function(){var e=k();return e.parent=A,e},A};return p=k(),p.explicitNavigation=!1,p.navigatingBack=!1,p.makeRoutesCaseSensitive=function(){w=!0},p.targetIsThisWindow=function(e){var t=s(e.target).attr("target");return!t||t===window.name||"_self"===t||"top"===t&&window===window.top?!0:!1},p.activate=function(t){return e.defer(function(n){if(h=n,p.options=e.extend({routeHandler:p.loadUrl},p.options,t),a.activate(p.options),a._hasPushState)for(var r=p.routes,i=r.length;i--;){var o=r[i];o.hash=o.hash.replace("#","")}s(document).delegate("a","click",function(e){if(a._hasPushState){if(!e.altKey&&!e.ctrlKey&&!e.metaKey&&!e.shiftKey&&p.targetIsThisWindow(e)){var t=s(this).attr("href");null==t||"#"===t.charAt(0)||/^[a-z]+:/i.test(t)||(p.explicitNavigation=!0,e.preventDefault(),a.navigate(t))}}else p.explicitNavigation=!0}),a.options.silent&&h&&(h.resolve(),h=null)}).promise()},p.deactivate=function(){a.deactivate()},p.install=function(){o.bindingHandlers.router={init:function(){return{controlsDescendantBindings:!0}},update:function(e,t,n,r,a){var s=o.utils.unwrapObservable(t())||{};if(s.__router__)s={model:s.activeItem(),attached:s.attached,compositionComplete:s.compositionComplete,activate:!1};else{var l=o.utils.unwrapObservable(s.router||r.router)||p;s.model=l.activeItem(),s.attached=l.attached,s.compositionComplete=l.compositionComplete,s.activate=!1}i.compose(e,s,a)}},o.virtualElements.allowedBindings.router=!0},p});
//! moment.js
//! version : 2.4.0
...
define('infrastructure/treeViewModel',["ko"],function(e){function t(){var t=this;t.keyName=e.observable(),t.selectedNode=e.observable(),t.root=new n(t),t.root.isExpanded(!0),t.rootNodes=e.computed(function(){return t.root.childNodes()}),t.selectedKey=e.computed(function(){return t.selectedNode()?t.selectedNode().key():void 0})}function n(t,n){var r=this;r.childNodes=e.observableArray(),r.parentNode=e.observable(n),r.tree=t,r.entity=e.observable(),r.key=e.computed({read:function(){var e=t.keyName();if(e&&r.entity()&&r.entity()[e]){var n=r.entity()[e];return"function"==typeof n?n.call(r.entity()):n}return void 0},deferEvaluation:!0}),r.isSelected=e.computed(function(){return t.selectedNode()===r}),r.isExpanded=e.observable(!1),r.addChildNode=function(e){r.childNodes.push(e),e.parentNode(r)},r.hasChildNodes=e.computed(function(){return r.childNodes()&&r.childNodes().length})}return t.prototype.createNode=function(){return new n(this)},t.prototype.saveState=function(){var t=[];return e.utils.arrayForEach(this.rootNodes(),function(e){e.saveState(t)}),{selectedKey:this.selectedKey(),nodeState:t}},t.prototype.restoreState=function(t){var n=this;if(e.utils.arrayForEach(t.nodeState,function(e){var t=n.findNodeByKey(e.key);t&&t.restoreState(e)}),t.selectedKey){var r=n.findNodeByKey(t.selectedKey);n.selectedNode(r)}},t.prototype.findNodeByKey=function(e){function t(n){if(n&&n.length)for(var r=0;r<n.length;r++){var i=n[r];if(i.key()===e)return i;var o=t(i.childNodes());if(o)return o}return void 0}return t(this.rootNodes())},t.prototype.selectNodeByKey=function(e){var t=this.findNodeByKey(e);return t?(t.selectNode(),!0):!1},t.prototype.expandRootNodes=function(){e.utils.arrayForEach(this.rootNodes(),function(e){e.isExpanded(!0)})},n.prototype.selectNode=function(){this.tree.selectedNode(this),this.ensureVisible()},n.prototype.toggleIsExpanded=function(){var e=!this.isExpanded();this.isExpanded(e)},n.prototype.saveState=function(t){t.push({key:this.key(),isExpanded:this.isExpanded()}),e.utils.arrayForEach(this.childNodes(),function(e){e.saveState(t)})},n.prototype.restoreState=function(e){e&&this.isExpanded(e.isExpanded)},n.prototype.ensureVisible=function(){for(var e=this.parentNode();e;)e.isExpanded()||e.isExpanded(!0),e=e.parentNode()},{TreeViewModel:t,TreeNodeViewModel:n}});
define('infrastructure/urlHelper',[],function(){function e(){}e.prototype.getFileUrl=function(e,t,n){if(t){if(/(\?|&amp;|&)download=1/i.test(n)||!t.File().isImage())return"/DbFileContent/Download/"+t.Id();if(t.File().isImage()){if(/(\?|&amp;|&)size=([0-9]+x[0-9]+)/i.test(n)){var i="220x160",r=n.match(/(\?|&amp;|&)size=([0-9]+x[0-9]+)/);return r&&3==r.length&&(i=r[2]),"/DbFileContent/Thumbnail/"+t.Id()+"?thumbnailName="+i}return"/DbFileContent/Inline/"+t.Id()}}return""},e.prototype.getPublicationUrl=function(e){return"#sitemap?p="+e};var t=new e;return t});
...
define('modules/draft/viewmodels/editor',["durandal/app","durandal/system","../module","../datacontext","../entities","entityManagerProvider","breeze","ko","Q","./editor/navigation","./editor/draftTemplate","./editor/draftProperties","./editor/draftFiles","./editor/contentPartEditor","./editor/templateEditor","./editor/draftNotes","./editorModel","authentication"],function(e,t,n,r,i,a,o,s,l,u,c,d,f,h,p,m,v,g){function b(){function l(e,t,n){n=n||"de",r.getTemplate(e).then(function(r){var i=r,a=E.createEntity("Draft",{TemplateName:e,Version:1,OriginalLanguage:n,Status:"NEW"});a.Template(JSON.stringify(i)),a.Created().At(new Date),a.Created().By(g.user().userName()),a.Modified().At(new Date),a.Modified().By(g.user().userName()),t&&t.name&&a.Name(t.name),T.entity(a);for(var o=0;o<i.rows.length;o++)for(var s=i.rows[o],l=0;l<s.cells.length;l++){var u=s.cells[l],c=T.getOrCreateContentPart(u);if(u.content){var d=/<%\s*([A-Za-z0-9_\.]+)\s*%>/gi,f=u.content.replace(d,function(e,n){return t&&t[n]?t[n]:v(n)||"Nicht gefunden"});c.getResource("de").Content(f)}}})}function v(e){if(!T.entity()||!T.entity().template())return null;var t=T.entity().template();if(!t.parameters)return null;var n=s.utils.arrayFirst(t.parameters,function(t){return t.name.toLowerCase()===e.toLowerCase()});return n?n.value:null}function b(e){var t=o.EntityQuery.from("Drafts").where("Id","==",e).expand("ContentParts.Resources, Files.Resources.FileVersion.File");return E.executeQuery(t).then(function(e){T.entity(e.results[0])})}function y(){T.entity().setDeleted(),E.saveChanges().then(T.navigateBack)}function w(){N=N||new u(T);var e=L.activeInstruction().queryParams;if(e&&e.t)if("DraftProperties"===e.t)T.showProperties();else if("DraftFiles"===e.t)T.showFiles();else{var t=T.entity().findContentPart(e.t);t&&T.showContentPartEditor(t)}T.currentContent()||(F=F||new c(T),T.currentContent(F)),T.currentNavigation(N)}function k(){var e=T.entity();e&&(x(),e.entityAspect.propertyChanged.subscribe(D))}function x(){var e=T.entity();e&&T.template(e.deserializeTemplate())}function D(){n.routeConfig.hasUnsavedChanges(E.hasChanges())}function C(e){var t=s.utils.arrayFirst(P,function(t){return t.contentPart===e});return t||(t=new h(T,e),P.push(t)),t}var N,F,I,S,M,_,T=this,E=a.createManager(),P=[],L=n.router;T.currentContent=s.observable(),T.currentNavigation=s.observable(),T.entity=s.observable(),T.entity.subscribe(k),T.template=s.observable(),T.isNewDraft=s.observable(!1),T.draftStates=i.supportedDraftStates,T.activate=function(e,n){return t.defer(function(t){e&&/^[0-9]+$/.test(e)?b(e).then(function(){w(),t.resolve()}):(T.isNewDraft(!0),l(e,n),w(),t.resolve())}).promise()},T.shouldActivate=function(e,t,n){return t[0]!==n[0]},T.showEditorMain=function(){F=F||new c(T),T.currentContent(F)},T.showFiles=function(){I=I||new f(T),T.currentContent(I)},T.showProperties=function(){S=S||new d(T),T.currentContent(S)},T.showContentPartEditor=function(e){var t=C(e);t&&T.currentContent(t)},T.showTemplateEditor=function(){M=M||new p(T),T.currentContent(M)},T.showDraftNotes=function(){_=_||new m(T),T.currentContent(_)},T.navigateBack=function(){return!T.currentContent()||"ContentPartEditor"!==T.currentContent().name&&"TemplateEditor"!==T.currentContent().name?(T.showDraftsIndex(),void 0):(T.showEditorMain(),void 0)},T.showDraftsIndex=function(){n.routeConfig.hasUnsavedChanges(!1),n.router.navigate(n.routeConfig.hash)},T.saveChanges=function(){T.entity().Modified().At(new Date),T.entity().Modified().By(g.user().userName()),E.saveChanges().then(function(){e.trigger("caps:draft:saved",{entity:T.entity(),isNewDraft:T.isNewDraft()}),T.showDraftsIndex()})},T.deleteDraft=function(){var t="Entwurf löschen",n="Abbrechen";e.showMessage("Soll der Entwurf wirklich gelöscht werden?","Entwurf löschen",[t,n]).then(function(e){e===t&&y()})},T.getOrCreateContentPart=function(e){var t=T.entity().findContentPart(e.name);if(!t){t=E.createEntity("DraftContentPart",{DraftId:T.entity().Id(),Name:e.name,ContentType:e.contentType||"markdown"}),E.addEntity(t);var n=E.createEntity("DraftContentPartResource",{DraftContentPartId:T.entity().Id(),Language:"de",Content:""});E.addEntity(n),t.Resources.push(n),T.entity().ContentParts.push(t)}return t},T.createDraftFile=function(e){var t=o.EntityQuery.from("Files").where("Id","==",e.Id()).expand("Versions.File");return E.executeQuery(t).then(function(t){var n=t.results[0],r=E.createEntity("DraftFile",{Name:e.FileName()});e.isImage()&&r.Determination("Picture"),E.addEntity(r);var i=E.createEntity("DraftFileResource",{Language:"de",DbFileVersionId:n.latestVersion().Id()});return E.addEntity(i),r.Resources.push(i),r.DraftId(T.entity().Id()),T.entity().Files.push(r),r})}}return b});
...
define('modules/draft/viewmodels/index',["../module","../datacontext","ko","durandal/app","moment","localization","infrastructure/publicationService","../contentGenerator","infrastructure/listSortModel","../commands/deleteDraft","./draftSearchControl"],function(e,t,n,r,i,a,o,s,l,u,c){function d(e){if(e&&w()){var t=e.Content();t&&t.EntityKey()==w().draftId()&&p(w().draftId(),k())}}function f(){var e=F;return D(!0),t.searchDrafts(e.searchWords(),e.sortOptions.getOrderBy()).then(function(e){var t=n.utils.arrayMap(e.results,function(e){return new g(e)});y(t),D(!1)})}function h(e){return t.getDraft(e).then(function(t){var n=t.results[0],r=s.createTemplateContent(t.results[0],"de"),i=new v(n,r);k(i),p(e,i)})}function p(e,r){t.fetchPublications(e).then(function(e){r.publications(n.utils.arrayMap(e,function(e){return new b(r.entity(),e)}))}).fail(function(e){alert(e.message)})}function m(){y().length&&N.selectDraft(y()[0])}function v(t,r){var o=this,s=new a.Language(t.OriginalLanguage());o.entity=n.observable(t),o.template=n.observable(r),o.originalLanguage=s,o.supportedTranslations=a.website.supportedTranslations(s.culture),o.publications=n.observableArray(),o.createdAt=n.computed(function(){return i(t.Created().At()).format("LLLL")}),o.createdFromNow=n.computed(function(){return i(t.Created().At()).fromNow()}),o.modifiedAt=n.computed(function(){return i(t.Modified().At()).format("LLLL")}),o.modifiedFromNow=n.computed(function(){return i(t.Modified().At()).fromNow()}),o.translateDraft=function(n){e.router.navigate("#drafts/translate/"+t.Id()+"/"+n.culture)}}function g(e){var t=this;t.draftId=n.computed(function(){return e.Id()}),t.createdAt=n.computed(function(){return t.formatDate(e.Created().At())}),t.modifiedAt=n.computed(function(){return t.formatDate(e.Modified().At())}),t.title=n.computed(function(){return e.Name()}),t.isSelected=n.computed(function(){return w()&&w().draftId()===t.draftId()})}function b(e,t){var r=this;r.draft=n.observable(e),r.sitemapNode=n.observable(t),r.title=n.computed(function(){return r.sitemapNode().path()}),r.contentVersion=n.computed(function(){return r.sitemapNode().Content()?"v."+r.sitemapNode().Content().ContentVersion():""}),r.createdAt=n.computed(function(){return i.utc(r.sitemapNode().Created().At()).fromNow()}),r.createdBy=n.computed(function(){return r.sitemapNode().Created().By()}),r.isOutdated=n.computed(function(){return r.sitemapNode().Content()?r.sitemapNode().Content().ContentVersion()<r.draft().Version():!1}),r.republish=function(){var e=s.createPublicationContent(this.draft());o.republish(this.sitemapNode().Id(),e)}}var y=n.observableArray(),w=n.observable(),k=n.observable(),x=!1,D=n.observable(!1),C=new u,F=new c;F.refreshResults=function(){N.refresh()},r.on("caps:draft:saved",function(e){var t=e.entity;w()&&w().draftId()===t.Id()&&h(w().draftId()),e.isNewDraft&&f().then(function(){N.selectDraftById(t.Id())})}),r.on("caps:draft:deleted",function(){f().then(m)}),r.on("caps:publication:created",d),r.on("caps:publication:refreshed",d);var N={items:y,selectedItem:w,draftPreview:k,isLoading:D,searchControl:F,activate:function(){x||(x=!0,f().then(m))},addDraft:function(){e.router.navigate("#drafts/create")},editDraft:function(t){e.router.navigate("#drafts/edit/"+t.draftId())},editSelectedDraft:function(){N.editDraft(w())},selectDraft:function(e){w(e),k(null),h(e.draftId())},selectDraftById:function(e){var t=n.utils.arrayFirst(y(),function(t){return t.draftId()===e});t&&N.selectDraft(t)},publishDraft:function(){try{var t=s.createPublicationContent(k().entity());r.selectSiteMapNode({module:e,okTitle:"Veröffentlichen"}).then(function(e){e.dialogResult&&o.publish(t,e.selectedNode).fail(function(e){alert(e.message)})})}catch(n){alert(n.message)}},refresh:function(){f()},deleteDraft:function(){C.execute(w().draftId())}};return g.prototype.formatDate=function(e){return i(e).calendar()},N});
...
define('modules/sitemap/viewmodels/editor',["../module","ko","entityManagerProvider","breeze","durandal/app"],function(e,t,n,r,i){function a(){function r(e){var t=(new o).from("SiteMapNodes").where("Id","==",e).expand("Resources");return u.executeQuery(t)}function a(e){if(!e||!e.length)return l();var n=t.utils.arrayFirst(s,function(e){return e.name&&e.name.toLowerCase()===c.entity().NodeType().toLowerCase()});return n||l()}function l(){return t.utils.arrayFirst(s,function(e){return e.isCustomType})}var u,c=this;c.entity=t.observable(),c.nodeTypes=s,c.nodeType=t.observable(),c.nodeType.subscribe(function(e){e&&e.name&&c.entity().NodeType(e.name)}),c.activate=function(e){u=n.createManager(),r(e).then(function(e){c.entity(e.results[0]),c.nodeType(a(e.results[0].NodeType()))})},c.navigateBack=function(){e.router.navigate(e.routeConfig.hash)},c.saveChanges=function(){u.saveChanges().then(function(){i.trigger("caps:sitemapnode:saved",c.entity()),c.navigateBack()})}}var o=r.EntityQuery,s=[{title:"Inhalts-Seite",name:"PAGE"},{title:"Statische Seite",name:"ACTION"},{title:"Startseite",name:"ROOT",isRoot:!0},{title:"Aufmacher",name:"TEASER"},{title:"Benutzerdefiniert",isCustomType:!0,name:""}];return a});
...
define('modules/sitemap/viewmodels/index',["../module","ko","infrastructure/datacontext","plugins/router","entityManagerProvider","breeze","durandal/system","durandal/app","localization","infrastructure/contentReferences","infrastructure/urlHelper","infrastructure/treeViewModel","moment","./siteMapViewModel","infrastructure/publicationService","authentication"],function(e,t,n,r,i,a,o,s,l,u,c,d,f,p,h,m){function v(e){w(e)&&x(e.Id()).then(function(){I()&&I().refreshTree(),g()})}function g(){if(T(null),M()&&M().ContentId()){var e=(new N).from("Publications").where("Id","==",M().ContentId()).expand("Translations, ContentParts.Resources, Files.Resources.FileVersion.File");D.executeQuery(e).then(function(){var e=new C(M());T(e)}).fail(function(e){alert(e.message)})}b()}function b(){if(S(null),M()){var e=t.utils.arrayFilter(M().childNodes(),function(e){return"teaser"===e.NodeType().toLowerCase()});S(e)}}function y(e){return t.utils.arrayFirst(L.sitemaps(),function(t){return t.entity()===e})}function w(e){var t=I();return e&&t&&e.SiteMapId()===t.entity().Id()}function k(){var e=(new N).from("Websites").expand("SiteMapVersions").take(1);return D.executeQuery(e)}function x(e){var t=(new N).from("SiteMapNodes").where("Id","==",e).expand("Resources");return D.executeQuery(t)}function C(e){var n=this;n.sitemapNode=e,n.template=t.observable(),e&&e.Content()&&n.template(e.Content().template()),n.findContentPart=function(e){if(M()&&M().Content()){var t=M().Content().getContentPart(e.name);if(t){var n=M().Content(),r=t.getResource("de").Content();return _.replaceReferences(n,r,"de")}}return""}}var D=i.createManager(),N=a.EntityQuery,F=t.observable(),I=t.observable(),M=t.observable(),S=t.observableArray(),T=t.observable(),E=l.website.supportedTranslations(),P=!1,_=new u({replaceFileReference:function(e,t){var n=e.context,r=n.findFile(e.fileName),i=r.getResource(t),a=null!==i?i.FileVersion():void 0;return c.getFileUrl(e.fileName,a,e.query)},replacePublicationReference:function(e,t){return c.getPublicationUrl(e.id,t,e.query)}});I.subscribe(function(e){M(null),e&&e.fetchTree().then(function(){e.entity().rootNodes().length&&e.selectNodeByKey(e.entity().rootNodes()[0].Id())})}),M.subscribe(g),s.on("caps:sitemapnode:saved",function(e){w(e)&&x(e.Id())}),s.on("caps:publication:created",v),s.on("caps:publication:refreshed",v);var L={website:F,sitemaps:t.computed(function(){var e=F()?F().sortedSiteMapVersions():[];return t.utils.arrayMap(e,function(e){var t=new p(e,D);return t.selectedNodeChanged=function(e){e&&M(e.entity())},t})}),selectedSitemap:I,selectedNode:M,teasers:S,supportedTranslations:E,contentPreview:T,activate:function(){P||(P=!0,k().then(function(e){F(e.results[0]),I(y(F().latestSitemap()))}))},createSitemapVersion:function(){function e(e){var t=e.createEntity("DbSiteMap",{WebsiteId:F().Id(),Version:n}),r=e.createEntity("DbSiteMapNode",{NodeType:"ROOT",Name:"HOME"}),i=r.getOrCreateResource("de",e);return r.SiteMapId(t.Id()),i.Title("Startseite"),e.addEntity(r),t}try{if(F()){var t=F().latestSitemap(),n=t?t.Version()+1:1,r=t?t.createNewVersion(n,D):e(D);D.saveChanges().then(function(){I(y(r))}).fail(function(e){o.log(e)})}}catch(i){alert(i.message)}},deleteSitemapVersion:function(){var e="Sitemap-Version verwerfen",t="Abbrechen";s.showMessage("Soll diese Version wirklich verworfen werden?","Sitemap-Version verwerfen?",[e,t]).then(function(t){if(t===e){var n=I().entity();if(n){var r=n.nextVersion()||n.previousVersion();try{n.setDeleted(),I(y(r))}catch(i){alert("Die Version konnte nicht gelöscht werden.")}D.saveChanges().fail(function(e){alert(e.message)})}}})},publishSitemapVersion:function(){I().entity().PublishedFrom(new Date),I().entity().PublishedBy(m.user().userName()),D.saveChanges()},createSitemapNode:function(){var e=I();if(e&&M()){var t=D.createEntity("DbSiteMapNode",{NodeType:"PAGE"});D.addEntity(t),t.ParentNodeId(M().Id()),t.SiteMapId(e.entity().Id());var n=t.getOrCreateResource("de",D);n.Title("Seite "+(new Date).toLocaleTimeString()),D.saveChanges().then(function(){e.refreshTree(),e.selectNodeByKey(t.Id())}).fail(function(e){alert(e.message)})}},deleteSitemapNode:function(){function e(e){return e.setDeleted(),D.saveChanges()}var t=I();if(t&&M()){var n="Seite löschen",r="Abbrechen";s.showMessage("Soll die Seite wirklich gelöscht werden?","Seite löschen",[n,r]).then(function(r){if(r===n){var i=M(),a=i.nextNode()||i.previousNode()||i.ParentNode();e(i).then(function(){t.refreshTree(),a&&t.selectNodeByKey(a.Id())}).fail(function(e){alert(e.message)})}})}},editWebsite:function(){r.navigate("#website")},editTranslation:function(t){M()&&e.router.navigate("#sitemap/translate/"+M().Id()+"/"+t.culture)},editSitemapNode:function(){M()&&e.router.navigate("#sitemap/edit/"+M().Id())},moveSelectedNodeUp:function(){M()&&(M().moveUp(),D.saveChanges().then(function(){I()&&I().refreshTree()}))},moveSelectedNodeDown:function(){M()&&(M().moveDown(),D.saveChanges().then(function(){I()&&I().refreshTree()}))},moveSelectedNode:function(){function t(e){return e.Id()!==M().Id()}if(I()){var n=I(),r=M();s.selectSiteMapNode({module:e,nodeFilter:t,siteMapId:n.entity().Id(),canSelectSiteMap:!1}).then(function(e){e.dialogResult&&e.selectedNode&&e.selectedNode.Id()!==r.ParentNodeId()&&(r.reparent(e.selectedNode),D.saveChanges().then(function(){n.refreshTree(),n.tree().selectedNode().ensureVisible()}))})}},createTeaser:function(){if(M()){var e=I().entity().Id(),t=I().tree().root.childNodes()[0].entity().Id();h.createTeaser(e,t,M().Id())}}};return L});
