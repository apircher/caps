...
define('modules/sitemap/viewmodels/index',["../module","ko","plugins/router","durandal/system","durandal/app","localization","./siteMapViewModel","./publicationViewModel","infrastructure/publicationService","authentication","../datacontext","durandal/composition","moment","infrastructure/keyboardHandler","infrastructure/scrollState"],function(e,t,n,r,i,a,o,s,l,u,c,d,f,p,h){function m(e){x(e)&&c.fetchSiteMapNode(e.Id()).then(function(){T()&&T().refreshTree(),b()})}function v(e){E(null),e&&e.fetchTree().then(function(){if(E()){var t=e.tree().findNodeByKey(E().Id());if(t)return t.selectNode(),void 0}e.selectRootNode()})}function g(e){_(null),b(),y(e)}function b(){P(null),E()&&E().ContentId()&&c.fetchPublication(E().ContentId()).then(function(){var e=new s(E());P(e)}).fail(C)}function y(e){R(null),e&&R(new I(e))}function w(e){var n=t.utils.arrayFirst(B.siteMapVersions(),function(t){return t.entity()===e});T(n)}function k(e){var t=new o(e);return t.selectedNodeChanged=function(e){e&&E(e.entity())},t}function x(e){return T()&&T().containsNode(e)}function C(e){r.log(e.message),alert(e.message)}function N(e){var t=T();if(t&&e){var n=e.nextNode()||e.previousNode()||e.ParentNode();c.deleteSiteMapNode(e).then(function(){t.refreshTree(),n&&t.selectNodeByKey(n.Id()),i.trigger("caps:sitemapnode:deleted",e)}).fail(C)}}function D(){c.fetchFirstWebsite().then(function(e){M(e.results[0]),w(M().latestSiteMap())}).fail(C)}function F(e){c.fetchSiteMapNodeByContentId(e).then(function(e){if(!e.results.length)return D(),void 0;var t=e.results[0],n=t.SiteMap();M(n.Website()),w(n),E(t)}).fail(C)}function S(e){var n=this;n.entity=e,n.isSelected=t.computed(function(){return _()===n}),n.selectTeaser=function(){_(n),y(n.entity)}}function I(n){var r=this;r.entity=n,r.supportedTranslations=a.website.supportedTranslations(),r.edit=function(){n&&e.router.navigate("#sitemap/edit/"+n.Id())},r.editTranslation=function(t){n&&e.router.navigate("#sitemap/translate/"+n.Id()+"/"+t.culture)},r.createTeaser=function(){if(n){var e=n.SiteMap().Id(),t=n.SiteMap().rootNodes()[0].Id();l.createTeaser(e,t,n.Id())}},r.canCreateTeaser=function(){return n?"ROOT"==n.NodeType()||n.hasTeasers()?!1:n.isTeaser()?!1:!0:!1},r.deleteTeaser=function(){var e="Aufmacher löschen",t="Abbrechen";i.showMessage('Soll der Aufmacher "'+r.entity.localeTitle("de")+'" wirklich gelöscht werden?',"Aufmacher löschen",[e,t]).then(function(t){t===e&&N(r.entity)})},r.hasOptions=t.computed(function(){return r.entity.isTeaser()||r.canCreateTeaser()}),r.hasContent=t.computed(function(){return n&&n.Content()}),r.contentSummary=t.computed(function(){if(!n.ContentId())return"Kein Inhalt festgelegt";var e=n.Content();return e?e.EntityType()+" #"+e.EntityKey()+" (v."+e.ContentVersion()+")":""}),r.authorSummary=t.computed(function(){if(!n.ContentId()||!n.Content())return"";var e=n.Content();return e.AuthorName()+" "+f(e.ContentDate()).fromNow()}),r.selectContent=function(){function t(e){l.setNodeContent(r.entity.Id(),e).fail(function(e){alert(e.message)})}isActive=!1,i.selectContent({module:e}).then(function(e){e.dialogResult&&t(e.selectedContent)}).finally(function(){isActive=!0})},r.editContent=function(){n.ContentId()&&n.Content()&&i.editContent(n.Content().EntityType(),n.Content().EntityKey())}}var M=t.observable(),T=t.observable(),E=t.observable(),P=t.observable(),_=t.observable(),R=t.observable(),L=!1,A=new p(e),V=new h(e);T.subscribe(v),E.subscribe(g),i.on("caps:sitemapnode:saved",function(e){x(e)&&c.fetchSiteMapNode(e.Id())}),i.on("caps:publication:created",m),i.on("caps:publication:refreshed",m);var O=$(window);e.on("module:compositionComplete",function(e,t){t===B&&(O.trigger("forceViewportHeight:refresh"),V.activate())});var B={website:M,siteMapVersions:t.computed(function(){var e=M()?M().sortedSiteMapVersions():[];return t.utils.arrayMap(e,k)}),selectedSiteMap:T,selectedNode:E,selectedPublication:P,properties:R,listScrollState:V,teasers:t.computed(function(){if(!E())return[];var e=t.utils.arrayFilter(E().childNodes(),function(e){return e.isTeaser()});return t.utils.arrayMap(e,function(e){return new S(e)})}),activate:function(e){L||(L=!0,e&&e.p||D()),e&&e.p&&F(e.p),A.activate()},shouldActivate:function(){return!0},deactivate:function(){A.deactivate(),V.deactivate()},createSiteMapVersion:function(){c.createNewSiteMapVersion(M()).then(w).fail(C)},deleteSiteMapVersion:function(){var e="Sitemap-Version verwerfen",t="Abbrechen",n=T().entity();n&&i.showMessage("Soll diese Version wirklich verworfen werden?","Sitemap-Version verwerfen?",[e,t]).then(function(t){if(t===e){var r=n.nextVersion()||n.previousVersion();w(r),c.deleteSiteMapVersion(n).fail(C)}})},publishSiteMapVersion:function(){c.publishSiteMap(T().entity(),u.user().userName())},createSiteMapNode:function(){T()&&E()&&c.createSiteMapNode(T().entity(),E()).then(function(e){T().refreshTree(),T().selectNodeByKey(e.Id())}).fail(C)},deleteSiteMapNode:function(){var e="Seite löschen",t="Abbrechen";i.showMessage('Soll die Seite "'+E().localeTitle("de")+'" wirklich gelöscht werden?',"Seite löschen",[e,t]).then(function(t){t===e&&N(E())})},editWebsite:function(){n.navigate("#website")},moveSelectedNodeUp:function(){E()&&(E().moveUp(),c.saveChanges().then(function(){T()&&T().refreshTree()}))},moveSelectedNodeDown:function(){E()&&(E().moveDown(),c.saveChanges().then(function(){T()&&T().refreshTree()}))},moveSelectedNode:function(){function t(e){return!e.isTeaser()&&e.Id()!==E().Id()}if(T()){var n=T(),r=E();i.selectSiteMapNode({module:e,nodeFilter:t,siteMapId:n.entity().Id(),canSelectSiteMap:!1}).then(function(e){e.dialogResult&&e.selectedNode&&e.selectedNode.Id()!==r.ParentNodeId()&&(r.reparent(e.selectedNode),c.saveChanges().then(function(){n.refreshTree(),n.tree().selectedNode().ensureVisible()}))})}}};return A.keydown=function(e){T()&&T().tree()&&T().tree().handleKeyDown(e)},B});
