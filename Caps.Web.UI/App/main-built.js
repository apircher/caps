...
define('modules/contentfile/viewmodels/detail',["durandal/system","durandal/app","knockout","../module","../datacontext","moment","infrastructure/utils","infrastructure/tagService","infrastructure/serverUtil"],function(e,t,n,r,i,a,o,s,l){function c(){function c(){return e.defer(function(e){k(!0),i.fetchFile(g()).then(function(){b(i.localGetFile(g())),e.resolve(b())}).fail(e.fail).done(function(){k(!1)})}).promise()}function d(){w(n.utils.arrayMap(b().Versions(),function(e){return new p(e)})),y(w()[0])}function u(){k(!0)}function f(){k(!1),i.detachContentFile(b()),c().then(function(){d(),t.trigger("caps:contentfile:replaced",b())})}function h(e){D([]),i.getThumbnailInfo(e).then(function(e){D(n.utils.arrayMap(e,function(e){return new v(e)}))})}function p(e){var r=this;r.entity=e,r.isCurrentVersion=n.computed(function(){return y()&&r.entity.Id()===y().entity.Id()}),r.isInUse=n.computed(function(){return r.entity.DraftFileResources().length>0||r.entity.PublicationFileResources().length>0}),r.remove=function(){w.remove(r)},r.select=function(){y(r)},r.navigateToResourceOwner=function(e){t.trigger("caps:contentfile:navigateToResourceOwner",e)}}function v(e){var t=this;t.name=n.computed(function(){return e.name}),t.deleteThumbnail=function(){i.deleteThumbnail(e.fileVersionId,e.id).then(function(){D.remove(t)})}}var m=this,g=n.observable(0),b=n.observable(),y=n.observable(),w=n.observableArray(),k=n.observable(!1),x=n.observable(),N=n.observable(!1),S=t.uploadManager,D=n.observableArray();m.fileId=g,m.file=b,m.fileVersion=y,m.versions=w,m.isLoading=k,m.uploadManager=S,m.thumbnails=D,m.addTagUIVisible=N,m.tagName=x,m.moment=a,m.utils=o,m.server=l,m.activate=function(e){return b(null),g(e),x(null),N(!1),t.on("uploadManager:uploadStarted",u),t.on("uploadManager:uploadDone",f),c().then(function(){d(),h(y().entity.Id())}).fail(function(e){alert(e.message)})},m.deactivate=function(){t.off("uploadManager:uploadStarted",u),t.off("uploadManager:uploadDone",f)},m.uploadedFromNowBy=n.computed(function(){return y()&&y().entity?a(y().entity.Modified().At()).fromNow()+" von "+y().entity.Modified().By():""}),m.uploadedAt=n.computed(function(){return y()&&y().entity?a(y().entity.Modified().At()).format("LLLL"):""}),m.refresh=function(){return c()},m.navigateBack=function(){r.router.navigate(r.routeConfig.hash)},m.previewTemplate=function(e){return e&&e.File()&&e.File().isImage()?"file-preview-image":"file-preview-general"},m.tagNames=n.computed(function(){return n.utils.arrayMap(s.tags(),function(e){return e.Name()})}),m.addTag=function(){N(!0);var e=x();e&&e.length&&s.getOrCreateTag(e).then(function(e){return i.addFileTag(b(),e)}).fail(function(e){window.alert(e.message||e.responseText)}).done(function(){t.trigger("caps:tag:added",x()),x("")})},m.cancelAddTag=function(){x(null),N(!1)},m.updateTagName=function(e,t,n){x(n.value)},m.removeTag=function(e){i.removeFileTag(b(),e).then(function(e){var r=n.utils.arrayFilter(e.entities,function(e){return"Tag"==e.entityType.shortName});n.utils.arrayForEach(r,function(e){t.trigger("caps:tag:deleted",e)})}).fail(function(){alert(err.message||err.responseText)}).done(function(){t.trigger("caps:tag:removed",e)})},m.deleteVersion=function(e){t.showMessage("Soll die Version wirklich gelöscht werden?","Version löschen?",["Ok","Abbrechen"]).then(function(t){"Ok"===t&&i.deleteFileVersion(e.entity).then(function(){if(e.remove(),e.isCurrentVersion()){var t=b().nextVersion(e)||b().previousVersion(e);y(new p(t))}})})},m.deleteFile=function(){t.showMessage("Soll die Datei wirklich gelöscht werden?","Datei löschen?",["Ok","Abbrechen"]).then(function(e){"Ok"===e&&i.deleteFile(b()).then(function(){t.trigger("caps:file:deleted",b()),m.navigateBack()})})}}return c});
