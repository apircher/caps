...
define('plugins/router',["durandal/system","durandal/app","durandal/activator","durandal/events","durandal/composition","plugins/history","knockout","jquery"],function(e,t,n,r,i,a,o,s){function l(e){return e=e.replace(b,"\\$&").replace(v,"(?:$1)?").replace(m,function(e,t){return t?e:"([^/]+)"}).replace(g,"(.*?)"),new RegExp("^"+e+"$",w?void 0:"i")}function u(e){var t=e.indexOf(":"),n=t>0?t-1:e.length;return e.substring(0,n)}function c(e,t){return-1!==e.indexOf(t,e.length-t.length)}function d(e,t){if(!e||!t)return!1;if(e.length!=t.length)return!1;for(var n=0,r=e.length;r>n;n++)if(e[n]!=t[n])return!1;return!0}function f(e){return e.queryString?e.fragment+"?"+e.queryString:e.fragment}var p,h,v=/\((.*?)\)/g,m=/(\(\?)?:\w+/g,g=/\*\w+/g,b=/[\-{}\[\]+?.,\\\^$|#\s]/g,y=/\/$/,w=!1,k=function(){function i(e,t){return e.router&&e.router.parent==t}function s(e){P&&P.config.isActive&&P.config.isActive(e)}function v(t,n){e.log("Navigation Complete",t,n);var r=e.getModuleId(M);r&&A.trigger("router:navigation:from:"+r),M=t,s(!1),P=n,s(!0);var a=e.getModuleId(M);a&&A.trigger("router:navigation:to:"+a),i(t,A)||A.updateDocumentTitle(t,n),E(!1),h.explicitNavigation=!1,h.navigatingBack=!1,A.trigger("router:navigation:complete",t,n,A)}function m(t,n){e.log("Navigation Cancelled"),A.activeInstruction(P),P&&A.navigate(f(P),!1),E(!1),h.explicitNavigation=!1,h.navigatingBack=!1,A.trigger("router:navigation:cancelled",t,n,A)}function g(t){e.log("Navigation Redirecting"),E(!1),h.explicitNavigation=!1,h.navigatingBack=!1,A.navigate(t,{trigger:!0,replace:!0})}function b(t,n,r){h.navigatingBack=!h.explicitNavigation&&M!=r.fragment,A.trigger("router:route:activating",n,r,A),t.activateItem(n,r.params).then(function(e){if(e){var a=M;if(v(n,r),i(n,A)){var o=r.fragment;r.queryString&&(o+="?"+r.queryString),n.router.loadUrl(o)}a==n&&(A.attached(),A.compositionComplete())}else t.settings.lifecycleData&&t.settings.lifecycleData.redirect?g(t.settings.lifecycleData.redirect):m(n,r);p&&(p.resolve(),p=null)}).fail(function(t){e.error(t)})}function w(t,n,r){var i=A.guardRoute(n,r);i?i.then?i.then(function(i){i?e.isString(i)?g(i):b(t,n,r):m(n,r)}):e.isString(i)?g(i):b(t,n,r):m(n,r)}function x(e,t,n){A.guardRoute?w(e,t,n):b(e,t,n)}function C(e){return P&&P.config.moduleId==e.config.moduleId&&M&&(M.canReuseForRoute&&M.canReuseForRoute.apply(M,e.params)||!M.canReuseForRoute&&M.router&&M.router.loadUrl)}function N(){if(!E()){var t=T.shift();T=[],t&&(E(!0),A.activeInstruction(t),C(t)?x(n.create(),M,t):e.acquire(t.config.moduleId).then(function(n){var r=e.resolveObject(n);x(_,r,t)}).fail(function(n){e.error("Failed to load routed module ("+t.config.moduleId+"). Details: "+n.message)}))}}function D(e){T.unshift(e),N()}function I(e,t,n){for(var r=e.exec(t).slice(1),i=0;i<r.length;i++){var a=r[i];r[i]=a?decodeURIComponent(a):null}var o=A.parseQueryString(n);return o&&r.push(o),{params:r,queryParams:o}}function S(t){A.trigger("router:route:before-config",t,A),e.isRegExp(t)?t.routePattern=t.route:(t.title=t.title||A.convertRouteToTitle(t.route),t.moduleId=t.moduleId||A.convertRouteToModuleId(t.route),t.hash=t.hash||A.convertRouteToHash(t.route),t.routePattern=l(t.route)),t.isActive=t.isActive||o.observable(!1),A.trigger("router:route:after-config",t,A),A.routes.push(t),A.route(t.routePattern,function(e,n){var r=I(t.routePattern,e,n);D({fragment:e,queryString:n,config:t,params:r.params,queryParams:r.queryParams})})}function F(t){if(e.isArray(t.route))for(var n=t.isActive||o.observable(!1),r=0,i=t.route.length;i>r;r++){var a=e.extend({},t);a.route=t.route[r],a.isActive=n,r>0&&delete a.nav,S(a)}else S(t);return A}var M,P,T=[],E=o.observable(!1),_=n.create(),A={handlers:[],routes:[],navigationModel:o.observableArray([]),activeItem:_,isNavigating:o.computed(function(){var e=_(),t=E(),n=e&&e.router&&e.router!=A&&e.router.isNavigating()?!0:!1;return t||n}),activeInstruction:o.observable(null),__router__:!0};return r.includeIn(A),_.settings.areSameItem=function(e,t,n,r){return e==t?d(n,r):!1},A.parseQueryString=function(e){var t,n;if(!e)return null;if(n=e.split("&"),0==n.length)return null;t={};for(var r=0;r<n.length;r++){var i=n[r];if(""!==i){var a=i.split("=");t[a[0]]=a[1]&&decodeURIComponent(a[1].replace(/\+/g," "))}}return t},A.route=function(e,t){A.handlers.push({routePattern:e,callback:t})},A.loadUrl=function(t){var n=A.handlers,r=null,i=t,o=t.indexOf("?");if(-1!=o&&(i=t.substring(0,o),r=t.substr(o+1)),A.relativeToParentRouter){var s=this.parent.activeInstruction();i=s.params.join("/"),i&&"/"==i.charAt(0)&&(i=i.substr(1)),i||(i=""),i=i.replace("//","/").replace("//","/")}i=i.replace(y,"");for(var l=0;l<n.length;l++){var u=n[l];if(u.routePattern.test(i))return u.callback(i,r),!0}return e.log("Route Not Found"),A.trigger("router:route:not-found",t,A),P&&a.navigate(f(P),{trigger:!1,replace:!0}),h.explicitNavigation=!1,h.navigatingBack=!1,!1},A.updateDocumentTitle=function(e,n){n.config.title?document.title=t.title?n.config.title+" | "+t.title:n.config.title:t.title&&(document.title=t.title)},A.navigate=function(e,t){return e&&-1!=e.indexOf("://")?(window.location.href=e,!0):(h.explicitNavigation=!0,a.navigate(e,t))},A.navigateBack=function(){a.navigateBack()},A.attached=function(){A.trigger("router:navigation:attached",M,P,A)},A.compositionComplete=function(){E(!1),A.trigger("router:navigation:composition-complete",M,P,A),N()},A.convertRouteToHash=function(e){if(A.relativeToParentRouter){var t=A.parent.activeInstruction(),n=t.config.hash+"/"+e;return a._hasPushState&&(n="/"+n),n=n.replace("//","/").replace("//","/")}return a._hasPushState?e:"#"+e},A.convertRouteToModuleId=function(e){return u(e)},A.convertRouteToTitle=function(e){var t=u(e);return t.substring(0,1).toUpperCase()+t.substring(1)},A.map=function(t,n){if(e.isArray(t)){for(var r=0;r<t.length;r++)A.map(t[r]);return A}return e.isString(t)||e.isRegExp(t)?(n?e.isString(n)&&(n={moduleId:n}):n={},n.route=t):n=t,F(n)},A.buildNavigationModel=function(t){for(var n=[],r=A.routes,i=t||100,a=0;a<r.length;a++){var o=r[a];o.nav&&(e.isNumber(o.nav)||(o.nav=++i),n.push(o))}return n.sort(function(e,t){return e.nav-t.nav}),A.navigationModel(n),A},A.mapUnknownRoutes=function(t,n){var r="*catchall",i=l(r);return A.route(i,function(o,s){var l=I(i,o,s),u={fragment:o,queryString:s,config:{route:r,routePattern:i},params:l.params,queryParams:l.queryParams};if(t)if(e.isString(t))u.config.moduleId=t,n&&a.navigate(n,{trigger:!1,replace:!0});else if(e.isFunction(t)){var c=t(u);if(c&&c.then)return c.then(function(){A.trigger("router:route:before-config",u.config,A),A.trigger("router:route:after-config",u.config,A),D(u)}),void 0}else u.config=t,u.config.route=r,u.config.routePattern=i;else u.config.moduleId=o;A.trigger("router:route:before-config",u.config,A),A.trigger("router:route:after-config",u.config,A),D(u)}),A},A.reset=function(){return P=M=void 0,A.handlers=[],A.routes=[],A.off(),delete A.options,A},A.makeRelative=function(t){return e.isString(t)&&(t={moduleId:t,route:t}),t.moduleId&&!c(t.moduleId,"/")&&(t.moduleId+="/"),t.route&&!c(t.route,"/")&&(t.route+="/"),t.fromParent&&(A.relativeToParentRouter=!0),A.on("router:route:before-config").then(function(e){t.moduleId&&(e.moduleId=t.moduleId+e.moduleId),t.route&&(e.route=""===e.route?t.route.substring(0,t.route.length-1):t.route+e.route)}),A},A.createChildRouter=function(){var e=k();return e.parent=A,e},A};return h=k(),h.explicitNavigation=!1,h.navigatingBack=!1,h.makeRoutesCaseSensitive=function(){w=!0},h.targetIsThisWindow=function(e){var t=s(e.target).attr("target");return!t||t===window.name||"_self"===t||"top"===t&&window===window.top?!0:!1},h.activate=function(t){return e.defer(function(n){if(p=n,h.options=e.extend({routeHandler:h.loadUrl},h.options,t),a.activate(h.options),a._hasPushState)for(var r=h.routes,i=r.length;i--;){var o=r[i];o.hash=o.hash.replace("#","")}s(document).delegate("a","click",function(e){if(a._hasPushState){if(!e.altKey&&!e.ctrlKey&&!e.metaKey&&!e.shiftKey&&h.targetIsThisWindow(e)){var t=s(this).attr("href");null==t||"#"===t.charAt(0)||/^[a-z]+:/i.test(t)||(h.explicitNavigation=!0,e.preventDefault(),a.navigate(t))}}else h.explicitNavigation=!0}),a.options.silent&&p&&(p.resolve(),p=null)}).promise()},h.deactivate=function(){a.deactivate()},h.install=function(){o.bindingHandlers.router={init:function(){return{controlsDescendantBindings:!0}},update:function(e,t,n,r,a){var s=o.utils.unwrapObservable(t())||{};if(s.__router__)s={model:s.activeItem(),attached:s.attached,compositionComplete:s.compositionComplete,activate:!1};else{var l=o.utils.unwrapObservable(s.router||r.router)||h;s.model=l.activeItem(),s.attached=l.attached,s.compositionComplete=l.compositionComplete,s.activate=!1}i.compose(e,s,a)}},o.virtualElements.allowedBindings.router=!0},h});
//! moment.js
//! version : 2.5.1
...
define('authentication',["Q","durandal/system","durandal/app","plugins/router","ko","infrastructure/antiForgeryToken","moment","infrastructure/utils"],function(e,t,n,o,r,i,a,s){function u(e,t){var n=t?localStorage:sessionStorage;n.accessToken=e}function c(){return sessionStorage.accessToken||localStorage.accessToken}function l(){localStorage.removeItem("accessToken"),sessionStorage.removeItem("accessToken")}function f(){return t.defer(function(e){$.ajax("~/api/account/authmetadata",{method:"get"}).then(function(t){T.lockoutPeriod=t.lockoutPeriod,T.minRequiredPasswordLength=t.minRequiredPasswordLength,e.resolve()}).fail(function(n){t.log("getMetadata failed: "+n.message),e.reject(n)})}).promise()}function d(){return t.defer(function(e){$.ajax("~/api/account/userinfo",{method:"get"}).then(function(t){P(new k(t.isAuthenticated,t.userName,t.roles,t)),t.IsAuthenticated&&n.trigger("caps:authentication:loggedOn",P()),e.resolve(P())}).fail(function(n){t.log("getCurrentUser failed: "+n.responseJSON.message),401==n.status?(P(new k(!1)),e.resolve(P())):e.reject(n)})}).promise()}function g(e,n){return t.defer(function(t){$.ajax("~/api/account/managementinfo",{method:"get",data:{returnUrl:e,generateState:n}}).then(function(e){t.resolve(e)}).fail(function(e){t.reject(e)})}).promise()}function h(e,n){return t.defer(function(t){$.ajax("~/api/account/externallogins",{method:"get",data:{returnUrl:e,generateState:n}}).then(t.resolve).fail(t.reject)}).promise()}function m(e){return t.defer(function(t){$.ajax("~/api/account/addexternallogin",{method:"post",data:{externalAccessToken:e}}).then(t.resolve).fail(t.reject)}).promise()}function p(e,n){return t.defer(function(t){$.ajax("~/api/account/removelogin",{method:"post",data:{loginProvider:e,providerKey:n}}).then(t.resolve).fail(t.reject)}).promise()}function v(e){return t.defer(function(t){$.ajax("~/api/account/setpassword",{method:"post",data:e}).then(t.resolve).fail(t.reject)}).promise()}function w(){return t.defer(function(e){A()&&!P().isExpired()?e.resolve(P()):P().isExpired()?d().then(e.resolve).fail(e.reject):e.resolve(P())}).promise()}function j(o,r,a){return t.defer(function(s){function c(o){return o.userName&&o.access_token?(u(o.access_token,a),t.log("logon successful"),e.fcall(i.initToken).then(d).then(function(){n.trigger("caps:authentication:loggedOn",P()),s.resolve(o)}).fail(l),void 0):(l(new Error(b(o))),void 0)}function l(e){t.log("logon failed: "+e.message||e.error),s.reject(e)}$.ajax("~/Token?rememberMe="+a,{method:"post",data:{grant_type:"password",UserName:o,Password:r}}).done(c).fail(l)}).promise()}function x(){return t.defer(function(e){$.ajax("~/api/account/logout",{method:"post"}).then(l).then(i.initToken).then(function(){t.log("logoff successful"),n.trigger("caps:authentication:loggedOff"),P(new k),e.resolve()}).fail(e.reject)}).promise()}function R(e){return t.defer(function(t){$.ajax("~/api/account/changepassword",{method:"post",data:e}).then(d).then(t.resolve).fail(t.reject)}).promise()}function k(e,t,n,o,i){var a=this;o=o||{},this.expirationTicket=new S(i),this.isAuthenticated=r.observable(e||!1),this.userName=r.observable(t||""),this.roles=r.observable(n||[]),this.creationDate=r.observable(o.creationDate||new Date),this.lastPasswordChangedDate=r.observable(o.lastPasswordChangedDate),this.firstName=r.observable(o.firstName||""),this.lastName=r.observable(o.lastName||""),this.displayName=r.computed(function(){return a.firstName().length>0?a.firstName():a.lastName().length>0?a.lastName():a.userName()}),this.fullName=r.computed(function(){return"{0} {1}".replace(/\{0\}/,a.firstName()).replace(/\{1\}/,a.lastName()).trim()}),this.hasEverChangedPassword=r.computed(function(){return a.lastPasswordChangedDate()>a.creationDate()}),this.isInRole=function(e){for(var t=0;t<this.roles().length;t++)if(this.roles()[t]==e)return!0;return!1},this.isInAnyRole=function(e){if(!e||0===e.length)return!0;for(var t=0;t<e.length;t++)if(this.isInRole(e[t]))return!0;return!1}}function S(e){this.created=new Date,this.expiration=e||!1}function b(e){var t="Die Anmeldung ist fehlgeschlagen. Versuche es in einigen Minuten nochmal. Melde das Problem, wenn es weiterhin besteht.";if(e){var n=e.Error;if(n){if("ERROR_LOCKED"==n){var o="Dein Konto wurde aufgrund zu vieler ungültiger Anmelde-Versuche gesperrt. Die Sperrung wird nach {0} Minuten automatisch aufgehoben.";return o.replace(/\{0\}/gi,T.lockoutPeriod)}if("ERROR_NOTAPPROVED"==n)return"Dein Konto wurde noch nicht bestätigt.";if("ERROR_USER_OR_PASSWORD_INVALID"==n)return"Der Benutzername oder das Passwort sind ungültig.";if("Bad request"==n)return t}}return e.Error||t}function N(){window.location.hash="","undefined"!=typeof history.pushState&&history.pushState("",document.title,location.pathname)}var P=r.observable(new k),y="viewmodels/login",E="login",D="",T={lockoutPeriod:15,minRequiredPasswordLength:6};$(document).ajaxSend(function(e,t){var n=c();n&&t.setRequestHeader("Authorization","Bearer "+n)});var A=r.computed(function(){return P().isAuthenticated()});return o.logon=function(e){if(e.config.moduleId===y)throw new Error("The logon-Function may not be called with the logon-route.");return o.logonSuccessRoute=e,E},o.redirectFromLogonView=function(){var e=D;if(o.logonSuccessRoute){var t=o.logonSuccessRoute;delete o.logonSuccessRoute,e=t.config.hash}o.navigate(e,{trigger:!0,replace:!0})},o.guardRoute=function(e,n){return t.defer(function(e){w().then(function(){A()||n.config.moduleId===y?(n.config.roles&&!P().isInAnyRole(n.config.roles)&&e.resolve("forbidden"),e.resolve(!0)):e.resolve(o.logon(n))}).fail(e.reject)}).promise()},k.prototype.isExpired=function(){return this.expirationTicket.isExpired()},S.prototype.isExpired=function(){return this.expiration?a(this.created).add("seconds",this.expiration)<new Date:!1},{metadata:T,user:P,logon:j,logoff:x,changePassword:R,setPassword:v,isAuthenticated:A,initialize:function(){function n(){return t.defer(function(t){sessionStorage.associatingExternalLogin?(sessionStorage.removeItem("associatingExternalLogin"),"undefined"!=typeof a.error?(o=null,r=a.error):"undefined"!=typeof a.access_token?(o=a.access_token,r=null):(o=null,r=null),N(),d().then(function(e){e.userName?(window.location.hash="#profile",m(o).then(t.resolve(e))):t.reject()}).fail(t.reject)):"undefined"!=typeof a.error?(N(),t.reject(new Error(a.error))):"undefined"!=typeof a.access_token?(N(),u(a.access_token),e.fcall(i.initToken).then(d().then(t.resolve))):d().then(function(e){t.resolve(e)})}).promise()}var o,r,a=s.getFragment();return f().then(n)},UserModel:k,getAccountManagementInfo:g,getExternalLoginProviders:h,removeLogin:p}});
define('infrastructure/contentControls',[],function(){function e(e,r){return r=r||t,e=e.replace(n,function(e,t,n){return r.call(this,t,e,n)})}function t(e){return'<div class="caps-ccctag">caps:<strong>'+e+"</strong></div>"}var n=/(?:<\s*)caps:([a-zA-Z0-9]*)(?:[^>]*\s*\/>)/gi;return{replaceContentControls:e}});
define('infrastructure/contentEditing',["durandal/app"],function(e){var t={},n={registerEditor:function(e,n,r){t[e]={entityType:e,module:n,edit:r}},findEditor:function(e){return t[e]}};return e.editContent=function(e,t){var r=n.findEditor(e);r&&r.edit(t)},e.registerContentEditor=function(e,t,r){n.registerEditor(e,t,r)},n});
...
define('infrastructure/datacontext',["breeze","entityManagerProvider","durandal/system","durandal/app"],function(e,t,n,r){function o(){var e=(new c).from("Websites");return u.executeQuery(e)}function i(e){var t=(new c).from("SiteMaps").where("WebsiteId","==",e);return u.executeQuery(t)}function a(){var e=c.from("Tags");return u.executeQuery(e)}function s(e){return n.defer(function(t){function n(n){if(n.results.length>0)t.resolve(n.results[0]);else{var o=u.createEntity("Tag",{Name:e});u.addEntity(o),u.saveChanges().done(function(){r.trigger("caps:tags:added",o),t.resolve(o)})}}var o=(new c).from("Tags").where("Name","==",e);u.executeQuery(o).then(n).fail(t.reject)}).promise()}var u=t.createManager(),c=e.EntityQuery;return{getWebsites:o,getSiteMaps:i,getTags:a,getOrCreateTag:s}});
...
define('infrastructure/keyboardHandler',["jquery","ko","durandal/system"],function(e,t,n){function r(e){function r(){i.on("keydown",a)}function o(){i.off("keydown",a)}function a(e){var t=s.keydown;n.isFunction(t)&&t.call(s,e)}var s=this,u=t.observable(!1);e.on("module:activate",function(){u()&&r()}),e.on("module:deactivate",function(){u()&&o()}),s.isActive=u,s.activate=function(){u(!0),r()},s.deactivate=function(){u(!1),o()}}var i=e(window);return r.prototype.keydown=function(e){n.log("Keydown: "+e.keyCode)},r});
...
requirejs.config({paths:{text:"../Scripts/text",durandal:"../Scripts/durandal",plugins:"../Scripts/durandal/plugins",transitions:"../Scripts/durandal/transitions",entityManagerProvider:"infrastructure/entityManagerProvider",authentication:"infrastructure/authentication",localization:"infrastructure/localization","knockout.extenders":"../Scripts/knockout.extenders",typeahead:"../Scripts/typeahead",moment:"../Scripts/moment",doubleTap:"../Scripts/doubleTap"},map:{"*":{ko:"knockout"}}}),define("jquery",function(){return jQuery}),define("knockout",ko),define("knockout.validation",ko.validation),define("Q",function(){return Q}),define("breeze",function(){return breeze}),define("markdown",function(){return Markdown}),define("toastr",function(){return toastr}),define('main',["durandal/app","durandal/viewLocator","durandal/system","Q","authentication","infrastructure/antiForgeryToken","knockout.validation","localization","infrastructure/moduleLoader","plugins/router","jquery","entityManagerProvider","infrastructure/serverUtil","knockout.extenders","infrastructure/validation","../Scripts/safari.cancelZoom","infrastructure/contentEditing"],function(e,t,n,r,i,a,o,s,l,c,d,u,f){function h(){var t={message:"Mindestens ein Bereich enthält ungespeicherte Änderungen.",cancel:!1};return e.trigger("app:beforeunload",t),t.cancel?t.message:void 0}function p(){require(["plugins/dialog"],function(e){e.MessageBox.defaultViewMarkup=['<div data-view="plugins/messageBox" class="messageBox">','<div class="modal-header">','<h4 data-bind="text: title"></h4>',"</div>",'<div class="modal-body">','<p class="message" data-bind="text: message"></p>',"</div>",'<div class="modal-footer" data-bind="foreach: options">',"<button class=\"btn\" data-bind=\"click: function () { $parent.selectOption($data); }, text: $data, css: { 'btn-primary': $index() == 0, 'btn-default': $index() != 0, autofocus: $index() == 0 }\"></button>","</div>","</div>"].join("\n")})}function m(e){e.archiveSessionStorageToLocalStorage=function(){for(var e={},t=0;t<sessionStorage.length;t++)e[sessionStorage.key(t)]=sessionStorage[sessionStorage.key(t)];localStorage.sessionStorageBackup=JSON.stringify(e),sessionStorage.clear()},e.restoreSessionStorageFromLocalStorage=function(){var e,t=localStorage.sessionStorageBackup;if(t){e=JSON.parse(t);for(var n in e)sessionStorage[n]=e[n];localStorage.removeItem("sessionStorageBackup")}}}n.debug(!0),n.defer=function(e){var t=r.defer();e.call(t,t);var n=t.promise;return t.promise=function(){return n},t},d(document).ajaxSend(function(e,t,n){n.url=f.mapPath(n.url)}),m(e),e.restoreSessionStorageFromLocalStorage(),d(window).bind("beforeunload",h),e.title="CAPS",e.configurePlugins({router:!0,dialog:!0,widget:!0,fileSelection:!0,siteMapNodeSelection:!0,contentSelection:!0}),o.init({insertMessages:!1}),s.localize("de"),r.fcall(a.initToken).then(i.initialize).then(l.loadModules(["sitemap","draft","contentfile","user"])).then(u.initialize).then(e.start).then(function(){t.useConvention(),p(),e.setRoot("viewmodels/shell","entrance"),e.trigger("caps:started")}).done()});
define('modules/contentfile/datacontext',["durandal/system","breeze","entityManagerProvider","jquery","infrastructure/userQueryParser"],function(e,t,n,r,i){function a(){var e=w.from("Files");return y.executeQuery(e)}function o(e,t,n,r,i){var a=i?w.from("FilteredFiles").withParameters({filterOptions:i}):w.from("Files"),o=s(a,e).expand("Versions").orderBy(r||"Created.At desc").skip((t-1)*n).take(n).inlineCount(!0);return y.executeQuery(o)}function s(e,t){if(t&&t.length){var n=k.getBreezePredicate(t);if(n)return e.where(n)}return e}function l(e){var t=w.from("Files").where("Id","==",e).expand("Tags.Tag, Versions, Versions.Properties, Versions.DraftFileResources.DraftFile, Versions.PublicationFileResources.PublicationFile");return y.executeQuery(t)}function c(e){return y.getEntityByKey("DbFile",e)}function d(t){return e.defer(function(e){function n(){y.detachEntity(t),e.resolve()}r.ajax("api/DbFile/"+t.Id(),{method:"delete"}).done(n).fail(e.reject)}).promise()}function u(t){return e.defer(function(n){function i(){try{y.detachEntity(t)}catch(r){e.log(r)}n.resolve()}r.ajax("api/DbFileVersion/"+t.Id(),{method:"delete"}).done(i).fail(n.reject)}).promise()}function f(t,n){return e.defer(function(e){var r=w.from("Tags").where("Id","==",n.Id());y.executeQuery(r).then(function(n){var r=n.results[0],i=y.createEntity("DbFileTag",{FileId:t.Id(),TagId:r.Id()});y.addEntity(i),y.saveChanges().fail(e.reject).done(e.resolve)}).fail(e.reject)}).promise()}function h(e,t){return e.Tags.remove(t),t.entityAspect.setDeleted(),y.saveChanges()}function p(e){y.detachEntity(e)}function m(e){var t=y.getEntities("DraftFileResource");t.forEach(function(t){t.DraftFile()&&t.DraftFile().DraftId()==e.Id()&&y.detachEntity(t)})}function v(e){var t=y.getEntities("PublicationFileResource");t.forEach(function(t){t.PublicationFile()&&t.PublicationFile().PublicationId()==e&&y.detachEntity(t)})}function g(e){var t=(new w).from("DraftFiles").where("Id","==",e.Id()),n=y.executeQueryLocally(t);n&&n.length&&n.forEach(function(e){e.Resources()&&e.Resources().forEach(function(e){y.detachEntity(e)}),y.detachEntity(e)})}function b(t){return e.defer(function(e){function n(t){e.resolve(t)}r.ajax("api/dbfile/metadata",{method:"post",traditional:!0,data:{fileNames:t}}).done(n).fail(e.reject)}).promise()}var y=n.createManager(),w=t.EntityQuery,k=new i;return k.translateColumnName=function(e){return e&&e.length&&/autor/i.test(e)?"Created.By":"FileName"},{getFiles:a,fetchFile:l,localGetFile:c,deleteFile:d,deleteFileVersion:u,searchFiles:o,addFileTag:f,removeFileTag:h,detachEntity:p,detachPublicationFileResources:v,detachDraftFileResources:m,detachDraftFile:g,getFileInfo:b,isValidUserQuery:function(e){return k.validate(e)}}});
...
define('modules/contentfile/viewmodels/detail',["durandal/system","durandal/app","knockout","../module","../datacontext","moment","infrastructure/utils","infrastructure/tagService","infrastructure/serverUtil","durandal/composition","moment","./uploadManager"],function(e,t,n,r,i,a,o,s,l,c,a,d){function u(){return e.defer(function(e){b(!0),i.fetchFile(p()).then(function(){m(i.localGetFile(p())),e.resolve(m())}).fail(e.fail).done(function(){b(!1)})}).promise()}function f(e){var r=this;r.entity=e,r.isCurrentVersion=n.computed(function(){return v()&&r.entity.Id()===v().entity.Id()}),r.isInUse=n.computed(function(){return r.entity.DraftFileResources().length>0||r.entity.PublicationFileResources().length>0}),r.remove=function(){g.remove(r)},r.select=function(){v(r)},r.navigateToResourceOwner=function(e){t.trigger("caps:contentfile:navigateToResourceOwner",e)}}function h(){return new d({uploadStarted:function(){b(!0)},uploadDone:function(){b(!1),u().then(function(){t.trigger("caps:contentfile:uploadDone",m())})}})}var p=n.observable(0),m=n.observable(),v=n.observable(),g=n.observableArray(),b=n.observable(!1),y=n.observable(),w=n.observable(!1),k=h();t.on("caps:sitemapnode:deleted",function(e){var t=e.ContentId();i.detachPublicationFileResources(t)}),t.on("caps:draft:deleted",function(e){i.detachDraftFileResources(e)}),t.on("caps:draft:saved",function(e){e.deletedFiles&&e.deletedFiles.length&&e.deletedFiles.forEach(function(e){i.detachDraftFile(e)})});var x=$(window);r.on("module:compositionComplete",function(e,t){t===N&&x.trigger("forceViewportHeight:refresh")});var N={fileId:p,file:m,fileVersion:v,versions:g,isLoading:b,uploadManager:k,uploadedFromNowBy:n.computed(function(){return v()&&v().entity?a(v().entity.Modified().At()).fromNow()+" von "+v().entity.Modified().By():""}),uploadedAt:n.computed(function(){return v()&&v().entity?a(v().entity.Modified().At()).format("LLLL"):""}),activate:function(e){return m(null),p(e),y(null),w(!1),u().then(function(){g(n.utils.arrayMap(m().Versions(),function(e){return new f(e)})),v(g()[0])}).fail(function(e){alert(e.message)})},refresh:function(){return u()},navigateBack:function(){r.router.navigate(r.routeConfig.hash)},previewTemplate:function(e){return e&&e.File()&&e.File().isImage()?"file-preview-image":"file-preview-general"},addTagUIVisible:w,tagNames:n.computed(function(){return n.utils.arrayMap(s.tags(),function(e){return e.Name()})}),tagName:y,addTag:function(){w(!0);var e=y();e&&e.length&&s.getOrCreateTag(e).then(function(e){return i.addFileTag(m(),e)}).fail(function(e){window.alert(e.message||e.responseText)}).done(function(){t.trigger("caps:tag:added",y()),y("")})},cancelAddTag:function(){y(null),w(!1)},updateTagName:function(e,t,n){y(n.value)},removeTag:function(e){i.removeFileTag(m(),e).then(function(e){var r=n.utils.arrayFilter(e.entities,function(e){return"Tag"==e.entityType.shortName});n.utils.arrayForEach(r,function(e){t.trigger("caps:tag:deleted",e)})}).fail(function(){alert(err.message||err.responseText)}).done(function(){t.trigger("caps:tag:removed",e)})},deleteVersion:function(e){t.showMessage("Soll die Version wirklich gelöscht werden?","Version löschen?",["Ok","Abbrechen"]).then(function(t){"Ok"===t&&i.deleteFileVersion(e.entity).then(function(){if(e.remove(),e.isCurrentVersion()){var t=m().nextVersion(e)||m().previousVersion(e);v(new f(t))}})})},deleteFile:function(){t.showMessage("Soll die Datei wirklich gelöscht werden?","Datei löschen?",["Ok","Abbrechen"]).then(function(e){"Ok"===e&&i.deleteFile(m()).then(function(){t.trigger("caps:file:deleted",m()),N.navigateBack()})})},moment:a,utils:o,server:l};return N});
...
define('modules/user/datacontext',["Q","knockout","jquery","modules/user/entities"],function(e,t,n,r){function i(){return d("~/api/User").then(function(e){return n.map(e,function(e){return new r.User(e)})}).fail(function(e){alert(e.message)})}function a(){return d("~/api/usermgmt/GetAllRoles")}function o(e){return d("~/api/User/"+e).then(function(e){return new r.User(e)})}function s(e){return d("~/api/User",{method:"put",data:e.toDto()})}function l(e){return d("~/api/User/"+e.userName(),{method:"post",data:e.toDto()})}function u(e){return d("~/api/User",{method:"delete",data:e.toDto()}).then(function(){return e})}function c(e,t){return d("~/api/usermgmt/SetPassword",{method:"post",data:{UserName:e,NewPassword:t}})}function d(t,r){var i=e.defer();return n.ajax(t,r).done(i.resolve).fail(i.reject),i.promise}return{getAllUsers:i,getAllRoles:a,getUser:o,createUser:s,updateUser:l,deleteUser:u,setPassword:c}});
