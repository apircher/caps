...
define('modules/contentfile/viewmodels/index',["ko","durandal/system","durandal/app","../module","../datacontext","infrastructure/virtualListModel","infrastructure/filterModel","infrastructure/listSortModel","jquery","toastr","Q","doubleTap","infrastructure/tagService","./fileListItem","./uploadManager","./fileSearchControl","infrastructure/serverUtil"],function(e,t,n,i,a,o,s,l,c,u,d,f,h,p,m,v,g){function b(e){var n=S;return console.log("loadPage called. pageNumber="+e+", Filter="+n.currentFilter),t.defer(function(t){N(!0),a.searchFiles(n.searchWords(),e,D.itemsPerPage(),n.sortOptions.getOrderBy(),n.currentFilter).then(function(n){D.addPage(n,e),t.resolve()}).fail(t.reject).done(function(){N(!1)})}).promise()}function y(e){function t(){D.selectedItem()===e&&D.resetSelection(),D.removeItem(e)}function n(){dialog.showMessage("Die Datei konnte nicht gelöscht werden.","Nicht erfolgreich")}return a.deleteFile(e.data()).then(t).fail(n)}function w(){return new m({beforeUpload:function(t,r,i){var o=e.utils.arrayMap(t,function(e){return e.name});a.getFileInfo(o).then(function(t){var r=e.utils.arrayFilter(t,function(e){return e.Count>0});if(r.length>0){var a="Hinzufügen",o="Ersetzen",s="Abbrechen";n.showMessage("Es wurden "+r.length+" Namens-Konflikte gefunden. Wie sollen diese behandelt werden?","Dateien hinzufügen",[a,o,s]).then(function(e){if(e!==s){var t;e===o&&(t={storageAction:"replace"}),i(t)}})}else i()})},uploadStarted:function(e,t,n){n||(e.listItem=D.insertItem(void 0,t),e.listItem.isUploading(!0))},uploadDone:function(e,t){var n=t.listItem||D.findItem(function(t){return t.data().Id()===e.Id});a.fetchFile(e.Id).then(function(){n&&(n.data(a.localGetFile(e.Id)),n.isUploading(!1))}).fail(function(){u.error("Die Datei "+r.FileName+" konnte nicht geladen werden.")})}})}var k,x=!1,D=new o.VirtualList(35,null,p),N=e.observable(!1),I=w(),C=e.observable(!1),F=e.observable(0),S=new v;return i.router.on("router:navigation:attached",function(e){e==k&&C(!0)}),n.on("caps:tags:added",function(e){S.addTagFilter(e)}),n.on("caps:tag:deleted",function(e){S.removeTagFilter(e)}),n.on("caps:file:deleted",function(e){var t=D.findItem(function(t){return t.data().Id()==e.Id()});t&&(D.selectedItem()===t&&D.resetSelection(),D.removeItem(t))}),S.refreshResults=function(){k.refresh()},k={list:D,isLoading:N,uploadManager:I,selectedFile:D.selectedItem,selectedFiles:D.selectedItems,scrollTop:F,isInteractive:C,searchControl:S,server:g,activate:function(){x||(x=!0,b(1))},deactivate:function(){C(!1)},deleteFile:function(e){var t="Datei löschen",r="Abbrechen";n.showMessage("Soll die Datei "+e.data().FileName()+" wirklich gelöscht werden?","Datei löschen",[t,r]).then(function(n){n===t&&y(e)})},deleteSelection:function(){var t=this.selectedFiles();if(0!==t.length){if(1==t.length)return this.deleteFile(t[0]);var r="Auswahl löschen";n.showMessage("Sollen die "+t.length+" ausgewählten Dateien wirklich endgültig gelöscht werden?","Auswahl löschen",[r,"Abbrechen"]).then(function(n){if(n===r){D.suspendEvents=!0;var i=e.utils.arrayMap(t,function(e){return y(e)});d.all(i).then(function(){D.suspendEvents=!1,D.raiseItemsChanged()})}})}},refresh:function(){F(0),D.resetSelection(),D.removeAll(),b(1)},resetSelectedItem:function(){D.resetSelection()},showSelectedFile:function(){this.showDetail(D.selectedItem())},showDetail:function(e){e&&(D.selectItem(e),i.router.navigate("#files/detail/"+e.data().Id()))},loadHandler:function(e,t){function n(e){var n=D.findPage(e);n.isLoaded||n.isLoading||(D.markPageLoading(e),b(e).then(function(){D.markPageLoaded(e),t.pageLoaded(e)}))}if(console.log("loadHandler called. First visible: "+t.firstVisible.index+" (Page #"+t.firstVisible.page+"); Last visible: "+t.lastVisible.index+" (Page #"+t.lastVisible.page+")"),C()){var r=t.firstVisible.viewModel?D.findItemPage(t.firstVisible.viewModel):void 0,i=t.lastVisible.viewModel?D.findItemPage(t.lastVisible.viewModel):void 0;if(r&&i)for(var a=r.index;a<=i.index;a++)n(a+1)}}}});
