...
define('modules/contentfile/viewmodels/detail',["durandal/system","durandal/app","knockout","../module","../datacontext","moment","infrastructure/utils","infrastructure/tagService","infrastructure/serverUtil","durandal/composition","moment","./uploadManager"],function(e,t,n,r,i,a,o,s,l,c,a,u){function d(){return e.defer(function(e){y(!0),i.fetchFile(m()).then(function(){v(i.localGetFile(m())),e.resolve(v())}).fail(e.fail).done(function(){y(!1)})}).promise()}function f(e){var r=this;r.entity=e,r.isCurrentVersion=n.computed(function(){return g()&&r.entity.Id()===g().entity.Id()}),r.isInUse=n.computed(function(){return r.entity.DraftFileResources().length>0||r.entity.PublicationFileResources().length>0}),r.remove=function(){b.remove(r)},r.select=function(){g(r)},r.navigateToResourceOwner=function(e){t.trigger("caps:contentfile:navigateToResourceOwner",e)}}function h(){return new u({uploadStarted:function(){y(!0)},uploadDone:function(){y(!1),d()}})}function p(){c.current.complete(function(){C.trigger("forceViewportHeight:refresh")})}var m=n.observable(0),v=n.observable(),g=n.observable(),b=n.observableArray(),y=n.observable(!1),w=n.observable(),k=n.observable(!1),x=h(),D=!1;r.on("module:activate",function(){D&&p()}),t.on("caps:sitemapnode:deleted",function(e){var t=e.ContentId();i.detachPublicationFileResources(t)}),t.on("caps:draft:deleted",function(e){i.detachDraftFileResources(e)}),t.on("caps:draft:saved",function(e){e.deletedFiles&&e.deletedFiles.length&&e.deletedFiles.forEach(function(e){i.detachDraftFile(e)})});var N={fileId:m,file:v,fileVersion:g,versions:b,isLoading:y,uploadManager:x,uploadedFromNowBy:n.computed(function(){return g()&&g().entity?a(g().entity.Modified().At()).fromNow()+" von "+g().entity.Modified().By():""}),uploadedAt:n.computed(function(){return g()&&g().entity?a(g().entity.Modified().At()).format("LLLL"):""}),activate:function(e){return v(null),m(e),w(null),k(!1),p(),D=!0,d().then(function(){b(n.utils.arrayMap(v().Versions(),function(e){return new f(e)})),g(b()[0])}).fail(function(e){alert(e.message)})},deactivate:function(){D=!1},refresh:function(){return d()},navigateBack:function(){r.router.navigate(r.routeConfig.hash)},previewTemplate:function(e){return e&&e.File()&&e.File().isImage()?"file-preview-image":"file-preview-general"},addTagUIVisible:k,tagNames:n.computed(function(){return n.utils.arrayMap(s.tags(),function(e){return e.Name()})}),tagName:w,addTag:function(){k(!0);var e=w();e&&e.length&&s.getOrCreateTag(e).then(function(e){return i.addFileTag(v(),e)}).fail(function(e){window.alert(e.message||e.responseText)}).done(function(){t.trigger("caps:tag:added",w()),w("")})},cancelAddTag:function(){w(null),k(!1)},updateTagName:function(e,t,n){w(n.value)},removeTag:function(e){i.removeFileTag(v(),e).then(function(e){var r=n.utils.arrayFilter(e.entities,function(e){return"Tag"==e.entityType.shortName});n.utils.arrayForEach(r,function(e){t.trigger("caps:tag:deleted",e)})}).fail(function(){alert(err.message||err.responseText)}).done(function(){t.trigger("caps:tag:removed",e)})},deleteVersion:function(e){t.showMessage("Soll die Version wirklich gelöscht werden?","Version löschen?",["Ok","Abbrechen"]).then(function(t){"Ok"===t&&i.deleteFileVersion(e.entity).then(function(){if(e.remove(),e.isCurrentVersion()){var t=v().nextVersion(e)||v().previousVersion(e);g(new f(t))}})})},deleteFile:function(){t.showMessage("Soll die Datei wirklich gelöscht werden?","Datei löschen?",["Ok","Abbrechen"]).then(function(e){"Ok"===e&&i.deleteFile(v()).then(function(){t.trigger("caps:file:deleted",v()),N.navigateBack()})})},moment:a,utils:o,server:l},C=$(window);return N});
...
define('modules/contentfile/viewmodels/fileSelectionDialog',["plugins/dialog","ko","./fileListItem","durandal/system","../datacontext","infrastructure/virtualListModel","./fileSearchControl","./uploadManager","toastr"],function(e,t,n,i,a,o,s,l,c){function u(e){var i=this;e=e||{},i.title=e.title||"Dateien hinzufügen",i.list=new o.VirtualList(35,null,n),i.isLoading=t.observable(!1),i.selectedFile=i.list.selectedItem,i.selectedFiles=i.list.selectedItems,i.initialized=!1,i.searchControl=new s,i.searchControl.refreshResults=function(){i.list.resetSelection(),i.list.removeAll(),i.loadPage(1)},i.loadHandler=function(e,t){function n(e){var n=this.list.findPage(e);n.isLoaded||n.isLoading||(this.list.markPageLoading(e),this.loadPage(e).then(function(){this.list.markPageLoaded(e),t.pageLoaded(e)}))}var r=t.firstVisible.viewModel?i.list.findItemPage(t.firstVisible.viewModel):void 0,a=t.lastVisible.viewModel?i.list.findItemPage(t.lastVisible.viewModel):void 0;if(r&&a)for(var o=r.index;o<=a.index;o++)n.call(i,o+1)},i.uploadManager=new l({uploadStarted:function(e,t){e.listItem=i.list.insertItem(void 0,t),e.listItem.isUploading(!0)},uploadDone:function(e,t){var n=t.listItem;a.fetchFile(e.Id).then(function(){n.data(a.localGetFile(e.Id)),n.isUploading(!1),n.isSelected(!0)}).fail(function(){c.error("Die Datei "+r.FileName+" konnte nicht geladen werden.")})}})}return u.prototype.activate=function(){this.initialized||(this.initialized=!0,this.loadPage(1))},u.prototype.loadPage=function(e){var t=this,n=t.searchControl;return i.defer(function(r){t.isLoading(!0),a.searchFiles(n.searchWords(),e,t.list.itemsPerPage(),n.sortOptions.getOrderBy(),n.currentFilter).then(function(n){t.list.addPage(n,e),r.resolve()}).fail(r.reject).done(function(){t.isLoading(!1)})}).promise()},u.prototype.selectOk=function(){var n=t.utils.arrayMap(this.selectedFiles(),function(e){return e.data()});!n.length&&this.selectedFile()&&n.push(this.selectedFile().data()),e.close(this,{dialogResult:!0,selectedFiles:n})},u.prototype.selectCancel=function(){e.close(this,{dialogResult:!1})},u.install=function(){require(["plugins/fileSelection"],function(e){e.registerDialog(u)})},u});
...
define('modules/contentfile/viewmodels/index',["ko","durandal/system","durandal/app","../module","../datacontext","infrastructure/virtualListModel","infrastructure/filterModel","infrastructure/listSortModel","jquery","toastr","Q","doubleTap","infrastructure/tagService","./fileListItem","./uploadManager","./fileSearchControl","infrastructure/serverUtil","./fileUploadDialog"],function(e,t,n,i,a,o,s,l,c,u,d,f,h,p,m,v,g,b){function y(e){var n=M;return console.log("loadPage called. pageNumber="+e+", Filter="+n.currentFilter),t.defer(function(t){I(!0),a.searchFiles(n.searchWords(),e,N.itemsPerPage(),n.sortOptions.getOrderBy(),n.currentFilter).then(function(n){N.addPage(n,e),t.resolve()}).fail(t.reject).done(function(){I(!1)})}).promise()}function w(e){function t(){N.selectedItem()===e&&N.resetSelection(),N.removeItem(e)}function n(){dialog.showMessage("Die Datei konnte nicht gelöscht werden.","Nicht erfolgreich")}return a.deleteFile(e.data()).then(t).fail(n)}function k(){return new m({beforeUpload:function(t,r,i){var o=e.utils.arrayMap(t,function(e){return e.name});a.getFileInfo(o).then(function(t){var r=e.utils.arrayFilter(t,function(e){return e.Count>0});if(r.length>0){var a=new b(t);n.showDialog(a).then(function(e){e&&i(e)})}else i()})},uploadStarted:function(e,t,n){var r=n&&"replace"===n.storageAction;r||(e.listItem=N.insertItem(void 0,t),e.listItem.isUploading(!0))},uploadDone:function(e,t){var n=t.listItem||N.findItem(function(t){return t.data()&&t.data().Id()===e.Id});a.fetchFile(e.Id).then(function(){n&&(n.data(a.localGetFile(e.Id)),n.isUploading(!1))}).fail(function(){u.error("Die Datei "+r.FileName+" konnte nicht geladen werden.")})}})}var x,D=!1,N=new o.VirtualList(35,null,p),I=e.observable(!1),C=k(),F=e.observable(!1),S=e.observable(0),M=new v;return i.router.on("router:navigation:attached",function(e){e==x&&F(!0)}),n.on("caps:tags:added",function(e){M.addTagFilter(e)}),n.on("caps:tag:deleted",function(e){M.removeTagFilter(e)}),n.on("caps:file:deleted",function(e){var t=N.findItem(function(t){return t.data().Id()==e.Id()});t&&(N.selectedItem()===t&&N.resetSelection(),N.removeItem(t))}),M.refreshResults=function(){x.refresh()},x={list:N,isLoading:I,uploadManager:C,selectedFile:N.selectedItem,selectedFiles:N.selectedItems,scrollTop:S,isInteractive:F,searchControl:M,server:g,activate:function(){D||(D=!0,y(1))},deactivate:function(){F(!1)},deleteFile:function(e){var t="Datei löschen",r="Abbrechen";n.showMessage("Soll die Datei "+e.data().FileName()+" wirklich gelöscht werden?","Datei löschen",[t,r]).then(function(n){n===t&&w(e)})},deleteSelection:function(){var t=this.selectedFiles();if(0!==t.length){if(1==t.length)return this.deleteFile(t[0]);var r="Auswahl löschen";n.showMessage("Sollen die "+t.length+" ausgewählten Dateien wirklich endgültig gelöscht werden?","Auswahl löschen",[r,"Abbrechen"]).then(function(n){if(n===r){N.suspendEvents=!0;var i=e.utils.arrayMap(t,function(e){return w(e)});d.all(i).then(function(){N.suspendEvents=!1,N.raiseItemsChanged()})}})}},refresh:function(){S(0),N.resetSelection(),N.removeAll(),y(1)},resetSelectedItem:function(){N.resetSelection()},showSelectedFile:function(){this.showDetail(N.selectedItem())},showDetail:function(e){e&&(N.selectItem(e),i.router.navigate("#files/detail/"+e.data().Id()))},loadHandler:function(e,t){function n(e){var n=N.findPage(e);n.isLoaded||n.isLoading||(N.markPageLoading(e),y(e).then(function(){N.markPageLoaded(e),t.pageLoaded(e)}))}if(console.log("loadHandler called. First visible: "+t.firstVisible.index+" (Page #"+t.firstVisible.page+"); Last visible: "+t.lastVisible.index+" (Page #"+t.lastVisible.page+")"),F()){var r=t.firstVisible.viewModel?N.findItemPage(t.firstVisible.viewModel):void 0,i=t.lastVisible.viewModel?N.findItemPage(t.lastVisible.viewModel):void 0;if(r&&i)for(var a=r.index;a<=i.index;a++)n(a+1)}}}});
...
define('modules/draft/viewmodels/editor',["durandal/app","durandal/system","../module","../datacontext","../entities","entityManagerProvider","breeze","ko","Q","./editor/navigation","./editor/draftTemplate","./editor/draftProperties","./editor/draftFiles","./editor/contentPartEditor","./editor/templateEditor","./editor/draftNotes","./editorModel","authentication"],function(e,t,n,r,i,a,o,s,l,u,c,d,f,h,p,m,v,g){function b(){function l(e,t,n){n=n||"de",r.getTemplate(e).then(function(r){var i=r,a=_.createEntity("Draft",{TemplateName:e,Version:1,OriginalLanguage:n,Status:"NEW"});a.Template(JSON.stringify(i)),a.Created().At(new Date),a.Created().By(g.user().userName()),a.Modified().At(new Date),a.Modified().By(g.user().userName()),t&&t.name&&a.Name(t.name),E.entity(a);for(var o=0;o<i.rows.length;o++)for(var s=i.rows[o],l=0;l<s.cells.length;l++){var u=s.cells[l],c=E.getOrCreateContentPart(u);if(u.content){var d=/<%\s*([A-Za-z0-9_\.]+)\s*%>/gi,f=u.content.replace(d,function(e,n){return t&&t[n]?t[n]:v(n)||"Nicht gefunden"});c.getResource("de").Content(f)}}})}function v(e){if(!E.entity()||!E.entity().template())return null;var t=E.entity().template();if(!t.parameters)return null;var n=s.utils.arrayFirst(t.parameters,function(t){return t.name.toLowerCase()===e.toLowerCase()});return n?n.value:null}function b(e){var t=o.EntityQuery.from("Drafts").where("Id","==",e).expand("ContentParts.Resources, Files.Resources.FileVersion.File");return _.executeQuery(t).then(function(e){E.entity(e.results[0])})}function y(){E.entity().setDeleted(),_.saveChanges().then(function(){e.trigger("caps:draft:deleted",E.entity()),E.navigateBack()})}function w(){N=N||new u(E);var e=R.activeInstruction().queryParams;if(e&&e.t)if("DraftProperties"===e.t)E.showProperties();else if("DraftFiles"===e.t)E.showFiles();else{var t=E.entity().findContentPart(e.t);t&&E.showContentPartEditor(t)}E.currentContent()||(I=I||new c(E),E.currentContent(I)),E.currentNavigation(N)}function k(){var e=E.entity();e&&(x(),e.entityAspect.propertyChanged.subscribe(D))}function x(){var e=E.entity();e&&E.template(e.deserializeTemplate())}function D(){n.routeConfig.hasUnsavedChanges(_.hasChanges())}function C(e){var t=s.utils.arrayFirst(P,function(t){return t.contentPart===e});return t||(t=new h(E,e),P.push(t)),t}var N,I,F,S,M,T,E=this,_=a.createManager(),P=[],R=n.router;E.currentContent=s.observable(),E.currentNavigation=s.observable(),E.entity=s.observable(),E.entity.subscribe(k),E.template=s.observable(),E.isNewDraft=s.observable(!1),E.draftStates=i.supportedDraftStates,E.activate=function(e,n){return t.defer(function(t){e&&/^[0-9]+$/.test(e)?b(e).then(function(){w(),t.resolve()}):(E.isNewDraft(!0),l(e,n),w(),t.resolve())}).promise()},E.shouldActivate=function(e,t,n){return t[0]!==n[0]},E.showEditorMain=function(){I=I||new c(E),E.currentContent(I)},E.showFiles=function(){F=F||new f(E),E.currentContent(F)},E.showProperties=function(){S=S||new d(E),E.currentContent(S)},E.showContentPartEditor=function(e){var t=C(e);t&&E.currentContent(t)},E.showTemplateEditor=function(){M=M||new p(E),E.currentContent(M)},E.showDraftNotes=function(){T=T||new m(E),E.currentContent(T)},E.navigateBack=function(){return!E.currentContent()||"ContentPartEditor"!==E.currentContent().name&&"TemplateEditor"!==E.currentContent().name?(E.showDraftsIndex(),void 0):(E.showEditorMain(),void 0)},E.showDraftsIndex=function(){n.routeConfig.hasUnsavedChanges(!1),n.router.navigate(n.routeConfig.hash)},E.saveChanges=function(){E.entity().Modified().At(new Date),E.entity().Modified().By(g.user().userName());var t=_.getEntities("DraftFile",o.EntityState.Deleted);_.saveChanges().then(function(){e.trigger("caps:draft:saved",{entity:E.entity(),isNewDraft:E.isNewDraft(),deletedFiles:t}),E.showDraftsIndex()})},E.deleteDraft=function(){var t="Entwurf löschen",n="Abbrechen";e.showMessage("Soll der Entwurf wirklich gelöscht werden?","Entwurf löschen",[t,n]).then(function(e){e===t&&y()})},E.getOrCreateContentPart=function(e){var t=E.entity().findContentPart(e.name);if(!t){t=_.createEntity("DraftContentPart",{DraftId:E.entity().Id(),Name:e.name,ContentType:e.contentType||"markdown"}),_.addEntity(t);var n=_.createEntity("DraftContentPartResource",{DraftContentPartId:E.entity().Id(),Language:"de",Content:""});_.addEntity(n),t.Resources.push(n),E.entity().ContentParts.push(t)}return t},E.createDraftFile=function(e){var t=o.EntityQuery.from("Files").where("Id","==",e.Id()).expand("Versions.File");return _.executeQuery(t).then(function(t){var n=t.results[0],r=_.createEntity("DraftFile",{Name:e.FileName()});e.isImage()&&r.Determination("Picture"),_.addEntity(r);var i=_.createEntity("DraftFileResource",{Language:"de",DbFileVersionId:n.latestVersion().Id()});return _.addEntity(i),r.Resources.push(i),r.DraftId(E.entity().Id()),E.entity().Files.push(r),r})}}return b});
...
define('modules/draft/viewmodels/index',["../module","../datacontext","ko","durandal/app","moment","localization","infrastructure/publicationService","../contentGenerator","infrastructure/listSortModel","../commands/deleteDraft","./draftSearchControl","infrastructure/interaction","infrastructure/keyCode","durandal/composition"],function(e,t,n,r,i,a,o,s,l,u,c,d,f,h){function p(e){if(e&&F()){var t=e.Content();t&&t.EntityKey()==F().draftId()&&g(F().draftId(),I())}}function m(){var e=E;return S(!0),t.searchDrafts(e.searchWords(),e.sortOptions.getOrderBy()).then(function(e){var t=n.utils.arrayMap(e.results,function(e){return new D(e)});N(t),S(!1)})}function v(e){return t.getDraft(e).then(function(t){var n=t.results[0],r=s.createTemplateContent(t.results[0],"de"),i=new x(n,r);I(i),g(e,i)})}function g(e,r){t.fetchPublications(e).then(function(e){r.publications(n.utils.arrayMap(e,function(e){return new C(r.entity(),e)}))}).fail(function(e){alert(e.message)})}function b(){N().length&&P.selectDraft(N()[0])}function y(){$(window).on("keydown",P.handleKeyDown)}function w(){$(window).off("keydown",P.handleKeyDown)}function k(){h.current.complete(function(){R.trigger("forceViewportHeight:refresh")})}function x(t,r){var o=this,s=new a.Language(t.OriginalLanguage());o.entity=n.observable(t),o.template=n.observable(r),o.originalLanguage=s,o.supportedTranslations=a.website.supportedTranslations(s.culture),o.publications=n.observableArray(),o.createdAt=n.computed(function(){return i(t.Created().At()).format("LLLL")}),o.createdFromNow=n.computed(function(){return i(t.Created().At()).fromNow()}),o.modifiedAt=n.computed(function(){return i(t.Modified().At()).format("LLLL")}),o.modifiedFromNow=n.computed(function(){return i(t.Modified().At()).fromNow()}),o.translateDraft=function(n){e.router.navigate("#drafts/translate/"+t.Id()+"/"+n.culture)}}function D(e){var t=this;t.draftId=n.computed(function(){return e.Id()}),t.createdAt=n.computed(function(){return t.formatDate(e.Created().At())}),t.modifiedAt=n.computed(function(){return t.formatDate(e.Modified().At())}),t.title=n.computed(function(){return e.Name()}),t.isSelected=n.computed(function(){return F()&&F().draftId()===t.draftId()}),t.status=n.computed(function(){return e.statusTitle()}),t.scrollIntoViewRequest=new d.InteractionRequest("ScrollIntoView")}function C(e,t){var r=this;r.draft=n.observable(e),r.sitemapNode=n.observable(t),r.title=n.computed(function(){return r.sitemapNode().path()}),r.contentVersion=n.computed(function(){return r.sitemapNode().Content()?"v."+r.sitemapNode().Content().ContentVersion():""}),r.createdAt=n.computed(function(){return i.utc(r.sitemapNode().Created().At()).fromNow()}),r.createdBy=n.computed(function(){return r.sitemapNode().Created().By()}),r.isOutdated=n.computed(function(){return r.sitemapNode().Content()?r.sitemapNode().Content().ContentVersion()<r.draft().Version():!1}),r.republish=function(){var e=s.createPublicationContent(this.draft());o.republish(this.sitemapNode().Id(),e)}}var N=n.observableArray(),F=n.observable(),I=n.observable(),M=!1,S=n.observable(!1),T=new u,E=new c,_=!1;E.refreshResults=function(){P.refresh()},r.on("caps:draft:saved",function(e){var t=e.entity;F()&&F().draftId()===t.Id()&&v(F().draftId()),e.isNewDraft&&m().then(function(){P.selectDraftById(t.Id())})}),r.on("caps:draft:deleted",function(){m().then(b)}),r.on("caps:publication:created",p),r.on("caps:publication:refreshed",p),e.on("module:activate",function(){_&&(y(),k())}),e.on("module:deactivate",function(){_&&w()});var P={items:N,selectedItem:F,draftPreview:I,isLoading:S,searchControl:E,activate:function(){M||(M=!0,m().then(b)),y(),k(),_=!0},deactivate:function(){_=!1,w()},addDraft:function(){e.router.navigate("#drafts/create")},editDraft:function(t){e.router.navigate("#drafts/edit/"+t.draftId())},editSelectedDraft:function(){P.editDraft(F())},selectDraft:function(e){F(e),e&&e.scrollIntoView(),I(null),v(e.draftId())},selectDraftById:function(e){var t=n.utils.arrayFirst(N(),function(t){return t.draftId()===e});t&&P.selectDraft(t)},selectNextDraft:function(){if(F()){var e=N().indexOf(F());e<N().length-1&&P.selectDraft(N()[e+1])}else P.selectDraft(N()[0])},selectPreviousDraft:function(){if(F()){var e=N().indexOf(F());e>0&&P.selectDraft(N()[e-1])}else P.selectDraft(N()[N().length-1])},publishDraft:function(){try{var t=s.createPublicationContent(I().entity());r.selectSiteMapNode({module:e,okTitle:"Veröffentlichen"}).then(function(e){e.dialogResult&&o.publish(t,e.selectedNode).fail(function(e){alert(e.message)})})}catch(n){alert(n.message)}},refresh:function(){m()},deleteDraft:function(){T.execute(F().draftId())},handleKeyDown:function(e){var t=e.keyCode;(t===f.keys.UP||t===f.keys.DOWN)&&(e.preventDefault(),t===f.keys.UP&&P.selectPreviousDraft(),t===f.keys.DOWN&&P.selectNextDraft())}},R=$(window);return D.prototype.scrollIntoView=function(){this.scrollIntoViewRequest.trigger()},D.prototype.formatDate=function(e){return i(e).calendar()},P});
