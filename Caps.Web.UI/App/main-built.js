...
define('modules/sitemap/viewmodels/index',["../module","ko","plugins/router","durandal/system","durandal/app","localization","./siteMapViewModel","./publicationViewModel","infrastructure/publicationService","authentication","../datacontext","durandal/composition","moment","infrastructure/keyboardHandler","infrastructure/scrollState","./addPageDialog"],function(e,t,n,r,i,a,o,s,l,u,c,d,f,p,h,m){function v(e){x(e)&&c.fetchSiteMapNode(e.Id()).then(function(){E()&&E().refreshTree(),y()})}function g(e){_(null),e&&e.fetchTree().then(function(){if(_()){var t=e.tree().findNodeByKey(_().Id());if(t)return t.selectNode(),void 0}e.selectRootNode()})}function b(e){A(null),y(),w(e)}function y(){R(null),_()&&_().ContentId()&&c.fetchPublication(_().ContentId()).then(function(){var e=new s(_());R(e)}).fail(N)}function w(e){L(null),e&&L(new M(e))}function k(e){var n=t.utils.arrayFirst(U.siteMapVersions(),function(t){return t.entity()===e});E(n)}function C(e){var t=new o(e);return t.selectedNodeChanged=function(e){e&&_(e.entity())},t}function x(e){return E()&&E().containsNode(e)}function N(e){r.log(e.message),alert(e.message)}function D(e){var t=E();if(t&&e){var n=e.nextNode()||e.previousNode()||e.ParentNode();c.deleteSiteMapNode(e).then(function(){t.refreshTree(),n&&t.selectNodeByKey(n.Id()),i.trigger("caps:sitemapnode:deleted",e)}).fail(N)}}function F(){c.fetchFirstWebsite().then(function(e){P(e.results[0]),k(P().latestSiteMap())}).fail(N)}function I(e){c.fetchSiteMapNodeByContentId(e).then(function(e){if(!e.results.length)return F(),void 0;var t=e.results[0],n=t.SiteMap();P(n.Website()),k(n),_(t)}).fail(N)}function S(e){var n=this;n.entity=e,n.isSelected=t.computed(function(){return A()===n}),n.selectTeaser=function(){A(n),w(n.entity)}}function M(n){var r=this;r.entity=n,r.supportedTranslations=a.website.supportedTranslations(),r.edit=function(){n&&e.router.navigate("#sitemap/edit/"+n.Id())},r.editTranslation=function(t){n&&e.router.navigate("#sitemap/translate/"+n.Id()+"/"+t.culture)},r.createTeaser=function(){if(n){var e=n.SiteMap().Id(),t=n.SiteMap().rootNodes()[0].Id();l.createTeaser(e,t,n.Id())}},r.canCreateTeaser=function(){return n?"ROOT"===n.NodeType()||n.hasTeasers()?!1:n.isTeaser()?!1:!0:!1},r.deleteTeaser=function(){var e="Aufmacher löschen",t="Abbrechen";i.showMessage('Soll der Aufmacher "'+r.entity.localeTitle("de")+'" wirklich gelöscht werden?',"Aufmacher löschen",[e,t]).then(function(t){t===e&&D(r.entity)})},r.hasOptions=t.computed(function(){return r.entity.isTeaser()}),r.hasContent=t.computed(function(){return n&&n.Content()}),r.contentSummary=t.computed(function(){if(!n.ContentId())return"Kein Inhalt festgelegt";var e=n.Content();return e?e.EntityType()+" #"+e.EntityKey()+" (v."+e.ContentVersion()+")":""}),r.authorSummary=t.computed(function(){if(!n.ContentId()||!n.Content())return"";var e=n.Content();return e.AuthorName()+" "+f(e.ContentDate()).fromNow()});var o;r.selectContent=function(){function t(e){l.setNodeContent(r.entity.Id(),e).fail(function(e){alert(e.message)})}o=!1,i.selectContent({module:e}).then(function(e){e.dialogResult&&t(e.selectedContent)}).finally(function(){o=!0})},r.editContent=function(){n.ContentId()&&n.Content()&&i.editContent(n.Content().EntityType(),n.Content().EntityKey())},r.deletePublication=function(){function e(){n.ContentId()&&n.Content()&&c.deletePublication(n)}var t="Entfernen",r="Abbrechen";i.showMessage("Soll der Inhalt dieser Seite wirklich entfernt werden?","Inhalt entfernen?",[t,r]).then(function(n){n===t&&e()})}}var T=$(window),P=t.observable(),E=t.observable(),_=t.observable(),R=t.observable(),A=t.observable(),L=t.observable(),V=!1,O=new p(e),B=new h(e);E.subscribe(g),_.subscribe(b),i.on("caps:sitemapnode:saved",function(e){x(e)&&c.fetchSiteMapNode(e.Id())}),i.on("caps:publication:created",v),i.on("caps:publication:refreshed",v),e.on("module:compositionComplete",function(e,t){t===U&&(T.trigger("forceViewportHeight:refresh"),B.activate())});var U={website:P,siteMapVersions:t.computed(function(){var e=P()?P().sortedSiteMapVersions():[];return t.utils.arrayMap(e,C)}),selectedSiteMap:E,selectedNode:_,selectedPublication:R,properties:L,listScrollState:B,teasers:t.computed(function(){if(!_())return[];var e=t.utils.arrayFilter(_().childNodes(),function(e){return e.isTeaser()});return t.utils.arrayMap(e,function(e){return new S(e)})}),activate:function(e){V||(V=!0,e&&e.p||F()),e&&e.p&&I(e.p),O.activate()},shouldActivate:function(){return!0},deactivate:function(){O.deactivate(),B.deactivate()},createSiteMapVersion:function(){c.createNewSiteMapVersion(P()).then(k).fail(N)},deleteSiteMapVersion:function(){var e="Sitemap-Version verwerfen",t="Abbrechen",n=E().entity();n&&i.showMessage("Soll diese Version wirklich verworfen werden?","Sitemap-Version verwerfen?",[e,t]).then(function(t){if(t===e){var r=n.nextVersion()||n.previousVersion();k(r),c.deleteSiteMapVersion(n).fail(N)}})},publishSiteMapVersion:function(){c.publishSiteMap(E().entity(),u.user().userName())},editWebsite:function(){n.navigate("#website")},moveSelectedNodeUp:function(){_()&&(_().moveUp(),c.saveChanges().then(function(){E()&&E().refreshTree()}))},moveSelectedNodeDown:function(){_()&&(_().moveDown(),c.saveChanges().then(function(){E()&&E().refreshTree()}))},canAddPage:function(){return _()?!0:!1},addPage:function(){function e(e){c.createSiteMapNode(E().entity(),_(),e,e).then(function(e){E().refreshTree(),E().selectNodeByKey(e.Id())}).fail(N)}E()&&_()&&m.show().then(function(t){t&&e(t.title)})},canEditContent:function(){return _()&&L()&&L().hasContent()?!0:!1},editContent:function(){L()&&L().editContent()},canSelectContent:function(){return _()?!0:!1},selectContent:function(){L()&&L().selectContent()},canMoveUp:function(){return _()&&"ROOT"!==_().NodeType()?!0:!1},canMoveDown:function(){return _()&&"ROOT"!==_().NodeType()?!0:!1},canMoveToNode:function(){return _()&&"ROOT"!==_().NodeType()?!0:!1},moveToNode:function(){function t(e){return!e.isTeaser()&&e.Id()!==_().Id()}if(E()){var n=E(),r=_();i.selectSiteMapNode({module:e,nodeFilter:t,siteMapId:n.entity().Id(),canSelectSiteMap:!1}).then(function(e){e.dialogResult&&e.selectedNode&&e.selectedNode.Id()!==r.ParentNodeId()&&(r.reparent(e.selectedNode),c.saveChanges().then(function(){n.refreshTree(),n.tree().selectedNode().ensureVisible()}))})}},canDeleteNode:function(){return _()&&"ROOT"!==_().NodeType()?!0:!1},deleteNode:function(){var e="Seite löschen",t="Abbrechen";i.showMessage('Soll die Seite "'+_().localeTitle("de")+'" wirklich gelöscht werden?',"Seite löschen",[e,t]).then(function(t){t===e&&D(_())})}};return O.keydown=function(e){var t=document.activeElement;(!t||"INPUT"!==t.tagName&&"TEXTAREA"!==t.tagName)&&E()&&E().tree()&&E().tree().handleKeyDown(e)},U});
