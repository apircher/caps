...
define('modules/draft/viewmodels/editor/draftFiles',["durandal/app","../../module","ko","./editorModel","infrastructure/treeViewModel","infrastructure/serverUtil","infrastructure/keyboardHandler"],function(e,t,n,r,i,a,o){function s(s){function c(){var e=s.entity().distinctFileGroupNames();b(n.utils.arrayMap(e,v))}function d(){function e(e){return n.utils.arrayFirst(b(),function(t){return t.name().toLowerCase()===e.toLowerCase()})?!0:!1}var t=s.entity().distinctFileGroupNames(),r=n.utils.arrayFilter(t,function(t){return!e(t)}),i=m();n.utils.arrayForEach(r,function(e){b.push(v(e))});var a=g.tree();!i&&a&&(a.selectRootNode(),a.expandRootNodes())}function u(){var e=new i.TreeViewModel,t=s.entity();e.keyName("Id"),e.createNode=function(){var t=new i.TreeNodeViewModel(e);return t.templateName=n.observable(),t},e.refresh=function(){var r;g.tree()&&(r=g.tree().saveState()),e.clear(),n.utils.arrayForEach(g.sortedFileGroups(),function(r){var i=f(e,r);e.root.addChildNode(i);var a=t.filesByGroupName(r.name());n.utils.arrayForEach(a,function(t){var n=p(e,t);n&&i.addChildNode(n)})}),r&&g.tree()&&g.tree().restoreState(r)},g.tree(e)}function f(e,t){var r=e.createNode();return r.title=n.observable(t.name()),r.nodeType="group",r.entity(t),r.templateName=n.computed(function(){return r.title().length?"draftfilegroup-label":"draftfilegroup-label-empty"}),r.groupName=n.computed({read:function(){return r.entity().name()},write:function(n){n!==t.name()&&(r.entity().name(n),r.childNodes().forEach(function(e){e.entity().Group(n)}),e.refresh())}}),r}function p(e,t){if(!t)return null;var i=new r.DraftFileNode(t,t.getOrCreateResource("de"),e);return i.title=t.Name(),i.templateName=n.observable("draftfile-label"),i}function h(){var e=m();return e?e.title():""}function m(){if(!g.tree()||!g.tree().selectedNode())return null;var e=g.tree().selectedNode();return"group"===e.nodeType?e:e.parentNode()}function v(e){var t={name:n.observable(e)};return t.Id=n.computed(function(){return t.name()}),t}var g=this,b=n.observableArray(),y=new o(t);g.name="DraftFiles",g.editor=s,g.server=a,g.determinations=n.observableArray(l),g.tree=n.observable(),g.deactivate=function(){y.deactivate()},s.currentContent.subscribe(function(e){e===g?y.activate():y.deactivate()}),g.editor.entity().Files.subscribe(function(){d(),g.tree().refresh()}),g.groupNames=n.computed(function(){return n.utils.arrayMap(b(),function(e){return e.name()})}),g.sortedFileGroups=n.computed(function(){var e=b();return e.sort(function(e,t){return e.name().toLowerCase().localeCompare(t.name().toLowerCase())}),e}),g.selectFiles=function(){e.selectFiles({module:t,title:"Anhänge hinzufügen"}).then(function(e){if(e.dialogResult){var t=h();n.utils.arrayForEach(e.selectedFiles,function(e){s.createDraftFile(e,t)})}})},g.addGroup=function(){function e(e){var t=n.utils.arrayFilter(g.groupNames(),function(t){var n=new RegExp("^("+e+")(\\s+\\(\\d+\\))?.*$","gi");return n.test(t)});return t.length?e+" ("+t.length+")":e}var t=e("Neue Gruppe");b.push(v(t)),g.tree().refresh();var r=g.tree().findNodeByKey(t);r&&r.selectNode()},g.moveSelectedNodeUp=function(){var e=g.tree().selectedNode();e.moveUp&&e.moveUp()},g.moveSelectedNodeDown=function(){var e=g.tree().selectedNode();e.moveDown&&e.moveDown()},g.removeFile=function(t){var n="Entfernen",r="Abbrechen";e.showMessage("Soll der Anhang "+t.entity().Name()+" wirklich entfernt werden?","Anhang entfernen",[n,r]).then(function(e){e===n&&(t.detachFromParentNode(),t.entity().setDeleted())})},g.contentTemplateName=function(){if(!g.tree()||!g.tree().selectedNode())return"";var e=g.tree().selectedNode();return"group"==e.nodeType?"draftfiles-group-template":"draftfiles-file-template"},g.navigateToFile=function(){if(g.tree()&&g.tree().selectedNode()&&"file"===g.tree().selectedNode().nodeType){var t=g.tree().selectedNode(),n=t.resource.FileVersion().File();e.trigger("caps:contentfile:navigateToFile",n)}},c(),u(),g.tree()&&(g.tree().refresh(),g.tree().expandRootNodes(),g.tree().selectRootNode()),y.keydown=function(e){var t=document.activeElement;g.tree()&&(!t||"INPUT"!=t.tagName&&"TEXTAREA"!=t.tagName)&&g.tree().handleKeyDown(e)}}var l=[{name:"Picture",title:"Bild"},{name:"Download",title:"Download"},{name:"Misc",title:"Sonstiges"}];return s});
