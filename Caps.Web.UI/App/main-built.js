...
define('modules/contentfile/viewmodels/index',["ko","durandal/system","durandal/app","../module","../datacontext","infrastructure/virtualListModel","infrastructure/filterModel","infrastructure/listSortModel","jquery","toastr","Q","doubleTap","infrastructure/tagService","./fileListItem","./uploadManager","./fileSearchControl","infrastructure/serverUtil","./fileUploadDialog"],function(e,t,n,i,a,o,s,l,c,d,u,f,h,p,v,m,g,b){function y(e){var n=M;return console.log("loadPage called. pageNumber="+e+", Filter="+n.currentFilter),t.defer(function(t){S(!0),a.searchFiles(n.searchWords(),e,D.itemsPerPage(),n.sortOptions.getOrderBy(),n.currentFilter).then(function(n){D.addPage(n,e),t.resolve()}).fail(t.reject).done(function(){S(!1)})}).promise()}function w(e){function t(){D.selectedItem()===e&&D.resetSelection(),D.removeItem(e)}function r(){n.showMessage("Die Datei konnte nicht gelöscht werden.","Nicht erfolgreich")}return a.deleteFile(e.data()).then(t).fail(r)}function k(){return new v({beforeUpload:function(t,r,i){var o=e.utils.arrayMap(t,function(e){return e.name});a.getFileInfo(o).then(function(t){var r=e.utils.arrayFilter(t,function(e){return e.Count>0});if(r.length>0){var a=new b(t);n.showDialog(a).then(function(e){e&&i(e)})}else i()})},uploadStarted:function(e,t,n){var r=n&&"replace"===n.storageAction;r||(e.listItem=D.insertItem(void 0,t),e.listItem.isUploading(!0))},uploadDone:function(e,t){var n=t.listItem||D.findItem(function(t){return t.data()&&t.data().Id()===e.id});a.fetchFile(e.id).then(function(){n&&(n.data(a.localGetFile(e.id)),n.isUploading(!1))}).fail(function(){d.error("Die Datei "+r.FileName+" konnte nicht geladen werden.")})}})}var x,N=!1,D=new o.VirtualList(35,null,p),S=e.observable(!1),C=k(),F=e.observable(!1),I=e.observable(0),M=new m;return i.router.on("router:navigation:attached",function(e){e==x&&F(!0)}),n.on("caps:tags:added",function(e){M.addTagFilter(e)}),n.on("caps:tag:deleted",function(e){M.removeTagFilter(e)}),n.on("caps:file:deleted",function(e){var t=D.findItem(function(t){return t.data().Id()==e.Id()});t&&(D.selectedItem()===t&&D.resetSelection(),D.removeItem(t))}),M.refreshResults=function(){x.refresh()},x={list:D,isLoading:S,uploadManager:C,selectedFile:D.selectedItem,selectedFiles:D.selectedItems,scrollTop:I,isInteractive:F,searchControl:M,server:g,activate:function(){N||(N=!0,y(1))},deactivate:function(){F(!1)},deleteFile:function(e){var t="Datei löschen",r="Abbrechen";n.showMessage("Soll die Datei "+e.data().FileName()+" wirklich gelöscht werden?","Datei löschen",[t,r]).then(function(n){n===t&&w(e)})},deleteSelection:function(){var t=this.selectedFiles();if(0!==t.length){if(1==t.length)return this.deleteFile(t[0]);var r="Auswahl löschen";n.showMessage("Sollen die "+t.length+" ausgewählten Dateien wirklich endgültig gelöscht werden?","Auswahl löschen",[r,"Abbrechen"]).then(function(n){if(n===r){D.suspendEvents=!0;var i=e.utils.arrayMap(t,function(e){return w(e)});u.all(i).then(function(){D.suspendEvents=!1,D.raiseItemsChanged()})}})}},refresh:function(){I(0),D.resetSelection(),D.removeAll(),y(1)},resetSelectedItem:function(){D.resetSelection()},showSelectedFile:function(){this.showDetail(D.selectedItem())},showDetail:function(e){e&&(D.selectItem(e),i.router.navigate("#files/detail/"+e.data().Id()))},loadHandler:function(e,t){function n(e){var n=D.findPage(e);n.isLoaded||n.isLoading||(D.markPageLoading(e),y(e).then(function(){D.markPageLoaded(e),t.pageLoaded(e)}))}if(console.log("loadHandler called. First visible: "+t.firstVisible.index+" (Page #"+t.firstVisible.page+"); Last visible: "+t.lastVisible.index+" (Page #"+t.lastVisible.page+")"),F()){var r=t.firstVisible.viewModel?D.findItemPage(t.firstVisible.viewModel):void 0,i=t.lastVisible.viewModel?D.findItemPage(t.lastVisible.viewModel):void 0;if(r&&i)for(var a=r.index;a<=i.index;a++)n(a+1)}}}});
...
define('modules/draft/viewmodels/editor/editor',["durandal/app","durandal/system","../../module","../../datacontext","../../entities","entityManagerProvider","breeze","ko","Q","./navigation","./draftTemplate","./draftProperties","./draftFiles","./contentPartEditor","./templateEditor","./draftNotes","./editorModel","authentication"],function(e,t,n,r,i,a,o,s,l,c,u,d,f,h,p,m,v,g){function b(){function l(){y.trigger("forceViewportHeight:refresh")}function v(e){var t=e.Id(),n=s.utils.arrayFilter(P.entity().Files(),function(e){var n=s.utils.arrayFirst(e.Resources(),function(e){return e.FileVersion()&&e.FileVersion().FileId()===t});return null!=n});if(n.length){var r=o.EntityQuery.from("Files").where("Id","==",t).expand("Versions.File");return T.executeQuery(r)}}function b(e,t,n){n=n||"de",r.getTemplate(e).then(function(r){var i=r,a=T.createEntity("Draft",{TemplateName:e,Version:1,OriginalLanguage:n,Status:"NEW"});a.Template(JSON.stringify(i)),a.Created().At(new Date),a.Created().By(g.user().userName()),a.Modified().At(new Date),a.Modified().By(g.user().userName()),t&&t.name&&a.Name(t.name),P.entity(a),i.forEachCell(function(e,n,r){var i=P.getOrCreateContentPart(n);if(i.Ranking(r),n.content){var a=/<%\s*([A-Za-z0-9_\.]+)\s*%>/gi,o=n.content.replace(a,function(e,n){return t&&t[n]?t[n]:w(n)||"Nicht gefunden"});i.getResource("de").Content(o)}})})}function w(e){if(!P.entity()||!P.entity().template())return null;var t=P.entity().template();if(!t.parameters)return null;var n=s.utils.arrayFirst(t.parameters,function(t){return t.name.toLowerCase()===e.toLowerCase()});return n?n.value:null}function k(e){var t=o.EntityQuery.from("Drafts").where("Id","==",e).expand("ContentParts.Resources, Files.Resources.FileVersion.File");return T.executeQuery(t).then(function(e){P.entity(e.results[0])})}function x(){P.entity().setDeleted(),T.saveChanges().then(function(){e.trigger("caps:draft:deleted",P.entity()),P.navigateBack()})}function C(){D=D||new c(P);var e=L.activeInstruction().queryParams;if(e&&e.t)if("DraftProperties"===e.t)P.showProperties();else if("DraftFiles"===e.t)P.showFiles();else{var t=P.entity().findContentPart(e.t);t&&P.showContentPartEditor(t)}P.currentContent()||(F=F||new u(P),P.currentContent(F)),P.currentNavigation(D)}function N(e){var t=s.utils.arrayFirst(_,function(t){return t.contentPart===e});return t||(t=new h(P,e),_.push(t)),t}var D,F,S,I,M,E,P=this,T=a.createManager(),_=[],L=n.router,R=s.observable();P.currentContent=s.observable(),P.currentNavigation=s.observable(),P.entity=s.observable(),P.template=s.computed(function(){return P.entity()?P.entity().template():void 0}),P.isNewDraft=s.observable(!1),P.draftStates=i.supportedDraftStates,P.lastContentPart=s.observable(),T.hasChangesChanged.subscribe(function(e){n.routeConfig.hasUnsavedChanges(e.hasChanges)}),T.validationErrorsChanged.subscribe(function(e){var t=e.entity;R(t.hasValidationErrors.call(t))}),P.activate=function(r,i){return n.on("module:compositionComplete",l),e.on("caps:contentfile:uploadDone",v),t.defer(function(e){r&&/^[0-9]+$/.test(r)?k(r).then(function(){C(),e.resolve()}):(P.isNewDraft(!0),b(r,i),C(),e.resolve())}).promise()},P.canDeactivate=function(){return T.hasChanges()?t.defer(function(t){var n="Speichern",r="Verwerfen",i="Abbrechen";e.showMessage("Sollen die Änderungen gespeichert werden?","Änderungen speichern?",[n,r,i]).then(function(e){if(e===i)t.resolve(!1);else if(e===n){var r=P.saveChanges();r&&r.then?r.then(function(){t.resolve(!0)}):t.resolve(!1)}else t.resolve(!0)})}).promise():!0},P.deactivate=function(){n.routeConfig.hasUnsavedChanges(!1),n.off("module:compositionComplete",l),e.off("caps:contentfile:uploadDone",v),S&&S.deactivate()},P.shouldActivate=function(e,t,n){return t[0]!==n[0]},P.showEditorMain=function(){F=F||new u(P),P.currentContent(F),P.lastContentPart(null)},P.showLayoutArea=function(){P.lastContentPart()?P.showContentPartEditor(P.lastContentPart()):P.showEditorMain()},P.showFiles=function(){S=S||new f(P),P.currentContent(S)},P.showProperties=function(){I=I||new d(P),P.currentContent(I)},P.showContentPartEditor=function(e){var t=N(e);t&&(t.showPreview(!1),P.currentContent(t),P.lastContentPart(e))},P.showTemplateEditor=function(){M=M||new p(P),P.currentContent(M)},P.showDraftNotes=function(){E=E||new m(P),P.currentContent(E)},P.navigateBack=function(){P.showDraftsIndex()},P.showDraftsIndex=function(){n.router.navigate(n.routeConfig.hash)},P.saveChangesAndNavigateBack=function(){P.saveChanges().then(P.navigateBack)},P.saveChanges=function(){if(R())return e.showMessage("Der Inhalt kann noch nicht gespeichert werden. Prüfe die markierten Felder und ergänze oder korrigiere die Eingaben.","Noch nicht komplett",["Ok"]),!1;P.entity().Modified().At(new Date),P.entity().Modified().By(g.user().userName());var t=T.getEntities("DraftFile",o.EntityState.Deleted);return T.saveChanges().then(function(){e.trigger("caps:draft:saved",{entity:P.entity(),isNewDraft:P.isNewDraft(),deletedFiles:t}),n.routeConfig.hasUnsavedChanges(!1)})},P.deleteDraft=function(){var t="Entwurf löschen",n="Abbrechen";e.showMessage("Soll der Entwurf wirklich gelöscht werden?","Entwurf löschen",[t,n]).then(function(e){if(e===t){if(P.isNewDraft())return T.rejectChanges(),P.navigateBack(),void 0;x()}})},P.getOrCreateContentPart=function(e){var t=P.entity().findContentPart(e.name);if(!t){t=T.createEntity("DraftContentPart",{DraftId:P.entity().Id(),Name:e.name,ContentType:e.contentType||"markdown"}),T.addEntity(t);var n=T.createEntity("DraftContentPartResource",{DraftContentPartId:P.entity().Id(),Language:"de",Content:""});T.addEntity(n),t.Resources.push(n),P.entity().ContentParts.push(t)}return t},P.createDraftFile=function(e,t){var n=o.EntityQuery.from("Files").where("Id","==",e.Id()).expand("Versions.File");return T.executeQuery(n).then(function(n){var r=n.results[0],i=T.createEntity("DraftFile",{Name:e.FileName()});e.isImage()&&i.Determination("Picture"),t&&t.length&&i.Group(t),T.addEntity(i);var a=T.createEntity("DraftFileResource",{Language:"de",DbFileVersionId:r.latestVersion().Id()});return T.addEntity(a),i.Resources.push(a),i.DraftId(P.entity().Id()),P.entity().Files.push(i),i})}}var y=$(window);return b});
define('modules/draft/viewmodels/index',["../module","../datacontext","ko","durandal/app","moment","localization","infrastructure/publicationService","../contentGenerator","infrastructure/listSortModel","../commands/deleteDraft","./draftSearchControl","infrastructure/interaction","infrastructure/keyCode","durandal/composition","infrastructure/keyboardHandler","infrastructure/scrollState"],function(e,t,n,r,i,a,o,s,l,c,u,d,f,p,h,m){function v(e){if(e&&D()){var t=e.Content();t&&t.EntityKey()==D().draftId()&&y(D().draftId(),F())}}function g(){var e=P;return I(!0),t.searchDrafts(e.searchWords(),e.sortOptions.getOrderBy()).then(function(e){var t=n.utils.arrayMap(e.results,function(e){return new x(e)});N(t),I(!1)})}function b(e){return t.getDraft(e).then(function(t){var n=t.results[0],r=s.createTemplateContent(t.results[0],"de"),i=new k(n,r);F(i),y(e,i)})}function y(e,r){t.fetchPublications(e).then(function(e){r.publications(n.utils.arrayMap(e,function(e){return new C(r.entity(),e)}))}).fail(function(e){alert(e.message)})}function w(){N().length&&L.selectDraft(N()[0])}function k(t,r){var o=this,s=new a.Language(t.OriginalLanguage());o.entity=n.observable(t),o.template=n.observable(r),o.originalLanguage=s,o.supportedTranslations=a.website.supportedTranslations(s.culture),o.publications=n.observableArray(),o.createdAt=n.computed(function(){return i(t.Created().At()).format("LLLL")}),o.createdFromNow=n.computed(function(){return i(t.Created().At()).fromNow()}),o.modifiedAt=n.computed(function(){return i(t.Modified().At()).format("LLLL")}),o.modifiedFromNow=n.computed(function(){return i(t.Modified().At()).fromNow()}),o.translateDraft=function(n){e.router.navigate("#drafts/translate/"+t.Id()+"/"+n.culture)}}function x(e){var t=this;t.draftId=n.computed(function(){return e.Id()}),t.createdAt=n.computed(function(){return t.formatDate(e.Created().At())}),t.modifiedAt=n.computed(function(){return t.formatDate(e.Modified().At())}),t.title=n.computed(function(){return e.Name()}),t.isSelected=n.computed(function(){return D()&&D().draftId()===t.draftId()}),t.status=n.computed(function(){return e.statusTitle()}),t.scrollIntoViewRequest=new d.InteractionRequest("ScrollIntoView")}function C(e,t){var r=this;r.draft=n.observable(e),r.sitemapNode=n.observable(t),r.title=n.computed(function(){return r.sitemapNode().path()}),r.contentVersion=n.computed(function(){return r.sitemapNode().Content()?"v."+r.sitemapNode().Content().ContentVersion():""}),r.createdAt=n.computed(function(){return i.utc(r.sitemapNode().Created().At()).fromNow()}),r.createdBy=n.computed(function(){return r.sitemapNode().Created().By()}),r.isOutdated=n.computed(function(){return r.sitemapNode().Content()?r.sitemapNode().Content().ContentVersion()<r.draft().Version():!1}),r.republish=function(){var e=s.createPublicationContent(this.draft());o.republish(this.sitemapNode().Id(),e)}}var N=n.observableArray(),D=n.observable(),F=n.observable(),S=!1,I=n.observable(!1),M=new c,P=new u,E=new h(e),T=new m(e);P.refreshResults=function(){L.refresh()},r.on("caps:draft:saved",function(e){var t=e.entity;D()&&D().draftId()===t.Id()&&b(D().draftId()),e.isNewDraft&&g().then(function(){L.selectDraftById(t.Id())})}),r.on("caps:draft:deleted",function(){g().then(w)}),r.on("caps:publication:created",v),r.on("caps:publication:refreshed",v);var _=$(window);e.on("module:compositionComplete",function(e,t){t===L&&(_.trigger("forceViewportHeight:refresh"),T.activate())});var L={items:N,selectedItem:D,draftPreview:F,isLoading:I,searchControl:P,draftListScrollState:T,activate:function(){S||(S=!0,g().then(function(){w()})),E.activate()},deactivate:function(){E.deactivate(),T.deactivate()},addDraft:function(){e.router.navigate("#drafts/create")},editDraft:function(t){e.router.navigate("#drafts/edit/"+t.draftId())},editSelectedDraft:function(){L.editDraft(D())},selectDraft:function(e){D(e),e&&e.scrollIntoView(),F(null),b(e.draftId())},selectDraftById:function(e){var t=n.utils.arrayFirst(N(),function(t){return t.draftId()===e});t&&L.selectDraft(t)},selectNextDraft:function(){if(D()){var e=N().indexOf(D());e<N().length-1&&L.selectDraft(N()[e+1])}else L.selectDraft(N()[0])},selectPreviousDraft:function(){if(D()){var e=N().indexOf(D());e>0&&L.selectDraft(N()[e-1])}else L.selectDraft(N()[N().length-1])},publishDraft:function(){try{var t=s.createPublicationContent(F().entity());T.deactivate(),r.selectSiteMapNode({module:e,okTitle:"Veröffentlichen"}).then(function(e){e.dialogResult&&o.publish(t,e.selectedNode).fail(function(e){alert(e.message)}),T.activate()})}catch(n){alert(n.message)}},refresh:function(){g()},deleteDraft:function(){M.execute(D().draftId())}};return E.keydown=function(e){var t=e.keyCode;(t===f.keys.UP||t===f.keys.DOWN)&&(e.preventDefault(),t===f.keys.UP&&L.selectPreviousDraft(),t===f.keys.DOWN&&L.selectNextDraft())},x.prototype.scrollIntoView=function(){this.scrollIntoViewRequest.trigger()},x.prototype.formatDate=function(e){return i(e).calendar()},L});
