...
define('infrastructure/moduleFactory',["ko","plugins/dialog","durandal/events"],function(e,t,n){function i(e){this.routeConfig=e,this.dialogContext=void 0}function r(t){t.hasUnsavedChanges=t.hasUnsavedChanges||e.observable(!1);var r=new i(t);return n.includeIn(r),r}return i.prototype.activate=function(){this.trigger("module:activate",this)},i.prototype.deactivate=function(){this.trigger("module:deactivate",this)},i.prototype.initializeRouter=function(){},i.prototype.getDialogContextName=function(){return this.moduleName+"_DialogContext"},i.prototype.initializeDialogContext=function(){var n=this,i="#"+n.moduleName+"Module";this.dialogContext={addHost:function(e){var t=$(i),n=t.children(":visible"),r=$('<div class="pageDialogHost"></div>').appendTo(t);e.host=r.get(0),e.hiddenControls=n,n.hide(),r.show()},removeHost:function(t){var n=($(i),$(t.host));n.hide(),t.hiddenControls.show(),setTimeout(function(){e.removeNode(t.host)},200)},compositionComplete:function(){}},t.addContext(this.getDialogContextName(),this.dialogContext)},i.prototype.showDialog=function(e,n){return this.dialogContext||this.initializeDialogContext(),t.show(e,n,this.getDialogContextName())},{createModule:r,CapsModule:i}});
...
define('infrastructure/moduleRouter',["plugins/router","durandal/system","infrastructure/moduleRegistry","ko","infrastructure/utils","durandal/composition"],function(e,t,n,r,i,o){function a(e){return r.utils.arrayForEach(n.modules(),function(t){u(e,t)}),e}function u(e,n){var r=n.routeConfig;if(!r)throw new Error("No moduleRoute found.");r.isModuleRoute=!0,e.map(r),t.isFunction(n.initializeRouter)&&n.initializeRouter()}function s(t,n,r){var i=e.createChildRouter().makeRelative({moduleId:n,route:r});return l(i,t),i.on("router:navigation:complete",function(e,n,r){o.current.complete(function(){t.trigger("module:compositionComplete",t,e,n,r)})}),i}function l(e,n){e.activeItem.settings.areSameItem=function(n,r,o,a){return n==r||t.getModuleId(n)==t.getModuleId(r)?n&&t.isFunction(n.shouldActivate)?!n.shouldActivate(e,o,a):i.compareArrays(o,a):!1},e.navigateToModule=function(){var t=e.activeInstruction();null==t?e.navigate(n.routeConfig.hash):e.navigate(t.fragment)}}return{mapModuleRoutes:a,createModuleRouter:s}});
...
define('modules/draft/viewmodels/editor/contentEditors/markdownEditor',["durandal/app","ko","jquery","./insertLinkDialog","./insertImageDialog","../../../module","Q"],function(e,t,n,r,i,a,o){function s(){var s=this;s.insertLink=function(t){var n=new r;return e.showDialog(n).then(function(e){e.result&&t(e.url)}),!0},s.insertPicture=function(r,l){var u=new i(s.editor,s.editor.entity(),l);return e.showDialog(u).then(function(i){i.result?r(i.url):i.addFiles?(n(".wmd-prompt-background").hide(),e.selectFiles({module:a,title:'Dateien zu Entwurf "'+s.editor.entity().Name()+'" hinzufügen'}).then(function(e){if(e.dialogResult){var i=t.utils.arrayMap(e.selectedFiles,function(e){return s.editor.createDraftFile(e)});n(".wmd-prompt-background").show(),o.all(i).then(function(e){s.insertPicture(r,e[0])})}else r(null)})):r(null)}),!0},s.showHelp=function(){alert("help?")}}return t.bindingHandlers.pagedownEditor={init:function(e,r){var i=t.unwrap(r()),a=n(e),o=a.children("textarea")[0],s=a.find(".wmd-toolbar")[0],l=a.find(".wmd-preview")[0],u=n(o),c=n(s),d=n(l),f="-"+new String(i.contentPart.Id()).replace("-","neg"),p=new Markdown.Converter;u.attr("id","wmd-input"+f),c.attr("id","wmd-button-bar"+f),d.attr("id","wmd-preview"+f),{helpButton:{handler:i.showHelp}};var h=new Markdown.Editor(p,f,null);u.val(i.content()),h.hooks.onPreviewRefresh=function(e){var t=u.val();return i.content(t),e},h.hooks.insertImageDialog=i.insertPicture,h.hooks.insertLinkDialog=i.insertLink,h.run()}},s});
define('modules/draft/viewmodels/editor/contentEditors/textEditor',[],function(){function e(){}return e});
define('modules/draft/viewmodels/editor/contentPartEditor',["require","ko","../../contentGenerator"],function(e,t,n){function r(r,a){function o(t){i[t]&&e([i[t]],function(e){var t=new e;t.editor=r,t.contentPart=a,t.content=s.resource.Content,s.contentEditor(t)})}var s=this;s.name="ContentPartEditor",s.editor=r,s.showPreview=t.observable(!1),s.contentPart=a,s.resource=a.getResource("de"),s.contentTypes=t.observableArray([{title:"HTML",value:"html"},{title:"Markdown",value:"markdown"},{title:"Text",value:"text"}]),s.contentEditor=t.observable(),s.templateCell=r.template().findCell(a.Name()),s.title=s.templateCell?s.templateCell.title:a.Name(),o(a.ContentType()),a.ContentType.subscribe(o),s.togglePreview=function(){s.previewContent(n.createTemplateCellContent(s.editor.entity(),s.templateCell,s.resource.Language())),s.showPreview(!s.showPreview())},s.previewContent=t.observable()}var i={text:"./contentEditors/textEditor",markdown:"./contentEditors/markdownEditor",html:"./contentEditors/htmlEditor"};return r});
