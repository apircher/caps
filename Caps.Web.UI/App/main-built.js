...
define('modules/draft/viewmodels/index',["../module","../datacontext","ko","durandal/app","moment","localization","infrastructure/publicationService","../contentGenerator","infrastructure/listSortModel","../commands/deleteDraft","./draftSearchControl","infrastructure/interaction","infrastructure/keyCode"],function(e,t,n,r,i,a,o,s,l,u,c,d,f){function h(e){if(e&&N()){var t=e.Content();t&&t.EntityKey()==N().draftId()&&v(N().draftId(),C())}}function p(){var e=S;return I(!0),t.searchDrafts(e.searchWords(),e.sortOptions.getOrderBy()).then(function(e){var t=n.utils.arrayMap(e.results,function(e){return new k(e)});D(t),I(!1)})}function m(e){return t.getDraft(e).then(function(t){var n=t.results[0],r=s.createTemplateContent(t.results[0],"de"),i=new w(n,r);C(i),v(e,i)})}function v(e,r){t.fetchPublications(e).then(function(e){r.publications(n.utils.arrayMap(e,function(e){return new x(r.entity(),e)}))}).fail(function(e){alert(e.message)})}function g(){D().length&&_.selectDraft(D()[0])}function b(){$(window).on("keydown",_.handleKeyDown)}function y(){$(window).off("keydown",_.handleKeyDown)}function w(t,r){var o=this,s=new a.Language(t.OriginalLanguage());o.entity=n.observable(t),o.template=n.observable(r),o.originalLanguage=s,o.supportedTranslations=a.website.supportedTranslations(s.culture),o.publications=n.observableArray(),o.createdAt=n.computed(function(){return i(t.Created().At()).format("LLLL")}),o.createdFromNow=n.computed(function(){return i(t.Created().At()).fromNow()}),o.modifiedAt=n.computed(function(){return i(t.Modified().At()).format("LLLL")}),o.modifiedFromNow=n.computed(function(){return i(t.Modified().At()).fromNow()}),o.translateDraft=function(n){e.router.navigate("#drafts/translate/"+t.Id()+"/"+n.culture)}}function k(e){var t=this;t.draftId=n.computed(function(){return e.Id()}),t.createdAt=n.computed(function(){return t.formatDate(e.Created().At())}),t.modifiedAt=n.computed(function(){return t.formatDate(e.Modified().At())}),t.title=n.computed(function(){return e.Name()}),t.isSelected=n.computed(function(){return N()&&N().draftId()===t.draftId()}),t.scrollIntoViewRequest=new d.InteractionRequest("ScrollIntoView")}function x(e,t){var r=this;r.draft=n.observable(e),r.sitemapNode=n.observable(t),r.title=n.computed(function(){return r.sitemapNode().path()}),r.contentVersion=n.computed(function(){return r.sitemapNode().Content()?"v."+r.sitemapNode().Content().ContentVersion():""}),r.createdAt=n.computed(function(){return i.utc(r.sitemapNode().Created().At()).fromNow()}),r.createdBy=n.computed(function(){return r.sitemapNode().Created().By()}),r.isOutdated=n.computed(function(){return r.sitemapNode().Content()?r.sitemapNode().Content().ContentVersion()<r.draft().Version():!1}),r.republish=function(){var e=s.createPublicationContent(this.draft());o.republish(this.sitemapNode().Id(),e)}}var D=n.observableArray(),N=n.observable(),C=n.observable(),F=!1,I=n.observable(!1),M=new u,S=new c,T=!1;S.refreshResults=function(){_.refresh()},r.on("caps:draft:saved",function(e){var t=e.entity;N()&&N().draftId()===t.Id()&&m(N().draftId()),e.isNewDraft&&p().then(function(){_.selectDraftById(t.Id())})}),r.on("caps:draft:deleted",function(){p().then(g)}),r.on("caps:publication:created",h),r.on("caps:publication:refreshed",h),e.on("module:activate",function(){T&&b()}),e.on("module:deactivate",function(){T&&y()});var _={items:D,selectedItem:N,draftPreview:C,isLoading:I,searchControl:S,activate:function(){F||(F=!0,p().then(g)),T=!0,b()},deactivate:function(){T=!1,y()},addDraft:function(){e.router.navigate("#drafts/create")},editDraft:function(t){e.router.navigate("#drafts/edit/"+t.draftId())},editSelectedDraft:function(){_.editDraft(N())},selectDraft:function(e){N(e),e&&e.scrollIntoView(),C(null),m(e.draftId())},selectDraftById:function(e){var t=n.utils.arrayFirst(D(),function(t){return t.draftId()===e});t&&_.selectDraft(t)},selectNextDraft:function(){if(N()){var e=D().indexOf(N());e<D().length-1&&_.selectDraft(D()[e+1])}else _.selectDraft(D()[0])},selectPreviousDraft:function(){if(N()){var e=D().indexOf(N());e>0&&_.selectDraft(D()[e-1])}else _.selectDraft(D()[D().length-1])},publishDraft:function(){try{var t=s.createPublicationContent(C().entity());r.selectSiteMapNode({module:e,okTitle:"Veröffentlichen"}).then(function(e){e.dialogResult&&o.publish(t,e.selectedNode).fail(function(e){alert(e.message)})})}catch(n){alert(n.message)}},refresh:function(){p()},deleteDraft:function(){M.execute(N().draftId())},handleKeyDown:function(e){var t=e.keyCode;(t===f.keys.UP||t===f.keys.DOWN)&&(e.preventDefault(),t===f.keys.UP&&_.selectPreviousDraft(),t===f.keys.DOWN&&_.selectNextDraft())}};return k.prototype.scrollIntoView=function(){this.scrollIntoViewRequest.trigger()},k.prototype.formatDate=function(e){return i(e).calendar()},_});
...
define('modules/sitemap/viewmodels/index',["../module","ko","plugins/router","durandal/system","durandal/app","localization","./siteMapViewModel","./publicationViewModel","infrastructure/publicationService","authentication","../datacontext"],function(e,t,n,r,i,a,o,s,l,u,c){function d(e){v(e)&&c.fetchSiteMapNode(e.Id()).then(function(){k()&&k().refreshTree(),p()})}function f(e){x(null),e&&e.fetchTree().then(function(){e.selectRootNode()})}function p(){N(null),x()&&x().ContentId()&&c.fetchPublication(x().ContentId()).then(function(){var e=new s(x());N(e)}).fail(g)}function h(e){var n=t.utils.arrayFirst(M.siteMapVersions(),function(t){return t.entity()===e});k(n)}function m(e){var t=new o(e);return t.selectedNodeChanged=function(e){e&&x(e.entity())},t}function v(e){return k()&&k().containsNode(e)}function g(e){r.log(e.message),alert(e.message)}function b(){$(window).on("keydown",M.handleKeyDown)}function y(){$(window).off("keydown",M.handleKeyDown)}var w=t.observable(),k=t.observable(),x=t.observable(),N=t.observable(),C=a.website.supportedTranslations(),D=!1,F=!1;k.subscribe(f),x.subscribe(p),i.on("caps:sitemapnode:saved",function(e){v(e)&&c.fetchSiteMapNode(e.Id())}),i.on("caps:publication:created",d),i.on("caps:publication:refreshed",d),e.on("module:activate",function(){F&&b()}),e.on("module:deactivate",function(){F&&y()});var M={website:w,siteMapVersions:t.computed(function(){var e=w()?w().sortedSiteMapVersions():[];return t.utils.arrayMap(e,m)}),selectedSiteMap:k,selectedNode:x,selectedPublication:N,teasers:t.computed(function(){return x()?t.utils.arrayFilter(x().childNodes(),function(e){return"teaser"===e.NodeType().toLowerCase()}):[]}),supportedTranslations:C,activate:function(){D||(D=!0,c.fetchFirstWebsite().then(function(e){w(e.results[0]),h(w().latestSiteMap())}).fail(g)),b(),F=!0},deactivate:function(){y(),F=!1},createSiteMapVersion:function(){c.createNewSiteMapVersion(w()).then(h).fail(g)},deleteSiteMapVersion:function(){var e="Sitemap-Version verwerfen",t="Abbrechen",n=k().entity();n&&i.showMessage("Soll diese Version wirklich verworfen werden?","Sitemap-Version verwerfen?",[e,t]).then(function(t){if(t===e){var r=n.nextVersion()||n.previousVersion();h(r),c.deleteSiteMapVersion(n).fail(g)}})},publishSiteMapVersion:function(){c.publishSiteMap(k().entity(),u.user().userName())},createSiteMapNode:function(){k()&&x()&&c.createSiteMapNode(k().entity(),x()).then(function(e){siteMap.refreshTree(),siteMap.selectNodeByKey(e.Id())}).fail(g)},deleteSiteMapNode:function(){var e=k();if(e&&x()){var t="Seite löschen",n="Abbrechen";i.showMessage("Soll die Seite wirklich gelöscht werden?","Seite löschen",[t,n]).then(function(n){if(n===t){var r=x(),i=r.nextNode()||r.previousNode()||r.ParentNode();c.deleteSiteMapNode(r).then(function(){e.refreshTree(),i&&e.selectNodeByKey(i.Id())}).fail(g)}})}},editWebsite:function(){n.navigate("#website")},editTranslation:function(t){x()&&e.router.navigate("#sitemap/translate/"+x().Id()+"/"+t.culture)},editSiteMapNode:function(){x()&&e.router.navigate("#sitemap/edit/"+x().Id())},moveSelectedNodeUp:function(){x()&&(x().moveUp(),c.saveChanges().then(function(){k()&&k().refreshTree()}))},moveSelectedNodeDown:function(){x()&&(x().moveDown(),c.saveChanges().then(function(){k()&&k().refreshTree()}))},moveSelectedNode:function(){function t(e){return!e.isTeaser()&&e.Id()!==x().Id()}if(k()){var n=k(),r=x();i.selectSiteMapNode({module:e,nodeFilter:t,siteMapId:n.entity().Id(),canSelectSiteMap:!1}).then(function(e){e.dialogResult&&e.selectedNode&&e.selectedNode.Id()!==r.ParentNodeId()&&(r.reparent(e.selectedNode),c.saveChanges().then(function(){n.refreshTree(),n.tree().selectedNode().ensureVisible()}))})}},createTeaser:function(){if(x()){var e=k().entity().Id(),t=k().tree().root.childNodes()[0].entity().Id();l.createTeaser(e,t,x().Id())}},canCreateTeaser:function(){return x()?"ROOT"==x().NodeType()||x().hasTeasers()?!1:!0:!1},handleKeyDown:function(e){k().tree().handleKeyDown(e)}};return M});
