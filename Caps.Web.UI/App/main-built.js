...
define('modules/draft/viewmodels/editor',["durandal/app","durandal/system","../module","../datacontext","entityManagerProvider","breeze","ko","Q","./editor/navigation","./editor/draftTemplate","./editor/draftProperties","./editor/draftFiles","./editor/contentPartEditor","./editor/templateEditor","./editorModel","authentication"],function(e,t,n,r,i,a,o,s,l,u,c,d,f,h,p,m){function v(){function s(e){var t=r.getTemplate(e),n=F.createEntity("Draft",{Template:e,Version:1});n.TemplateContent(JSON.stringify(t)),n.Created().At(new Date),n.Created().By(m.user().userName()),n.Modified().At(new Date),n.Modified().By(m.user().userName());var i=F.createEntity("DraftResource",{Language:"de"});n.Resources.push(i),_.entity(n)}function p(e){var t=a.EntityQuery.from("Drafts").where("Id","==",e).expand("Resources, ContentParts.Resources, Files.Resources.FileVersion.File");return F.executeQuery(t).then(function(e){_.entity(e.results[0])})}function v(){_.entity().setDeleted(),F.saveChanges().then(_.navigateBack)}function g(){x=x||new l(_);var e=I.activeInstruction().queryParams;if(e&&e.t)if("DraftProperties"===e.t)_.showProperties();else if("DraftFiles"===e.t)_.showFiles();else{var t=_.entity().findContentPart(e.t);t&&_.showContentPartEditor(t)}_.currentContent()||(D=D||new u(_),_.currentContent(D)),_.currentNavigation(x)}function b(){var e=_.entity();e&&(y(),e.entityAspect.propertyChanged.subscribe(w))}function y(){var e=_.entity();e&&_.template(e.deserializeTemplate())}function w(){n.routeConfig.hasUnsavedChanges(F.hasChanges())}function k(e){var t=o.utils.arrayFirst(N,function(t){return t.contentPart===e});return t||(t=new f(_,e),N.push(t)),t}var x,D,C,M,S,_=this,F=i.createManager(),N=[],I=n.router;_.currentContent=o.observable(),_.currentNavigation=o.observable(),_.entity=o.observable(),_.entity.subscribe(b),_.template=o.observable(),_.isNewDraft=o.observable(!1),_.activate=function(e){return t.defer(function(t){e&&/^[0-9]+$/.test(e)?p(e).then(function(){g(),t.resolve()}):(_.isNewDraft(!0),s(e),g(),t.resolve())}).promise()},_.shouldActivate=function(e,t,n){return t[0]!==n[0]},_.showEditorMain=function(){D=D||new u(_),_.currentContent(D)},_.showFiles=function(){C=C||new d(_),_.currentContent(C)},_.showProperties=function(){M=M||new c(_,_.entity().getOrCreateResource("de",F)),_.currentContent(M)},_.showContentPartEditor=function(e){var t=k(e);t&&_.currentContent(t)},_.showTemplateEditor=function(){S=S||new h(_),_.currentContent(S)},_.navigateBack=function(){return!_.currentContent()||"ContentPartEditor"!==_.currentContent().name&&"TemplateEditor"!==_.currentContent().name?(_.showDraftsIndex(),void 0):(_.showEditorMain(),void 0)},_.showDraftsIndex=function(){n.routeConfig.hasUnsavedChanges(!1),n.router.navigate(n.routeConfig.hash)},_.saveChanges=function(){_.entity().Modified().At(new Date),_.entity().Modified().By(m.user().userName()),F.saveChanges().then(function(){e.trigger("caps:draft:saved",{entity:_.entity(),isNewDraft:_.isNewDraft()}),_.showDraftsIndex()})},_.deleteDraft=function(){var t="Entwurf löschen",n="Abbrechen";e.showMessage("Soll der Entwurf wirklich gelöscht werden?","Entwurf löschen",[t,n]).then(function(e){e===t&&v()})},_.getOrCreateContentPart=function(e){var t=_.entity().findContentPart(e);if(!t){t=F.createEntity("DraftContentPart",{DraftId:_.entity().Id(),PartType:e,ContentType:"markdown"}),F.addEntity(t);var n=F.createEntity("DraftContentPartResource",{DraftContentPartId:_.entity().Id(),Language:"de",Content:""});F.addEntity(n),t.Resources.push(n),_.entity().ContentParts.push(t)}return t},_.createDraftFile=function(e){var t=a.EntityQuery.from("Files").where("Id","==",e.Id()).expand("Versions.File");F.executeQuery(t).then(function(t){var n=t.results[0],r=F.createEntity("DraftFile",{DraftId:_.entity().Id(),Name:e.FileName()});F.addEntity(r);var i=F.createEntity("DraftFileResource",{Language:"de",DbFileVersionId:n.latestVersion().Id()});F.addEntity(i),r.Resources.push(i),_.entity().Files.push(r)})}}return v});
