...
define('plugins/router',["durandal/system","durandal/app","durandal/activator","durandal/events","durandal/composition","plugins/history","knockout","jquery"],function(e,t,n,r,i,a,o,s){function l(e){return e=e.replace(g,"\\$&").replace(p,"(?:$1)?").replace(v,function(e,t){return t?e:"([^/]+)"}).replace(m,"(.*?)"),new RegExp("^"+e+"$")}function u(e){var t=e.indexOf(":"),n=t>0?t-1:e.length;return e.substring(0,n)}function c(e,t){return-1!==e.indexOf(t,e.length-t.length)}function d(e,t){if(!e||!t)return!1;if(e.length!=t.length)return!1;for(var n=0,r=e.length;r>n;n++)if(e[n]!=t[n])return!1;return!0}var f,h,p=/\((.*?)\)/g,v=/(\(\?)?:\w+/g,m=/\*\w+/g,g=/[\-{}\[\]+?.,\\\^$|#\s]/g,b=/\/$/,y=function(){function i(e){return e.router&&e.router.parent==E}function s(e){F&&F.config.isActive&&F.config.isActive(e)}function p(t,n){e.log("Navigation Complete",t,n);var r=e.getModuleId(M);r&&E.trigger("router:navigation:from:"+r),M=t,s(!1),F=n,s(!0);var a=e.getModuleId(M);a&&E.trigger("router:navigation:to:"+a),i(t)||E.updateDocumentTitle(t,n),h.explicitNavigation=!1,h.navigatingBack=!1,E.trigger("router:navigation:complete",t,n,E)}function v(t,n){e.log("Navigation Cancelled"),E.activeInstruction(F),F&&E.navigate(F.fragment,!1),P(!1),h.explicitNavigation=!1,h.navigatingBack=!1,E.trigger("router:navigation:cancelled",t,n,E)}function m(t){e.log("Navigation Redirecting"),P(!1),h.explicitNavigation=!1,h.navigatingBack=!1,E.navigate(t,{trigger:!0,replace:!0})}function g(t,n,r){h.navigatingBack=!h.explicitNavigation&&M!=r.fragment,E.trigger("router:route:activating",n,r,E),t.activateItem(n,r.params).then(function(e){if(e){var a=M;if(p(n,r),i(n)){var o=r.fragment;r.queryString&&(o+="?"+r.queryString),n.router.loadUrl(o)}a==n&&(E.attached(),E.compositionComplete())}else t.settings.lifecycleData&&t.settings.lifecycleData.redirect?m(t.settings.lifecycleData.redirect):v(n,r);f&&(f.resolve(),f=null)}).fail(function(t){e.error(t)})}function w(t,n,r){var i=E.guardRoute(n,r);i?i.then?i.then(function(i){i?e.isString(i)?m(i):g(t,n,r):v(n,r)}):e.isString(i)?m(i):g(t,n,r):v(n,r)}function k(e,t,n){E.guardRoute?w(e,t,n):g(e,t,n)}function x(e){return F&&F.config.moduleId==e.config.moduleId&&M&&(M.canReuseForRoute&&M.canReuseForRoute.apply(M,e.params)||!M.canReuseForRoute&&M.router&&M.router.loadUrl)}function D(){if(!P()){var t=_.shift();_=[],t&&(P(!0),E.activeInstruction(t),x(t)?k(n.create(),M,t):e.acquire(t.config.moduleId).then(function(n){var r=e.resolveObject(n);k(T,r,t)}).fail(function(n){e.error("Failed to load routed module ("+t.config.moduleId+"). Details: "+n.message)}))}}function C(e){_.unshift(e),D()}function N(e,t,n){for(var r=e.exec(t).slice(1),i=0;i<r.length;i++){var a=r[i];r[i]=a?decodeURIComponent(a):null}var o=E.parseQueryString(n);return o&&r.push(o),{params:r,queryParams:o}}function I(t){E.trigger("router:route:before-config",t,E),e.isRegExp(t)?t.routePattern=t.route:(t.title=t.title||E.convertRouteToTitle(t.route),t.moduleId=t.moduleId||E.convertRouteToModuleId(t.route),t.hash=t.hash||E.convertRouteToHash(t.route),t.routePattern=l(t.route)),t.isActive=t.isActive||o.observable(!1),E.trigger("router:route:after-config",t,E),E.routes.push(t),E.route(t.routePattern,function(e,n){var r=N(t.routePattern,e,n);C({fragment:e,queryString:n,config:t,params:r.params,queryParams:r.queryParams})})}function S(t){if(e.isArray(t.route))for(var n=t.isActive||o.observable(!1),r=0,i=t.route.length;i>r;r++){var a=e.extend({},t);a.route=t.route[r],a.isActive=n,r>0&&delete a.nav,I(a)}else I(t);return E}var M,F,_=[],P=o.observable(!1),T=n.create(),E={handlers:[],routes:[],navigationModel:o.observableArray([]),activeItem:T,isNavigating:o.computed(function(){var e=T(),t=P(),n=e&&e.router&&e.router!=E&&e.router.isNavigating()?!0:!1;return t||n}),activeInstruction:o.observable(null),__router__:!0};return r.includeIn(E),T.settings.areSameItem=function(e,t,n,r){return e==t?d(n,r):!1},E.parseQueryString=function(e){var t,n;if(!e)return null;if(n=e.split("&"),0==n.length)return null;t={};for(var r=0;r<n.length;r++){var i=n[r];if(""!==i){var a=i.split("=");t[a[0]]=a[1]&&decodeURIComponent(a[1].replace(/\+/g," "))}}return t},E.route=function(e,t){E.handlers.push({routePattern:e,callback:t})},E.loadUrl=function(t){var n=E.handlers,r=null,i=t,o=t.indexOf("?");if(-1!=o&&(i=t.substring(0,o),r=t.substr(o+1)),E.relativeToParentRouter){var s=this.parent.activeInstruction();i=s.params.join("/"),i&&"/"==i.charAt(0)&&(i=i.substr(1)),i||(i=""),i=i.replace("//","/").replace("//","/")}i=i.replace(b,"");for(var l=0;l<n.length;l++){var u=n[l];if(u.routePattern.test(i))return u.callback(i,r),!0}return e.log("Route Not Found"),E.trigger("router:route:not-found",t,E),F&&a.navigate(F.fragment,{trigger:!1,replace:!0}),h.explicitNavigation=!1,h.navigatingBack=!1,!1},E.updateDocumentTitle=function(e,n){n.config.title?document.title=t.title?n.config.title+" | "+t.title:n.config.title:t.title&&(document.title=t.title)},E.navigate=function(e,t){return e&&-1!=e.indexOf("://")?(window.location.href=e,!0):(h.explicitNavigation=!0,a.navigate(e,t))},E.navigateBack=function(){a.navigateBack()},E.attached=function(){E.trigger("router:navigation:attached",M,F,E)},E.compositionComplete=function(){P(!1),E.trigger("router:navigation:composition-complete",M,F,E),D()},E.convertRouteToHash=function(e){if(E.relativeToParentRouter){var t=E.parent.activeInstruction(),n=t.config.hash+"/"+e;return a._hasPushState&&(n="/"+n),n=n.replace("//","/").replace("//","/")}return a._hasPushState?e:"#"+e},E.convertRouteToModuleId=function(e){return u(e)},E.convertRouteToTitle=function(e){var t=u(e);return t.substring(0,1).toUpperCase()+t.substring(1)},E.map=function(t,n){if(e.isArray(t)){for(var r=0;r<t.length;r++)E.map(t[r]);return E}return e.isString(t)||e.isRegExp(t)?(n?e.isString(n)&&(n={moduleId:n}):n={},n.route=t):n=t,S(n)},E.buildNavigationModel=function(t){for(var n=[],r=E.routes,i=t||100,a=0;a<r.length;a++){var o=r[a];o.nav&&(e.isNumber(o.nav)||(o.nav=++i),n.push(o))}return n.sort(function(e,t){return e.nav-t.nav}),E.navigationModel(n),E},E.mapUnknownRoutes=function(t,n){var r="*catchall",i=l(r);return E.route(i,function(o,s){var l=N(i,o,s),u={fragment:o,queryString:s,config:{route:r,routePattern:i},params:l.params,queryParams:l.queryParams};if(t)if(e.isString(t))u.config.moduleId=t,n&&a.navigate(n,{trigger:!1,replace:!0});else if(e.isFunction(t)){var c=t(u);if(c&&c.then)return c.then(function(){E.trigger("router:route:before-config",u.config,E),E.trigger("router:route:after-config",u.config,E),C(u)}),void 0}else u.config=t,u.config.route=r,u.config.routePattern=i;else u.config.moduleId=o;E.trigger("router:route:before-config",u.config,E),E.trigger("router:route:after-config",u.config,E),C(u)}),E},E.reset=function(){return F=M=void 0,E.handlers=[],E.routes=[],E.off(),delete E.options,E},E.makeRelative=function(t){return e.isString(t)&&(t={moduleId:t,route:t}),t.moduleId&&!c(t.moduleId,"/")&&(t.moduleId+="/"),t.route&&!c(t.route,"/")&&(t.route+="/"),t.fromParent&&(E.relativeToParentRouter=!0),E.on("router:route:before-config").then(function(e){t.moduleId&&(e.moduleId=t.moduleId+e.moduleId),t.route&&(e.route=""===e.route?t.route.substring(0,t.route.length-1):t.route+e.route)}),E},E.createChildRouter=function(){var e=y();return e.parent=E,e},E};return h=y(),h.explicitNavigation=!1,h.navigatingBack=!1,h.targetIsThisWindow=function(e){var t=s(e.target).attr("target");return!t||t===window.name||"_self"===t||"top"===t&&window===window.top?!0:!1},h.activate=function(t){return e.defer(function(n){if(f=n,h.options=e.extend({routeHandler:h.loadUrl},h.options,t),a.activate(h.options),a._hasPushState)for(var r=h.routes,i=r.length;i--;){var o=r[i];o.hash=o.hash.replace("#","")}s(document).delegate("a","click",function(e){if(a._hasPushState){if(!e.altKey&&!e.ctrlKey&&!e.metaKey&&!e.shiftKey&&h.targetIsThisWindow(e)){var t=s(this).attr("href");null==t||"#"===t.charAt(0)||/^[a-z]+:/i.test(t)||(h.explicitNavigation=!0,e.preventDefault(),a.navigate(t))}}else h.explicitNavigation=!0}),a.options.silent&&f&&(f.resolve(),f=null)}).promise()},h.deactivate=function(){a.deactivate()},h.install=function(){o.bindingHandlers.router={init:function(){return{controlsDescendantBindings:!0}},update:function(e,t,n,r,a){var s=o.utils.unwrapObservable(t())||{};if(s.__router__)s={model:s.activeItem(),attached:s.attached,compositionComplete:s.compositionComplete,activate:!1};else{var l=o.utils.unwrapObservable(s.router||r.router)||h;s.model=l.activeItem(),s.attached=l.attached,s.compositionComplete=l.compositionComplete,s.activate=!1}i.compose(e,s,a)}},o.virtualElements.allowedBindings.router=!0},h});
//! moment.js
//! version : 2.4.0
...
requirejs.config({paths:{text:"../Scripts/text",durandal:"../Scripts/durandal",plugins:"../Scripts/durandal/plugins",transitions:"../Scripts/durandal/transitions","knockout.custom-bindings":"../Scripts/knockout.custom-bindings","knockout.extenders":"../Scripts/knockout.extenders",typeahead:"../Scripts/typeahead",moment:"../Scripts/moment",doubleTap:"../Scripts/doubleTap",entityManagerProvider:"infrastructure/entityManagerProvider",authentication:"infrastructure/authentication",localization:"infrastructure/localization"},shim:{"jquery.ui.widget":["jquery"],"jquery.fileupload":["jquery.ui.widget"]},map:{"*":{ko:"knockout"}}}),define("jquery",function(){return jQuery}),define("knockout",ko),define("knockout.validation",ko.validation),define("Q",function(){return Q}),define("breeze",function(){return breeze}),define("markdown",function(){return Markdown}),define("toastr",function(){return toastr}),define('main',["durandal/app","durandal/viewLocator","durandal/system","Q","authentication","infrastructure/antiForgeryToken","knockout.validation","localization","infrastructure/moduleLoader","plugins/router","jquery","entityManagerProvider","knockout.custom-bindings","knockout.extenders","infrastructure/validation","../Scripts/safari.cancelZoom"],function(e,t,n,r,i,a,o,s,l,u,c,d){function f(){var t={message:"Mindestens ein Bereich enthält ungespeicherte Änderungen.",cancel:!1};return e.trigger("app:beforeunload",t),t.cancel?t.message:void 0}function h(){require(["plugins/dialog"],function(e){e.MessageBox.defaultViewMarkup=['<div data-view="plugins/messageBox" class="messageBox">','<div class="modal-header">','<h4 data-bind="text: title"></h4>',"</div>",'<div class="modal-body">','<p class="message" data-bind="text: message"></p>',"</div>",'<div class="modal-footer" data-bind="foreach: options">',"<button class=\"btn\" data-bind=\"click: function () { $parent.selectOption($data); }, text: $data, css: { 'btn-primary': $index() == 0, 'btn-default': $index() != 0, autofocus: $index() == 0 }\"></button>","</div>","</div>"].join("\n")})}n.debug(!0),e.title="CAPS",e.configurePlugins({router:!0,dialog:!0,widget:!0,fileSelection:!0,siteMapNodeSelection:!0}),n.defer=function(e){var t=r.defer();e.call(t,t);var n=t.promise;return t.promise=function(){return n},t},o.init({insertMessages:!1}),s.localize("de"),c(window).bind("beforeunload",f),r.fcall(a.initToken).then(i.initialize).then(l.loadModules(["sitemap","draft","contentfile","user"])).then(d.initialize).then(e.start).then(function(){t.useConvention(),h(),e.setRoot("viewmodels/shell","entrance"),e.trigger("caps:started")}).done()});
define('modules/contentfile/datacontext',["breeze","entityManagerProvider","Q","jquery","knockout","infrastructure/userQueryParser"],function(e,t,n,r,i,a){function o(){var e=m.from("Files");return p.executeQuery(e)}function s(e,t,n,r,i){var a=i?m.from("FilteredFiles").withParameters({filterOptions:i}):m.from("Files"),o=l(a,e).orderBy(r||"Created.At desc").skip((t-1)*n).take(n).inlineCount(!0);return p.executeQuery(o)}function l(e,t){if(t&&t.length){var n=v.getBreezePredicate(t);if(n)return e.where(n)}return e}function u(e){var t=m.from("Files").where("Id","==",e).expand("Tags.Tag, Versions, Versions.Properties");return p.executeQuery(t)}function c(e){return p.getEntityByKey("DbFile",e)}function d(e){function t(){p.detachEntity(e),i.resolve()}var i=n.defer();return r.ajax("api/DbFile/"+e.Id(),{method:"delete"}).done(t).fail(i.reject),i.promise}function f(e,t){var r=n.defer(),i=m.from("Tags").where("Id","==",t.Id());return p.executeQuery(i).then(function(t){var n=t.results[0],i=p.createEntity("DbFileTag",{FileId:e.Id(),TagId:n.Id()});p.addEntity(i),p.saveChanges().fail(r.reject).done(r.resolve)}).fail(r.reject),r.promise}function h(e,t){return e.Tags.remove(t),t.entityAspect.setDeleted(),p.saveChanges()}var p=t.createManager(),m=e.EntityQuery,v=new a;return v.translateColumnName=function(e){return e&&e.length&&/autor/i.test(e)?"Created.By":"FileName"},{getFiles:o,fetchFile:u,localGetFile:c,deleteFile:d,searchFiles:s,addFileTag:f,removeFileTag:h,isValidUserQuery:function(e){return v.validate(e)}}});
define('modules/contentfile/entities',["require","knockout"],function(e,t){function n(){var e=this;this.isImage=t.computed({read:function(){return a(e.ContentType(),"image")},deferEvaluation:!0}),this.latestVersion=t.computed({read:function(){var t=e.Versions();return t.length>0?t[0]:null},deferEvaluation:!0})}function r(){var e=this;this.imageWidth=t.computed({read:function(){return s(e,i.imageWidth,0)},deferEvaluation:!0}),this.imageHeight=t.computed({read:function(){return s(e,i.imageHeight,0)},deferEvaluation:!0})}var i={imageWidth:"width",imageHeight:"height"},a=function(e,t){return e=e||"",t.length>e.length?!1:e.substring(0,t.length)===t},o=function(e,n){var r=t.utils.arrayFirst(e.Properties(),function(e){return e.PropertyName()==n});return r},s=function(e,t,n){var r=o(e,t);return r?r.PropertyValue():n};return{DbFile:n,DbFileVersion:r,extendModel:function(e){e.registerEntityTypeCtor("DbFile",n),e.registerEntityTypeCtor("DbFileVersion",r)}}});
...
define('modules/contentfile/viewmodels/detail',["require","knockout","../module","../datacontext","Q","moment","infrastructure/utils","infrastructure/tagService"],function(e,t,n,r,i,a,o,s){function l(){var e=i.defer();return f(!0),r.fetchFile(c()).then(function(){d(r.localGetFile(c())),e.resolve(d())}).fail(e.fail).done(function(){f(!1)}),e.promise}var u=e("durandal/app"),c=t.observable(0),d=t.observable(),f=t.observable(!1),h=t.observable(),p=t.observable(!1),m={fileId:c,file:d,isLoading:f,activate:function(e){return d(null),c(e),h(null),p(!1),l().fail(function(e){alert(e.message)})},refresh:function(){return l()},navigateBack:function(){n.router.navigate(n.routeConfig.hash)},previewTemplate:function(e){return e&&e.isImage()?"file-preview-image":"file-preview-general"},addTagUIVisible:p,tagNames:t.computed(function(){return t.utils.arrayMap(s.tags(),function(e){return e.Name()})}),tagName:h,addTag:function(){p(!0);var e=h();e&&e.length&&s.getOrCreateTag(e).then(function(e){return r.addFileTag(d(),e)}).fail(function(e){window.alert(e.message||e.responseText)}).done(function(){u.trigger("caps:tag:added",h()),h("")})},cancelAddTag:function(){h(null),p(!1)},updateTagName:function(e,t,n){h(n.value)},removeTag:function(e){r.removeFileTag(d(),e).then(function(e){var n=t.utils.arrayFilter(e.entities,function(e){return"Tag"==e.entityType.shortName});t.utils.arrayForEach(n,function(e){u.trigger("caps:tag:deleted",e)})}).fail(function(){alert(err.message||err.responseText)}).done(function(){u.trigger("caps:tag:removed",e)})},moment:a,utils:o};return m});
...
define('modules/draft/viewmodels/editor',["durandal/app","durandal/system","../module","../datacontext","entityManagerProvider","breeze","ko","Q","./editor/navigation","./editor/draftTemplate","./editor/draftProperties","./editor/draftFiles","./editor/contentPartEditor","./editor/templateEditor","./editorModel","authentication"],function(e,t,n,r,i,a,o,s,l,u,c,d,f,h,p,m){function v(){function s(e){var t=r.getTemplate(e),n=N.createEntity("Draft",{Template:e,Version:1});n.TemplateContent(JSON.stringify(t)),n.Created().At(new Date),n.Created().By(m.user().userName()),n.Modified().At(new Date),n.Modified().By(m.user().userName());var i=N.createEntity("DraftResource",{Language:"de"});n.Resources.push(i),M.entity(n)}function p(e){var t=a.EntityQuery.from("Drafts").where("Id","==",e).expand("Resources, ContentParts.Resources, Files.Resources.FileVersion.File");return N.executeQuery(t).then(function(e){M.entity(e.results[0])})}function v(){M.entity().setDeleted(),N.saveChanges().then(M.navigateBack)}function g(){x=x||new l(M);var e=F.activeInstruction().queryParams;if(e&&e.t)if("DraftProperties"===e.t)M.showProperties();else if("DraftFiles"===e.t)M.showFiles();else{var t=M.entity().findContentPart(e.t);t&&M.showContentPartEditor(t)}M.currentContent()||(D=D||new u(M),M.currentContent(D)),M.currentNavigation(x)}function b(){var e=M.entity();e&&(y(),e.entityAspect.propertyChanged.subscribe(w))}function y(){var e=M.entity();e&&M.template(e.deserializeTemplate())}function w(){n.routeConfig.hasUnsavedChanges(N.hasChanges())}function k(e){var t=o.utils.arrayFirst(_,function(t){return t.contentPart===e});return t||(t=new f(M,e),_.push(t)),t}var x,D,C,S,I,M=this,N=i.createManager(),_=[],F=n.router;M.currentContent=o.observable(),M.currentNavigation=o.observable(),M.entity=o.observable(),M.entity.subscribe(b),M.template=o.observable(),M.isNewDraft=o.observable(!1),M.activate=function(e){return t.defer(function(t){e&&/^[0-9]+$/.test(e)?p(e).then(function(){g(),t.resolve()}):(M.isNewDraft(!0),s(e),g(),t.resolve())}).promise()},M.shouldActivate=function(e,t,n){return t[0]!==n[0]},M.showEditorMain=function(){D=D||new u(M),M.currentContent(D)},M.showFiles=function(){C=C||new d(M),M.currentContent(C)},M.showProperties=function(){S=S||new c(M,M.entity().getOrCreateResource("de",N)),M.currentContent(S)},M.showContentPartEditor=function(e){var t=k(e);t&&M.currentContent(t)},M.showTemplateEditor=function(){I=I||new h(M),M.currentContent(I)},M.navigateBack=function(){return!M.currentContent()||"ContentPartEditor"!==M.currentContent().name&&"TemplateEditor"!==M.currentContent().name?(M.showDraftsIndex(),void 0):(M.showEditorMain(),void 0)},M.showDraftsIndex=function(){n.routeConfig.hasUnsavedChanges(!1),n.router.navigate(n.routeConfig.hash)},M.saveChanges=function(){M.entity().Modified().At(new Date),M.entity().Modified().By(m.user().userName()),N.saveChanges().then(function(){e.trigger("caps:draft:saved",{entity:M.entity(),isNewDraft:M.isNewDraft()}),M.showDraftsIndex()})},M.deleteDraft=function(){var t="Entwurf löschen",n="Abbrechen";e.showMessage("Soll der Entwurf wirklich gelöscht werden?","Entwurf löschen",[t,n]).then(function(e){e===t&&v()})},M.getOrCreateContentPart=function(e){var t=M.entity().findContentPart(e);if(!t){t=N.createEntity("DraftContentPart",{DraftId:M.entity().Id(),PartType:e,ContentType:"markdown"}),N.addEntity(t);var n=N.createEntity("DraftContentPartResource",{DraftContentPartId:M.entity().Id(),Language:"de",Content:""});N.addEntity(n),t.Resources.push(n),M.entity().ContentParts.push(t)}return t},M.createDraftFile=function(e){var t=a.EntityQuery.from("Files").where("Id","==",e.Id()).expand("Versions.File");N.executeQuery(t).then(function(t){var n=t.results[0],r=N.createEntity("DraftFile",{DraftId:M.entity().Id(),Name:e.FileName()});N.addEntity(r);var i=N.createEntity("DraftFileResource",{Language:"de",DbFileVersionId:n.latestVersion().Id()});N.addEntity(i),r.Resources.push(i),M.entity().Files.push(r)})}}return v});
define('modules/draft/viewmodels/index',["../module","../datacontext","ko","durandal/app","moment","localization","infrastructure/publicationService","../contentGenerator","infrastructure/listSortModel","../commands/deleteDraft"],function(e,t,n,r,i,a,o,s,l,u){function c(e){if(e&&w()){var t=e.Content();t&&t.EntityKey()==w().draftId()&&h(w().draftId(),k())}}function d(){return t.searchDrafts(x(),D.getOrderBy()).then(function(e){var t=n.utils.arrayMap(e.results,function(e){return new g(e)});y(t)})}function f(e){return t.getDraft(e).then(function(t){var n=t.results[0],r=s.createTemplateContent(t.results[0],"de"),i=new v(n,r);k(i),h(e,i)})}function h(e,r){t.fetchPublications(e).then(function(e){r.publications(n.utils.arrayMap(e,function(e){return new b(r.entity(),e)}))}).fail(function(e){alert(e.message)})}function p(){y().length&&I.selectDraft(y()[0])}function m(){var e=[new l.ListColumn("Created.At","Erstellt am"),new l.ListColumn("Created.By","Erstellt von"),new l.ListColumn("Modified.At","Letzte Änderung"),new l.ListColumn("Modified.By","Letzte Änderung von"),new l.ListColumn("Name","Name")],t=new l.SortOptions(e,function(){I.refresh()},"Modified.At");return t}function v(t,r){var o=this;o.entity=n.observable(t),o.resource=n.observable(t.getResource("de")),o.template=n.observable(r),o.defaultCulture=a.website.defaultLanguage,o.supportedTranslations=a.website.supportedTranslations(),o.publications=n.observableArray(),o.createdAt=n.computed(function(){return i(t.Created().At()).format("LLLL")}),o.createdFromNow=n.computed(function(){return i(t.Created().At()).fromNow()}),o.modifiedAt=n.computed(function(){return i(t.Modified().At()).format("LLLL")}),o.modifiedFromNow=n.computed(function(){return i(t.Modified().At()).fromNow()}),o.translateDraft=function(n){e.router.navigate("#drafts/translate/"+t.Id()+"/"+n.culture)}}function g(e){var t=this;t.draftId=n.computed(function(){return e.Id()}),t.createdAt=n.computed(function(){return t.formatDate(e.Created().At())}),t.modifiedAt=n.computed(function(){return t.formatDate(e.Modified().At())}),t.title=n.computed(function(){return e.Name()}),t.isSelected=n.computed(function(){return w()===t})}function b(e,t){var r=this;r.draft=n.observable(e),r.sitemapNode=n.observable(t),r.title=n.computed(function(){return r.sitemapNode().path()}),r.contentVersion=n.computed(function(){return r.sitemapNode().Content()?"v."+r.sitemapNode().Content().ContentVersion():""}),r.createdAt=n.computed(function(){return i.utc(r.sitemapNode().Created().At()).fromNow()}),r.createdBy=n.computed(function(){return r.sitemapNode().Created().By()}),r.isOutdated=n.computed(function(){return r.sitemapNode().Content()?r.sitemapNode().Content().ContentVersion()<r.draft().Version():!1}),r.republish=function(){var e=s.createPublicationContent(this.draft());o.republish(this.sitemapNode().Id(),e)}}var y=n.observableArray(),w=n.observable(),k=n.observable(),x=n.observable(""),D=m(),C=!1,N=new u;r.on("caps:draft:saved",function(e){var t=e.entity;w()&&w().draftId()===t.Id()&&f(w().draftId()),e.isNewDraft&&d().then(function(){I.selectDraftById(t.Id())})}),r.on("caps:draft:deleted",function(){d().then(p)}),r.on("caps:publication:created",c),r.on("caps:publication:refreshed",c);var I={items:y,selectedItem:w,draftPreview:k,searchWords:x,search:function(){d().then(p)},sortOptions:D,activate:function(){C||(C=!0,d().then(p))},addDraft:function(){e.router.navigate("#drafts/create")},editDraft:function(t){e.router.navigate("#drafts/edit/"+t.draftId())},editSelectedDraft:function(){I.editDraft(w())},selectDraft:function(e){w(e),k(null),f(e.draftId())},selectDraftById:function(e){var t=n.utils.arrayFirst(y(),function(t){return t.draftId()===e});t&&I.selectDraft(t)},publishDraft:function(){try{var t=s.createPublicationContent(k().entity());r.selectSiteMapNode({module:e,okTitle:"Veröffentlichen"}).then(function(e){e.dialogResult&&o.publish(t,e.selectedNode).fail(function(e){alert(e.message)})})}catch(n){alert(n.message)}},refresh:function(){d()},deleteDraft:function(){N.execute(w().draftId())}};return g.prototype.formatDate=function(e){return i(e).calendar()},I});
...
define('modules/sitemap/viewmodels/editor',["../module","ko","entityManagerProvider","breeze","durandal/app"],function(e,t,n,r,i){function a(){function r(e){var t=(new o).from("SiteMapNodes").where("Id","==",e).expand("Resources");return l.executeQuery(t)}var a=this,l=n.createManager();a.entity=t.observable(),a.nodeTypes=s,a.nodeType=t.computed({read:function(){return a.entity()&&a.entity().NodeType()?t.utils.arrayFirst(s,function(e){return e.name.toLowerCase()===a.entity().NodeType().toLowerCase()}):null},write:function(e){a.entity()&&(e?a.entity().NodeType(e.name):a.entity().NodeType(null))},owner:a}),a.activate=function(e){r(e).then(function(e){a.entity(e.results[0])})},a.navigateBack=function(){a.showDraftsIndex()},a.showDraftsIndex=function(){e.router.navigate(e.routeConfig.hash)},a.saveChanges=function(){l.saveChanges().then(function(){i.trigger("caps:sitemapnode:saved",a.entity()),a.showDraftsIndex()})}}var o=r.EntityQuery,s=[{title:"Inhalts-Seite",name:"PAGE"},{title:"Statische Seite",name:"ACTION"},{title:"Startseite",name:"ROOT"},{title:"Aufmacher",name:"TEASER"}];return a});
