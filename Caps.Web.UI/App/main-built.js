...
define('modules/contentfile/viewmodels/index',["ko","durandal/system","durandal/app","../module","../datacontext","infrastructure/virtualListModel","infrastructure/filterModel","infrastructure/listSortModel","jquery","toastr","Q","doubleTap","infrastructure/tagService","./fileListItem","./uploadManager","./fileSearchControl","infrastructure/serverUtil","./fileUploadDialog"],function(e,t,n,i,a,o,s,l,c,d,u,f,h,p,v,m,g,b){function y(e){var n=M;return console.log("loadPage called. pageNumber="+e+", Filter="+n.currentFilter),t.defer(function(t){D(!0),a.searchFiles(n.searchWords(),e,C.itemsPerPage(),n.sortOptions.getOrderBy(),n.currentFilter).then(function(n){C.addPage(n,e),t.resolve()}).fail(t.reject).done(function(){D(!1)})}).promise()}function w(e){function t(){C.selectedItem()===e&&C.resetSelection(),C.removeItem(e)}function n(){dialog.showMessage("Die Datei konnte nicht gelöscht werden.","Nicht erfolgreich")}return a.deleteFile(e.data()).then(t).fail(n)}function k(){return new v({beforeUpload:function(t,r,i){var o=e.utils.arrayMap(t,function(e){return e.name});a.getFileInfo(o).then(function(t){var r=e.utils.arrayFilter(t,function(e){return e.Count>0});if(r.length>0){var a=new b(t);n.showDialog(a).then(function(e){e&&i(e)})}else i()})},uploadStarted:function(e,t,n){var r=n&&"replace"===n.storageAction;r||(e.listItem=C.insertItem(void 0,t),e.listItem.isUploading(!0))},uploadDone:function(e,t){var n=t.listItem||C.findItem(function(t){return t.data()&&t.data().Id()===e.Id});a.fetchFile(e.Id).then(function(){n&&(n.data(a.localGetFile(e.Id)),n.isUploading(!1))}).fail(function(){d.error("Die Datei "+r.FileName+" konnte nicht geladen werden.")})}})}var x,N=!1,C=new o.VirtualList(35,null,p),D=e.observable(!1),F=k(),I=e.observable(!1),S=e.observable(0),M=new m;return i.router.on("router:navigation:attached",function(e){e==x&&I(!0)}),n.on("caps:tags:added",function(e){M.addTagFilter(e)}),n.on("caps:tag:deleted",function(e){M.removeTagFilter(e)}),n.on("caps:file:deleted",function(e){var t=C.findItem(function(t){return t.data().Id()==e.Id()});t&&(C.selectedItem()===t&&C.resetSelection(),C.removeItem(t))}),M.refreshResults=function(){x.refresh()},x={list:C,isLoading:D,uploadManager:F,selectedFile:C.selectedItem,selectedFiles:C.selectedItems,scrollTop:S,isInteractive:I,searchControl:M,server:g,activate:function(){N||(N=!0,y(1))},deactivate:function(){I(!1)},deleteFile:function(e){var t="Datei löschen",r="Abbrechen";n.showMessage("Soll die Datei "+e.data().FileName()+" wirklich gelöscht werden?","Datei löschen",[t,r]).then(function(n){n===t&&w(e)})},deleteSelection:function(){var t=this.selectedFiles();if(0!==t.length){if(1==t.length)return this.deleteFile(t[0]);var r="Auswahl löschen";n.showMessage("Sollen die "+t.length+" ausgewählten Dateien wirklich endgültig gelöscht werden?","Auswahl löschen",[r,"Abbrechen"]).then(function(n){if(n===r){C.suspendEvents=!0;var i=e.utils.arrayMap(t,function(e){return w(e)});u.all(i).then(function(){C.suspendEvents=!1,C.raiseItemsChanged()})}})}},refresh:function(){S(0),C.resetSelection(),C.removeAll(),y(1)},resetSelectedItem:function(){C.resetSelection()},showSelectedFile:function(){this.showDetail(C.selectedItem())},showDetail:function(e){e&&(C.selectItem(e),i.router.navigate("#files/detail/"+e.data().Id()))},loadHandler:function(e,t){function n(e){var n=C.findPage(e);n.isLoaded||n.isLoading||(C.markPageLoading(e),y(e).then(function(){C.markPageLoaded(e),t.pageLoaded(e)}))}if(console.log("loadHandler called. First visible: "+t.firstVisible.index+" (Page #"+t.firstVisible.page+"); Last visible: "+t.lastVisible.index+" (Page #"+t.lastVisible.page+")"),I()){var r=t.firstVisible.viewModel?C.findItemPage(t.firstVisible.viewModel):void 0,i=t.lastVisible.viewModel?C.findItemPage(t.lastVisible.viewModel):void 0;if(r&&i)for(var a=r.index;a<=i.index;a++)n(a+1)}}}});
...
define('modules/user/datacontext',["Q","knockout","jquery","modules/user/entities"],function(e,t,n,r){function i(){return d("~/api/User").then(function(e){return n.map(e,function(e){return new r.User(e)})}).fail(function(e){alert(e.message)})}function a(){return d("~/rpc/UserMgmt/GetAllRoles")}function o(e){return d("~/api/User/"+e).then(function(e){return new r.User(e)})}function s(e){return d("~/api/User",{method:"put",data:e.toDto()})}function l(e){return d("~/api/User/"+e.userName(),{method:"post",data:e.toDto()})}function u(e){return d("~/api/User",{method:"delete",data:e.toDto()}).then(function(){return e})}function c(e,t){return d("~/rpc/UserMgmt/SetPassword",{method:"post",data:{UserName:e,NewPassword:t}})}function d(t,r){var i=e.defer();return n.ajax(t,r).done(i.resolve).fail(i.reject),i.promise}return{getAllUsers:i,getAllRoles:a,getUser:o,createUser:s,updateUser:l,deleteUser:u,setPassword:c}});
