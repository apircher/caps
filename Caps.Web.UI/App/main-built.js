...
define('plugins/router',["durandal/system","durandal/app","durandal/activator","durandal/events","durandal/composition","plugins/history","knockout","jquery"],function(e,t,n,r,i,a,o,s){function l(e){return e=e.replace(g,"\\$&").replace(p,"(?:$1)?").replace(v,function(e,t){return t?e:"([^/]+)"}).replace(m,"(.*?)"),new RegExp("^"+e+"$")}function u(e){var t=e.indexOf(":"),n=t>0?t-1:e.length;return e.substring(0,n)}function c(e,t){return-1!==e.indexOf(t,e.length-t.length)}function d(e,t){if(!e||!t)return!1;if(e.length!=t.length)return!1;for(var n=0,r=e.length;r>n;n++)if(e[n]!=t[n])return!1;return!0}var f,h,p=/\((.*?)\)/g,v=/(\(\?)?:\w+/g,m=/\*\w+/g,g=/[\-{}\[\]+?.,\\\^$|#\s]/g,b=/\/$/,y=function(){function i(e){return e.router&&e.router.parent==T}function s(e){F&&F.config.isActive&&F.config.isActive(e)}function p(t,n){e.log("Navigation Complete",t,n);var r=e.getModuleId(S);r&&T.trigger("router:navigation:from:"+r),S=t,s(!1),F=n,s(!0);var a=e.getModuleId(S);a&&T.trigger("router:navigation:to:"+a),i(t)||T.updateDocumentTitle(t,n),h.explicitNavigation=!1,h.navigatingBack=!1,T.trigger("router:navigation:complete",t,n,T)}function v(t,n){e.log("Navigation Cancelled"),T.activeInstruction(F),F&&T.navigate(F.fragment,!1),P(!1),h.explicitNavigation=!1,h.navigatingBack=!1,T.trigger("router:navigation:cancelled",t,n,T)}function m(t){e.log("Navigation Redirecting"),P(!1),h.explicitNavigation=!1,h.navigatingBack=!1,T.navigate(t,{trigger:!0,replace:!0})}function g(t,n,r){h.navigatingBack=!h.explicitNavigation&&S!=r.fragment,T.trigger("router:route:activating",n,r,T),t.activateItem(n,r.params).then(function(e){if(e){var a=S;if(p(n,r),i(n)){var o=r.fragment;r.queryString&&(o+="?"+r.queryString),n.router.loadUrl(o)}a==n&&(T.attached(),T.compositionComplete())}else t.settings.lifecycleData&&t.settings.lifecycleData.redirect?m(t.settings.lifecycleData.redirect):v(n,r);f&&(f.resolve(),f=null)}).fail(function(t){e.error(t)})}function w(t,n,r){var i=T.guardRoute(n,r);i?i.then?i.then(function(i){i?e.isString(i)?m(i):g(t,n,r):v(n,r)}):e.isString(i)?m(i):g(t,n,r):v(n,r)}function k(e,t,n){T.guardRoute?w(e,t,n):g(e,t,n)}function x(e){return F&&F.config.moduleId==e.config.moduleId&&S&&(S.canReuseForRoute&&S.canReuseForRoute.apply(S,e.params)||!S.canReuseForRoute&&S.router&&S.router.loadUrl)}function D(){if(!P()){var t=_.shift();_=[],t&&(P(!0),T.activeInstruction(t),x(t)?k(n.create(),S,t):e.acquire(t.config.moduleId).then(function(n){var r=e.resolveObject(n);k(E,r,t)}).fail(function(n){e.error("Failed to load routed module ("+t.config.moduleId+"). Details: "+n.message)}))}}function C(e){_.unshift(e),D()}function N(e,t,n){for(var r=e.exec(t).slice(1),i=0;i<r.length;i++){var a=r[i];r[i]=a?decodeURIComponent(a):null}var o=T.parseQueryString(n);return o&&r.push(o),{params:r,queryParams:o}}function I(t){T.trigger("router:route:before-config",t,T),e.isRegExp(t)?t.routePattern=t.route:(t.title=t.title||T.convertRouteToTitle(t.route),t.moduleId=t.moduleId||T.convertRouteToModuleId(t.route),t.hash=t.hash||T.convertRouteToHash(t.route),t.routePattern=l(t.route)),t.isActive=t.isActive||o.observable(!1),T.trigger("router:route:after-config",t,T),T.routes.push(t),T.route(t.routePattern,function(e,n){var r=N(t.routePattern,e,n);C({fragment:e,queryString:n,config:t,params:r.params,queryParams:r.queryParams})})}function M(t){if(e.isArray(t.route))for(var n=t.isActive||o.observable(!1),r=0,i=t.route.length;i>r;r++){var a=e.extend({},t);a.route=t.route[r],a.isActive=n,r>0&&delete a.nav,I(a)}else I(t);return T}var S,F,_=[],P=o.observable(!1),E=n.create(),T={handlers:[],routes:[],navigationModel:o.observableArray([]),activeItem:E,isNavigating:o.computed(function(){var e=E(),t=P(),n=e&&e.router&&e.router!=T&&e.router.isNavigating()?!0:!1;return t||n}),activeInstruction:o.observable(null),__router__:!0};return r.includeIn(T),E.settings.areSameItem=function(e,t,n,r){return e==t?d(n,r):!1},T.parseQueryString=function(e){var t,n;if(!e)return null;if(n=e.split("&"),0==n.length)return null;t={};for(var r=0;r<n.length;r++){var i=n[r];if(""!==i){var a=i.split("=");t[a[0]]=a[1]&&decodeURIComponent(a[1].replace(/\+/g," "))}}return t},T.route=function(e,t){T.handlers.push({routePattern:e,callback:t})},T.loadUrl=function(t){var n=T.handlers,r=null,i=t,o=t.indexOf("?");if(-1!=o&&(i=t.substring(0,o),r=t.substr(o+1)),T.relativeToParentRouter){var s=this.parent.activeInstruction();i=s.params.join("/"),i&&"/"==i.charAt(0)&&(i=i.substr(1)),i||(i=""),i=i.replace("//","/").replace("//","/")}i=i.replace(b,"");for(var l=0;l<n.length;l++){var u=n[l];if(u.routePattern.test(i))return u.callback(i,r),!0}return e.log("Route Not Found"),T.trigger("router:route:not-found",t,T),F&&a.navigate(F.fragment,{trigger:!1,replace:!0}),h.explicitNavigation=!1,h.navigatingBack=!1,!1},T.updateDocumentTitle=function(e,n){n.config.title?document.title=t.title?n.config.title+" | "+t.title:n.config.title:t.title&&(document.title=t.title)},T.navigate=function(e,t){return e&&-1!=e.indexOf("://")?(window.location.href=e,!0):(h.explicitNavigation=!0,a.navigate(e,t))},T.navigateBack=function(){a.navigateBack()},T.attached=function(){T.trigger("router:navigation:attached",S,F,T)},T.compositionComplete=function(){P(!1),T.trigger("router:navigation:composition-complete",S,F,T),D()},T.convertRouteToHash=function(e){if(T.relativeToParentRouter){var t=T.parent.activeInstruction(),n=t.config.hash+"/"+e;return a._hasPushState&&(n="/"+n),n=n.replace("//","/").replace("//","/")}return a._hasPushState?e:"#"+e},T.convertRouteToModuleId=function(e){return u(e)},T.convertRouteToTitle=function(e){var t=u(e);return t.substring(0,1).toUpperCase()+t.substring(1)},T.map=function(t,n){if(e.isArray(t)){for(var r=0;r<t.length;r++)T.map(t[r]);return T}return e.isString(t)||e.isRegExp(t)?(n?e.isString(n)&&(n={moduleId:n}):n={},n.route=t):n=t,M(n)},T.buildNavigationModel=function(t){for(var n=[],r=T.routes,i=t||100,a=0;a<r.length;a++){var o=r[a];o.nav&&(e.isNumber(o.nav)||(o.nav=++i),n.push(o))}return n.sort(function(e,t){return e.nav-t.nav}),T.navigationModel(n),T},T.mapUnknownRoutes=function(t,n){var r="*catchall",i=l(r);return T.route(i,function(o,s){var l=N(i,o,s),u={fragment:o,queryString:s,config:{route:r,routePattern:i},params:l.params,queryParams:l.queryParams};if(t)if(e.isString(t))u.config.moduleId=t,n&&a.navigate(n,{trigger:!1,replace:!0});else if(e.isFunction(t)){var c=t(u);if(c&&c.then)return c.then(function(){T.trigger("router:route:before-config",u.config,T),T.trigger("router:route:after-config",u.config,T),C(u)}),void 0}else u.config=t,u.config.route=r,u.config.routePattern=i;else u.config.moduleId=o;T.trigger("router:route:before-config",u.config,T),T.trigger("router:route:after-config",u.config,T),C(u)}),T},T.reset=function(){return F=S=void 0,T.handlers=[],T.routes=[],T.off(),delete T.options,T},T.makeRelative=function(t){return e.isString(t)&&(t={moduleId:t,route:t}),t.moduleId&&!c(t.moduleId,"/")&&(t.moduleId+="/"),t.route&&!c(t.route,"/")&&(t.route+="/"),t.fromParent&&(T.relativeToParentRouter=!0),T.on("router:route:before-config").then(function(e){t.moduleId&&(e.moduleId=t.moduleId+e.moduleId),t.route&&(e.route=""===e.route?t.route.substring(0,t.route.length-1):t.route+e.route)}),T},T.createChildRouter=function(){var e=y();return e.parent=T,e},T};return h=y(),h.explicitNavigation=!1,h.navigatingBack=!1,h.targetIsThisWindow=function(e){var t=s(e.target).attr("target");return!t||t===window.name||"_self"===t||"top"===t&&window===window.top?!0:!1},h.activate=function(t){return e.defer(function(n){if(f=n,h.options=e.extend({routeHandler:h.loadUrl},h.options,t),a.activate(h.options),a._hasPushState)for(var r=h.routes,i=r.length;i--;){var o=r[i];o.hash=o.hash.replace("#","")}s(document).delegate("a","click",function(e){if(a._hasPushState){if(!e.altKey&&!e.ctrlKey&&!e.metaKey&&!e.shiftKey&&h.targetIsThisWindow(e)){var t=s(this).attr("href");null==t||"#"===t.charAt(0)||/^[a-z]+:/i.test(t)||(h.explicitNavigation=!0,e.preventDefault(),a.navigate(t))}}else h.explicitNavigation=!0}),a.options.silent&&f&&(f.resolve(),f=null)}).promise()},h.deactivate=function(){a.deactivate()},h.install=function(){o.bindingHandlers.router={init:function(){return{controlsDescendantBindings:!0}},update:function(e,t,n,r,a){var s=o.utils.unwrapObservable(t())||{};if(s.__router__)s={model:s.activeItem(),attached:s.attached,compositionComplete:s.compositionComplete,activate:!1};else{var l=o.utils.unwrapObservable(s.router||r.router)||h;s.model=l.activeItem(),s.attached=l.attached,s.compositionComplete=l.compositionComplete,s.activate=!1}i.compose(e,s,a)}},o.virtualElements.allowedBindings.router=!0},h});
//! moment.js
//! version : 2.4.0
