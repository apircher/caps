...
define('plugins/router',["durandal/system","durandal/app","durandal/activator","durandal/events","durandal/composition","plugins/history","knockout","jquery"],function(e,t,n,r,i,a,o,s){function l(e){return e=e.replace(b,"\\$&").replace(v,"(?:$1)?").replace(m,function(e,t){return t?e:"([^/]+)"}).replace(g,"(.*?)"),new RegExp("^"+e+"$",w?void 0:"i")}function u(e){var t=e.indexOf(":"),n=t>0?t-1:e.length;return e.substring(0,n)}function c(e,t){return-1!==e.indexOf(t,e.length-t.length)}function d(e,t){if(!e||!t)return!1;if(e.length!=t.length)return!1;for(var n=0,r=e.length;r>n;n++)if(e[n]!=t[n])return!1;return!0}function f(e){return e.queryString?e.fragment+"?"+e.queryString:e.fragment}var h,p,v=/\((.*?)\)/g,m=/(\(\?)?:\w+/g,g=/\*\w+/g,b=/[\-{}\[\]+?.,\\\^$|#\s]/g,y=/\/$/,w=!1,k=function(){function i(e,t){return e.router&&e.router.parent==t}function s(e){P&&P.config.isActive&&P.config.isActive(e)}function v(t,n){e.log("Navigation Complete",t,n);var r=e.getModuleId(M);r&&R.trigger("router:navigation:from:"+r),M=t,s(!1),P=n,s(!0);var a=e.getModuleId(M);a&&R.trigger("router:navigation:to:"+a),i(t,R)||R.updateDocumentTitle(t,n),E(!1),p.explicitNavigation=!1,p.navigatingBack=!1,R.trigger("router:navigation:complete",t,n,R)}function m(t,n){e.log("Navigation Cancelled"),R.activeInstruction(P),P&&R.navigate(f(P),!1),E(!1),p.explicitNavigation=!1,p.navigatingBack=!1,R.trigger("router:navigation:cancelled",t,n,R)}function g(t){e.log("Navigation Redirecting"),E(!1),p.explicitNavigation=!1,p.navigatingBack=!1,R.navigate(t,{trigger:!0,replace:!0})}function b(t,n,r){p.navigatingBack=!p.explicitNavigation&&M!=r.fragment,R.trigger("router:route:activating",n,r,R),t.activateItem(n,r.params).then(function(e){if(e){var a=M;if(v(n,r),i(n,R)){var o=r.fragment;r.queryString&&(o+="?"+r.queryString),n.router.loadUrl(o)}a==n&&(R.attached(),R.compositionComplete())}else t.settings.lifecycleData&&t.settings.lifecycleData.redirect?g(t.settings.lifecycleData.redirect):m(n,r);h&&(h.resolve(),h=null)}).fail(function(t){e.error(t)})}function w(t,n,r){var i=R.guardRoute(n,r);i?i.then?i.then(function(i){i?e.isString(i)?g(i):b(t,n,r):m(n,r)}):e.isString(i)?g(i):b(t,n,r):m(n,r)}function x(e,t,n){R.guardRoute?w(e,t,n):b(e,t,n)}function C(e){return P&&P.config.moduleId==e.config.moduleId&&M&&(M.canReuseForRoute&&M.canReuseForRoute.apply(M,e.params)||!M.canReuseForRoute&&M.router&&M.router.loadUrl)}function N(){if(!E()){var t=T.shift();T=[],t&&(E(!0),R.activeInstruction(t),C(t)?x(n.create(),M,t):e.acquire(t.config.moduleId).then(function(n){var r=e.resolveObject(n);x(_,r,t)}).fail(function(n){e.error("Failed to load routed module ("+t.config.moduleId+"). Details: "+n.message)}))}}function D(e){T.unshift(e),N()}function I(e,t,n){for(var r=e.exec(t).slice(1),i=0;i<r.length;i++){var a=r[i];r[i]=a?decodeURIComponent(a):null}var o=R.parseQueryString(n);return o&&r.push(o),{params:r,queryParams:o}}function S(t){R.trigger("router:route:before-config",t,R),e.isRegExp(t)?t.routePattern=t.route:(t.title=t.title||R.convertRouteToTitle(t.route),t.moduleId=t.moduleId||R.convertRouteToModuleId(t.route),t.hash=t.hash||R.convertRouteToHash(t.route),t.routePattern=l(t.route)),t.isActive=t.isActive||o.observable(!1),R.trigger("router:route:after-config",t,R),R.routes.push(t),R.route(t.routePattern,function(e,n){var r=I(t.routePattern,e,n);D({fragment:e,queryString:n,config:t,params:r.params,queryParams:r.queryParams})})}function F(t){if(e.isArray(t.route))for(var n=t.isActive||o.observable(!1),r=0,i=t.route.length;i>r;r++){var a=e.extend({},t);a.route=t.route[r],a.isActive=n,r>0&&delete a.nav,S(a)}else S(t);return R}var M,P,T=[],E=o.observable(!1),_=n.create(),R={handlers:[],routes:[],navigationModel:o.observableArray([]),activeItem:_,isNavigating:o.computed(function(){var e=_(),t=E(),n=e&&e.router&&e.router!=R&&e.router.isNavigating()?!0:!1;return t||n}),activeInstruction:o.observable(null),__router__:!0};return r.includeIn(R),_.settings.areSameItem=function(e,t,n,r){return e==t?d(n,r):!1},R.parseQueryString=function(e){var t,n;if(!e)return null;if(n=e.split("&"),0==n.length)return null;t={};for(var r=0;r<n.length;r++){var i=n[r];if(""!==i){var a=i.split("=");t[a[0]]=a[1]&&decodeURIComponent(a[1].replace(/\+/g," "))}}return t},R.route=function(e,t){R.handlers.push({routePattern:e,callback:t})},R.loadUrl=function(t){var n=R.handlers,r=null,i=t,o=t.indexOf("?");if(-1!=o&&(i=t.substring(0,o),r=t.substr(o+1)),R.relativeToParentRouter){var s=this.parent.activeInstruction();i=s.params.join("/"),i&&"/"==i.charAt(0)&&(i=i.substr(1)),i||(i=""),i=i.replace("//","/").replace("//","/")}i=i.replace(y,"");for(var l=0;l<n.length;l++){var u=n[l];if(u.routePattern.test(i))return u.callback(i,r),!0}return e.log("Route Not Found"),R.trigger("router:route:not-found",t,R),P&&a.navigate(f(P),{trigger:!1,replace:!0}),p.explicitNavigation=!1,p.navigatingBack=!1,!1},R.updateDocumentTitle=function(e,n){n.config.title?document.title=t.title?n.config.title+" | "+t.title:n.config.title:t.title&&(document.title=t.title)},R.navigate=function(e,t){return e&&-1!=e.indexOf("://")?(window.location.href=e,!0):(p.explicitNavigation=!0,a.navigate(e,t))},R.navigateBack=function(){a.navigateBack()},R.attached=function(){R.trigger("router:navigation:attached",M,P,R)},R.compositionComplete=function(){E(!1),R.trigger("router:navigation:composition-complete",M,P,R),N()},R.convertRouteToHash=function(e){if(R.relativeToParentRouter){var t=R.parent.activeInstruction(),n=t.config.hash+"/"+e;return a._hasPushState&&(n="/"+n),n=n.replace("//","/").replace("//","/")}return a._hasPushState?e:"#"+e},R.convertRouteToModuleId=function(e){return u(e)},R.convertRouteToTitle=function(e){var t=u(e);return t.substring(0,1).toUpperCase()+t.substring(1)},R.map=function(t,n){if(e.isArray(t)){for(var r=0;r<t.length;r++)R.map(t[r]);return R}return e.isString(t)||e.isRegExp(t)?(n?e.isString(n)&&(n={moduleId:n}):n={},n.route=t):n=t,F(n)},R.buildNavigationModel=function(t){for(var n=[],r=R.routes,i=t||100,a=0;a<r.length;a++){var o=r[a];o.nav&&(e.isNumber(o.nav)||(o.nav=++i),n.push(o))}return n.sort(function(e,t){return e.nav-t.nav}),R.navigationModel(n),R},R.mapUnknownRoutes=function(t,n){var r="*catchall",i=l(r);return R.route(i,function(o,s){var l=I(i,o,s),u={fragment:o,queryString:s,config:{route:r,routePattern:i},params:l.params,queryParams:l.queryParams};if(t)if(e.isString(t))u.config.moduleId=t,n&&a.navigate(n,{trigger:!1,replace:!0});else if(e.isFunction(t)){var c=t(u);if(c&&c.then)return c.then(function(){R.trigger("router:route:before-config",u.config,R),R.trigger("router:route:after-config",u.config,R),D(u)}),void 0}else u.config=t,u.config.route=r,u.config.routePattern=i;else u.config.moduleId=o;R.trigger("router:route:before-config",u.config,R),R.trigger("router:route:after-config",u.config,R),D(u)}),R},R.reset=function(){return P=M=void 0,R.handlers=[],R.routes=[],R.off(),delete R.options,R},R.makeRelative=function(t){return e.isString(t)&&(t={moduleId:t,route:t}),t.moduleId&&!c(t.moduleId,"/")&&(t.moduleId+="/"),t.route&&!c(t.route,"/")&&(t.route+="/"),t.fromParent&&(R.relativeToParentRouter=!0),R.on("router:route:before-config").then(function(e){t.moduleId&&(e.moduleId=t.moduleId+e.moduleId),t.route&&(e.route=""===e.route?t.route.substring(0,t.route.length-1):t.route+e.route)}),R},R.createChildRouter=function(){var e=k();return e.parent=R,e},R};return p=k(),p.explicitNavigation=!1,p.navigatingBack=!1,p.makeRoutesCaseSensitive=function(){w=!0},p.targetIsThisWindow=function(e){var t=s(e.target).attr("target");return!t||t===window.name||"_self"===t||"top"===t&&window===window.top?!0:!1},p.activate=function(t){return e.defer(function(n){if(h=n,p.options=e.extend({routeHandler:p.loadUrl},p.options,t),a.activate(p.options),a._hasPushState)for(var r=p.routes,i=r.length;i--;){var o=r[i];o.hash=o.hash.replace("#","")}s(document).delegate("a","click",function(e){if(a._hasPushState){if(!e.altKey&&!e.ctrlKey&&!e.metaKey&&!e.shiftKey&&p.targetIsThisWindow(e)){var t=s(this).attr("href");null==t||"#"===t.charAt(0)||/^[a-z]+:/i.test(t)||(p.explicitNavigation=!0,e.preventDefault(),a.navigate(t))}}else p.explicitNavigation=!0}),a.options.silent&&h&&(h.resolve(),h=null)}).promise()},p.deactivate=function(){a.deactivate()},p.install=function(){o.bindingHandlers.router={init:function(){return{controlsDescendantBindings:!0}},update:function(e,t,n,r,a){var s=o.utils.unwrapObservable(t())||{};if(s.__router__)s={model:s.activeItem(),attached:s.attached,compositionComplete:s.compositionComplete,activate:!1};else{var l=o.utils.unwrapObservable(s.router||r.router)||p;s.model=l.activeItem(),s.attached=l.attached,s.compositionComplete=l.compositionComplete,s.activate=!1}i.compose(e,s,a)}},o.virtualElements.allowedBindings.router=!0},p});
//! moment.js
//! version : 2.5.1
...
define('authentication',["Q","durandal/system","durandal/app","plugins/router","ko","infrastructure/antiForgeryToken","moment","infrastructure/utils"],function(e,t,n,o,r,i,a,s){function u(e,t){var n=t?localStorage:sessionStorage;n.accessToken=e}function c(){return sessionStorage.accessToken||localStorage.accessToken}function l(){localStorage.removeItem("accessToken"),sessionStorage.removeItem("accessToken")}function f(){return t.defer(function(e){$.ajax("~/api/account/authmetadata",{method:"get"}).then(function(t){A.lockoutPeriod=t.lockoutPeriod,A.minRequiredPasswordLength=t.minRequiredPasswordLength,e.resolve()}).fail(function(n){t.log("getMetadata failed: "+n.message),e.reject(n)})}).promise()}function d(){return t.defer(function(e){$.ajax("~/api/account/userinfo",{method:"get"}).then(function(t){y(new k(t.isAuthenticated,t.userName,t.roles,t)),t.IsAuthenticated&&n.trigger("caps:authentication:loggedOn",y()),e.resolve(y())}).fail(function(n){t.log("getCurrentUser failed: "+n.responseJSON.message),401==n.status?(y(new k(!1)),e.resolve(y())):e.reject(n)})}).promise()}function g(e,n){return t.defer(function(t){$.ajax("~/api/account/managementinfo",{method:"get",data:{returnUrl:e,generateState:n}}).then(function(e){t.resolve(e)}).fail(function(e){t.reject(e)})}).promise()}function h(e,n){return t.defer(function(t){$.ajax("~/api/account/externallogins",{method:"get",data:{returnUrl:e,generateState:n}}).then(t.resolve).fail(t.reject)}).promise()}function m(e){return t.defer(function(t){$.ajax("~/api/account/addexternallogin",{method:"post",data:{externalAccessToken:e}}).then(t.resolve).fail(t.reject)}).promise()}function p(e,n){return t.defer(function(t){$.ajax("~/api/account/removelogin",{method:"post",data:{loginProvider:e,providerKey:n}}).then(t.resolve).fail(t.reject)}).promise()}function v(e){return t.defer(function(t){$.ajax("~/api/account/setpassword",{method:"post",data:e}).then(t.resolve).fail(t.reject)}).promise()}function w(){return t.defer(function(e){I()&&!y().isExpired()?e.resolve(y()):y().isExpired()?d().then(e.resolve).fail(e.reject):e.resolve(y())}).promise()}function j(o,r,a){return t.defer(function(s){function c(o){return o.userName&&o.access_token?(u(o.access_token,a),t.log("logon successful"),e.fcall(i.initToken).then(d).then(function(){n.trigger("caps:authentication:loggedOn",y()),s.resolve(o)}).fail(l),void 0):(l(new Error(b(o))),void 0)}function l(e){t.log("logon failed: "+e.message||e.error),s.reject(e)}$.ajax("~/Token?rememberMe="+a,{method:"post",data:{grant_type:"password",UserName:o,Password:r}}).done(c).fail(l)}).promise()}function R(){return t.defer(function(e){$.ajax("~/api/account/logout",{method:"post"}).then(l).then(i.initToken).then(function(){t.log("logoff successful"),n.trigger("caps:authentication:loggedOff"),y(new k),e.resolve()}).fail(e.reject)}).promise()}function x(e){return t.defer(function(t){$.ajax("~/api/account/changepassword",{method:"post",data:e}).then(d).then(t.resolve).fail(t.reject)}).promise()}function k(e,t,n,o,i){var a=this;o=o||{},this.expirationTicket=new S(i),this.isAuthenticated=r.observable(e||!1),this.userName=r.observable(t||""),this.roles=r.observable(n||[]),this.creationDate=r.observable(o.creationDate||new Date),this.lastPasswordChangedDate=r.observable(o.lastPasswordChangedDate),this.firstName=r.observable(o.firstName||""),this.lastName=r.observable(o.lastName||""),this.displayName=r.computed(function(){return a.firstName().length>0?a.firstName():a.lastName().length>0?a.lastName():a.userName()}),this.fullName=r.computed(function(){return"{0} {1}".replace(/\{0\}/,a.firstName()).replace(/\{1\}/,a.lastName()).trim()}),this.hasEverChangedPassword=r.computed(function(){return a.lastPasswordChangedDate()>a.creationDate()}),this.isInRole=function(e){for(var t=0;t<this.roles().length;t++)if(this.roles()[t]==e)return!0;return!1},this.isInAnyRole=function(e){if(!e||0===e.length)return!0;for(var t=0;t<e.length;t++)if(this.isInRole(e[t]))return!0;return!1}}function S(e){this.created=new Date,this.expiration=e||!1}function b(e){var t="Die Anmeldung ist fehlgeschlagen. Versuche es in einigen Minuten nochmal. Melde das Problem, wenn es weiterhin besteht.";if(e){var n=e.Error;if(n){if("ERROR_LOCKED"==n){var o="Dein Konto wurde aufgrund zu vieler ungültiger Anmelde-Versuche gesperrt. Die Sperrung wird nach {0} Minuten automatisch aufgehoben.";return o.replace(/\{0\}/gi,A.lockoutPeriod)}if("ERROR_NOTAPPROVED"==n)return"Dein Konto wurde noch nicht bestätigt.";if("ERROR_USER_OR_PASSWORD_INVALID"==n)return"Der Benutzername oder das Passwort sind ungültig.";if("Bad request"==n)return t}}return e.Error||t}function N(){window.location.hash="","undefined"!=typeof history.pushState&&history.pushState("",document.title,location.pathname)}function P(){var e=localStorage.logonSuccessRoute;e&&(localStorage.removeItem("logonSuccessRoute"),window.location.hash=e)}var y=r.observable(new k),E="viewmodels/login",D="login",T="",A={lockoutPeriod:15,minRequiredPasswordLength:6};$(document).ajaxSend(function(e,t){var n=c();n&&t.setRequestHeader("Authorization","Bearer "+n)});var I=r.computed(function(){return y().isAuthenticated()});return o.logon=function(e){if(e.config.moduleId===E)throw new Error("The logon-Function may not be called with the logon-route.");return o.logonSuccessRoute=e,D},o.redirectFromLogonView=function(){var e=T;if(o.logonSuccessRoute){var t=o.logonSuccessRoute;delete o.logonSuccessRoute,e=t.config.hash}o.navigate(e,{trigger:!0,replace:!0})},o.guardRoute=function(e,n){return t.defer(function(e){w().then(function(){I()||n.config.moduleId===E?(n.config.roles&&!y().isInAnyRole(n.config.roles)&&e.resolve("forbidden"),e.resolve(!0)):e.resolve(o.logon(n))}).fail(e.reject)}).promise()},k.prototype.isExpired=function(){return this.expirationTicket.isExpired()},S.prototype.isExpired=function(){return this.expiration?a(this.created).add("seconds",this.expiration)<new Date:!1},{metadata:A,user:y,logon:j,logoff:R,changePassword:x,setPassword:v,isAuthenticated:I,initialize:function(){function n(){return t.defer(function(t){sessionStorage.associatingExternalLogin?(sessionStorage.removeItem("associatingExternalLogin"),"undefined"!=typeof c.error?(r=null,a=c.error):"undefined"!=typeof c.access_token?(r=c.access_token,a=null):(r=null,a=null),N(),d().then(function(e){e.userName?(window.location.hash="#profile",m(r).then(t.resolve(e))):t.reject()}).fail(t.reject)):"undefined"!=typeof c.error?(N(),t.reject(new Error(c.error))):"undefined"!=typeof c.access_token?(N(),u(c.access_token),e.fcall(i.initToken).then(function(){d().then(function(e){P(),o.redirectFromLogonView(),t.resolve(e)})})):d().then(function(e){t.resolve(e)})}).promise()}var r,a,c=s.getFragment();return f().then(n)},UserModel:k,getAccountManagementInfo:g,getExternalLoginProviders:h,removeLogin:p}});
...
define('infrastructure/filterModel',["require","ko"],function(e,t){function n(e,n,r){var o=this;o.name=e,o.title=n,o.value=r,o.isSelected=t.observable(!0),o.toggleSelect=function(){o.isSelected(!o.isSelected())}}function r(e){var n=this;e&&e.length>0&&e.sort(function(e,t){return e.title.localeCompare(t.title)}),n.filters=t.observableArray(e||[]),n.selectedFilters=t.computed(function(){return t.utils.arrayFilter(n.filters(),function(e){return e.isSelected()})}),n.clear=function(){n.filters([])},n.reset=function(){t.utils.arrayForEach(n.selectedFilters(),function(e){e.isSelected(!1)})},n.allSelected=t.computed({read:function(){for(var e=0;e<n.filters().length;e++)if(!n.filters()[e].isSelected())return!1;return!0},write:function(e){t.utils.arrayForEach(n.filters(),function(t){t.isSelected()!==e&&t.isSelected(e)})}}),n.toggleAll=function(){n.allSelected(!n.allSelected())}}return n.prototype.clone=function(){var e=new n(this.name,this.title,this.value);return e.isSelected(this.isSelected()),e},r.prototype.clone=function(){var e=t.utils.arrayMap(this.filters(),function(e){return e.clone()});return new r(e)},r.prototype.createOrUpdateFilter=function(e,t,r){var o=this.findFilter(r);o?(o.title=e,o.value=r):(o=new n(t,e,r),this.filters.push(o))},r.prototype.add=function(e){this.filters.push(e),this.filters.sort(function(e,t){return e.title.localeCompare(t.title)})},r.prototype.findFilter=function(e){return t.utils.arrayFirst(this.filters(),function(t){return t.value===e})},r.prototype.toString=function(){if(this.allSelected())return"";for(var e=this.selectedFilters(),t="",n=0;n<e.length;n++)t+=e[n].value+(n<e.length-1?"|":"");return t},{FilterItem:n,FilterOptions:r}});
...
define('infrastructure/keyboardHandler',["jquery","ko","durandal/system"],function(e,t,n){function r(e){function r(){o.on("keydown",a)}function i(){o.off("keydown",a)}function a(e){var t=s.keydown;n.isFunction(t)&&t.call(s,e)}var s=this,c=t.observable(!1);e.on("module:activate",function(){c()&&r()}),e.on("module:deactivate",function(){c()&&i()}),s.isActive=c,s.activate=function(){c(!0),r()},s.deactivate=function(){c(!1),i()}}var o=e(window);return r.prototype.keydown=function(e){n.log("Keydown: "+e.keyCode)},r});
...
define('infrastructure/moduleRouter',["plugins/router","durandal/system","infrastructure/moduleRegistry","ko","infrastructure/utils","durandal/composition"],function(e,t,n,r,i,o){function a(e){return r.utils.arrayForEach(n.modules(),function(t){s(e,t)}),e}function s(e,n){var r=n.routeConfig;if(!r)throw new Error("No moduleRoute found.");r.isModuleRoute=!0,e.map(r),t.isFunction(n.initializeRouter)&&n.initializeRouter()}function u(t,n,r){var i=e.createChildRouter().makeRelative({moduleId:n,route:r});return c(i,t),i.on("router:navigation:complete",function(e,n,r){o.current.complete(function(){t.trigger("module:compositionComplete",t,e,n,r)})}),i}function c(e,n){e.activeItem.settings.areSameItem=function(n,r,o,a){return n==r||t.getModuleId(n)==t.getModuleId(r)?n&&t.isFunction(n.shouldActivate)?!n.shouldActivate(e,o,a):i.compareArrays(o,a):!1},e.navigateToModule=function(){var t=e.activeInstruction();null==t?e.navigate(n.routeConfig.hash):e.navigate(t.fragment)}}return{mapModuleRoutes:a,createModuleRouter:u}});
...
requirejs.config({paths:{text:"../Scripts/text",durandal:"../Scripts/durandal",plugins:"../Scripts/durandal/plugins",transitions:"../Scripts/durandal/transitions",entityManagerProvider:"infrastructure/entityManagerProvider",authentication:"infrastructure/authentication",localization:"infrastructure/localization","knockout.extenders":"../Scripts/knockout.extenders",typeahead:"../Scripts/typeahead",moment:"../Scripts/moment",doubleTap:"../Scripts/doubleTap"},map:{"*":{ko:"knockout"}}}),define("jquery",function(){return jQuery}),define("knockout",ko),define("knockout.validation",ko.validation),define("Q",function(){return Q}),define("breeze",function(){return breeze}),define("markdown",function(){return Markdown}),define("toastr",function(){return toastr}),define('main',["durandal/app","durandal/viewLocator","durandal/system","Q","authentication","infrastructure/antiForgeryToken","knockout.validation","localization","infrastructure/moduleLoader","plugins/router","jquery","entityManagerProvider","infrastructure/serverUtil","durandal/composition","knockout.extenders","infrastructure/validation","../Scripts/safari.cancelZoom","infrastructure/contentEditing"],function(e,t,n,r,i,a,o,s,l,c,d,u,f,h){function p(){var t={message:"Mindestens ein Bereich enthält ungespeicherte Änderungen.",cancel:!1};return e.trigger("app:beforeunload",t),t.cancel?t.message:void 0}function m(){require(["plugins/dialog"],function(e){e.MessageBox.defaultViewMarkup=['<div data-view="plugins/messageBox" class="messageBox">','<div class="modal-header">','<h4 data-bind="text: title"></h4>',"</div>",'<div class="modal-body">','<p class="message" data-bind="text: message"></p>',"</div>",'<div class="modal-footer" data-bind="foreach: options">',"<button class=\"btn\" data-bind=\"click: function () { $parent.selectOption($data); }, text: $data, css: { 'btn-primary': $index() == 0, 'btn-default': $index() != 0, autofocus: $index() == 0 }\"></button>","</div>","</div>"].join("\n")})}function v(e){e.archiveSessionStorageToLocalStorage=function(){for(var e={},t=0;t<sessionStorage.length;t++)e[sessionStorage.key(t)]=sessionStorage[sessionStorage.key(t)];localStorage.sessionStorageBackup=JSON.stringify(e),sessionStorage.clear()},e.restoreSessionStorageFromLocalStorage=function(){var e,t=localStorage.sessionStorageBackup;if(t){e=JSON.parse(t);for(var n in e)sessionStorage[n]=e[n];localStorage.removeItem("sessionStorageBackup")}}}n.debug(!0),n.defer=function(e){var t=r.defer();e.call(t,t);var n=t.promise;return t.promise=function(){return n},t},d(document).ajaxSend(function(e,t,n){n.url=f.mapPath(n.url)}),v(e),e.restoreSessionStorageFromLocalStorage(),d(window).bind("beforeunload",p),e.title="CAPS",e.configurePlugins({router:!0,dialog:!0,widget:!0,fileSelection:!0,siteMapNodeSelection:!0,contentSelection:!0}),o.init({insertMessages:!1}),s.localize("de"),h.addBindingHandler("forceViewportHeight"),r.fcall(a.initToken).then(i.initialize).then(l.loadModules(["sitemap","draft","contentfile","user"])).then(u.initialize).then(e.start).then(function(){t.useConvention(),m(),e.setRoot("viewmodels/shell","entrance"),e.trigger("caps:started")}).done()});
define('modules/contentfile/datacontext',["durandal/system","breeze","entityManagerProvider","jquery","infrastructure/userQueryParser"],function(e,t,n,r,i){function a(){var e=x.from("Files");return k.executeQuery(e)}function o(e,t,n,r,i){var a=i?x.from("FilteredFiles").withParameters({filterOptions:i}):x.from("Files"),o=s(a,e).expand("Versions").orderBy(r||"Created.At desc").skip((t-1)*n).take(n).inlineCount(!0);return k.executeQuery(o)}function s(e,t){if(t&&t.length){var n=N.getBreezePredicate(t);if(n)return e.where(n)}return e}function l(e){var t=x.from("Files").where("Id","==",e).expand("Tags.Tag, Versions.Properties, Versions.DraftFileResources.DraftFile, Versions.PublicationFileResources.PublicationFile");return k.executeQuery(t)}function c(t){return e.defer(function(e){function n(t){e.resolve(t)}r.ajax("api/dbfileversion/"+t+"/thumbnails",{method:"get"}).done(n).fail(e.reject)}).promise()}function d(t,n){return e.defer(function(e){r.ajax("api/dbfileVersion/"+t+"/thumbnail/"+n,{method:"delete"}).done(e.resolve).fail(e.reject)}).promise()}function u(e){return k.getEntityByKey("DbFile",e)}function f(t){return e.defer(function(e){function n(){k.detachEntity(t),e.resolve()}r.ajax("api/DbFile/"+t.Id(),{method:"delete"}).done(n).fail(e.reject)}).promise()}function h(t){return e.defer(function(n){function i(){try{k.detachEntity(t)}catch(r){e.log(r)}n.resolve()}r.ajax("api/DbFileVersion/"+t.Id(),{method:"delete"}).done(i).fail(n.reject)}).promise()}function p(t,n){return e.defer(function(e){var r=x.from("Tags").where("Id","==",n.Id());k.executeQuery(r).then(function(n){var r=n.results[0],i=k.createEntity("DbFileTag",{FileId:t.Id(),TagId:r.Id()});k.addEntity(i),k.saveChanges().fail(e.reject).done(e.resolve)}).fail(e.reject)}).promise()}function m(e,t){return e.Tags.remove(t),t.entityAspect.setDeleted(),k.saveChanges()}function v(e){k.detachEntity(e)}function g(e){var t=k.getEntities("DraftFileResource");t.forEach(function(t){t.DraftFile()&&t.DraftFile().DraftId()==e.Id()&&k.detachEntity(t)})}function b(e){var t=k.getEntities("PublicationFileResource");t.forEach(function(t){t.PublicationFile()&&t.PublicationFile().PublicationId()==e&&k.detachEntity(t)})}function y(e){var t=(new x).from("DraftFiles").where("Id","==",e.Id()),n=k.executeQueryLocally(t);n&&n.length&&n.forEach(function(e){e.Resources()&&e.Resources().forEach(function(e){k.detachEntity(e)}),k.detachEntity(e)})}function w(t){return e.defer(function(e){function n(t){e.resolve(t)}r.ajax("api/dbfile/metadata",{method:"post",dataType:"json",data:{"":t}}).done(n).fail(e.reject)}).promise()}var k=n.createManager(),x=t.EntityQuery,N=new i;return N.translateColumnName=function(e){return e&&e.length&&/autor/i.test(e)?"Created.By":"FileName"},{getFiles:a,fetchFile:l,localGetFile:u,deleteFile:f,deleteFileVersion:h,searchFiles:o,addFileTag:p,removeFileTag:m,detachEntity:v,detachPublicationFileResources:b,detachDraftFileResources:g,detachDraftFile:y,getFileInfo:w,getThumbnailInfo:c,deleteThumbnail:d,isValidUserQuery:function(e){return N.validate(e)}}});
...
define('modules/contentfile/module',["infrastructure/moduleFactory","infrastructure/moduleRouter","./entities","durandal/app"],function(e,t,n,r){var i=e.createModule({route:"files*details",moduleId:"modules/contentfile/module",title:"Dateien",nav:30,hash:"#files"});return i.extendModel=n.extendModel,i.initializeRouter=function(){i.router=t.createModuleRouter(i,"modules/contentfile","files").map([{route:"",moduleId:"viewmodels/index",title:"Dateien",nav:!1},{route:"detail/:fileId",moduleId:"viewmodels/detail",title:"Details",nav:!1}]).buildNavigationModel()},r.on("caps:started",function(){require(["modules/contentfile/viewmodels/fileSelectionDialog"],function(e){e.install()})}),r.on("caps:contentfile:navigateToFile",function(e){e&&i.router.navigate("#files/detail/"+e.Id())}),i});
define('modules/contentfile/viewmodels/uploadManager',["ko","durandal/system"],function(e){function t(t){var n=this;n.isUploading=e.observable(!1),n.progress=e.observable(0),n.lastSelection=e.observableArray(),n.pendingUploads=[],n.beforeUploadCalled=!1,n.filesSelected=function(e,t){n.lastSelection(t.files),n.pendingUploads=[],n.beforeUploadCalled=!1},n.addFiles=function(r,i){function a(e){n.isUploading(!0),n.pendingUploads.length?n.pendingUploads.forEach(function(t){o(t,e)}):o(i,e)}function o(n,r){var i=0;e.utils.arrayForEach(n.files,function(e){t.uploadStarted&&"function"==typeof t.uploadStarted&&t.uploadStarted(e,i++,r)}),r&&(n.formData=r),n.submit()}t.beforeUpload&&"function"==typeof t.beforeUpload?(n.pendingUploads.push(i),n.beforeUploadCalled||(n.beforeUploadCalled=!0,t.beforeUpload.call(this,n.lastSelection(),i,a))):a()},n.uploadDone=function(r,i){e.utils.arrayForEach(i.result,function(n){var r=e.utils.arrayFirst(i.files,function(e){return e.name===n.fileName});t.uploadDone&&"function"==typeof t.uploadDone&&t.uploadDone(n,r)}),n.isUploading(!1)},n.uploadFailed=function(t,r){e.utils.arrayForEach(r.files,function(e){e.listItem.isUploading(!1)}),n.isUploading(!1)},n.uploadProgress=function(e,t){var r=parseInt(100*(t.loaded/t.total),10);n.progress(r)},n.filesDropped=function(e){return"copy"===e.dataTransfer.dropEffect?!1:void 0}}return t});
define('modules/contentfile/viewmodels/detail',["durandal/system","durandal/app","knockout","../module","../datacontext","moment","infrastructure/utils","infrastructure/tagService","infrastructure/serverUtil","durandal/composition","moment","./uploadManager"],function(e,t,n,r,i,a,o,s,l,c,a,d){function u(){return e.defer(function(e){w(!0),i.fetchFile(v()).then(function(){g(i.localGetFile(v())),e.resolve(g())}).fail(e.fail).done(function(){w(!1)})}).promise()}function f(e){var r=this;r.entity=e,r.isCurrentVersion=n.computed(function(){return b()&&r.entity.Id()===b().entity.Id()}),r.isInUse=n.computed(function(){return r.entity.DraftFileResources().length>0||r.entity.PublicationFileResources().length>0}),r.remove=function(){y.remove(r)},r.select=function(){b(r)},r.navigateToResourceOwner=function(e){t.trigger("caps:contentfile:navigateToResourceOwner",e)}}function h(e){var t=this;t.name=n.computed(function(){return e.name}),t.deleteThumbnail=function(){i.deleteThumbnail(e.fileVersionId,e.id).then(function(){D.remove(t)})}}function p(){return new d({uploadStarted:function(){w(!0)},uploadDone:function(){w(!1),u().then(function(){t.trigger("caps:contentfile:uploadDone",g())})}})}function m(e){D([]),i.getThumbnailInfo(e).then(function(e){D(n.utils.arrayMap(e,function(e){return new h(e)}))})}var v=n.observable(0),g=n.observable(),b=n.observable(),y=n.observableArray(),w=n.observable(!1),k=n.observable(),x=n.observable(!1),N=p(),D=n.observableArray();t.on("caps:sitemapnode:deleted",function(e){var t=e.ContentId();i.detachPublicationFileResources(t)}),t.on("caps:draft:deleted",function(e){i.detachDraftFileResources(e)}),t.on("caps:draft:saved",function(e){e.deletedFiles&&e.deletedFiles.length&&e.deletedFiles.forEach(function(e){i.detachDraftFile(e)})});var C=$(window);r.on("module:compositionComplete",function(e,t){t===S&&C.trigger("forceViewportHeight:refresh")});var S={fileId:v,file:g,fileVersion:b,versions:y,isLoading:w,uploadManager:N,thumbnails:D,uploadedFromNowBy:n.computed(function(){return b()&&b().entity?a(b().entity.Modified().At()).fromNow()+" von "+b().entity.Modified().By():""}),uploadedAt:n.computed(function(){return b()&&b().entity?a(b().entity.Modified().At()).format("LLLL"):""}),activate:function(e){return g(null),v(e),k(null),x(!1),u().then(function(){y(n.utils.arrayMap(g().Versions(),function(e){return new f(e)})),b(y()[0]),m(b().entity.Id())}).fail(function(e){alert(e.message)})},refresh:function(){return u()},navigateBack:function(){r.router.navigate(r.routeConfig.hash)},previewTemplate:function(e){return e&&e.File()&&e.File().isImage()?"file-preview-image":"file-preview-general"},addTagUIVisible:x,tagNames:n.computed(function(){return n.utils.arrayMap(s.tags(),function(e){return e.Name()})}),tagName:k,addTag:function(){x(!0);var e=k();e&&e.length&&s.getOrCreateTag(e).then(function(e){return i.addFileTag(g(),e)}).fail(function(e){window.alert(e.message||e.responseText)}).done(function(){t.trigger("caps:tag:added",k()),k("")})},cancelAddTag:function(){k(null),x(!1)},updateTagName:function(e,t,n){k(n.value)},removeTag:function(e){i.removeFileTag(g(),e).then(function(e){var r=n.utils.arrayFilter(e.entities,function(e){return"Tag"==e.entityType.shortName});n.utils.arrayForEach(r,function(e){t.trigger("caps:tag:deleted",e)})}).fail(function(){alert(err.message||err.responseText)}).done(function(){t.trigger("caps:tag:removed",e)})},deleteVersion:function(e){t.showMessage("Soll die Version wirklich gelöscht werden?","Version löschen?",["Ok","Abbrechen"]).then(function(t){"Ok"===t&&i.deleteFileVersion(e.entity).then(function(){if(e.remove(),e.isCurrentVersion()){var t=g().nextVersion(e)||g().previousVersion(e);b(new f(t))}})})},deleteFile:function(){t.showMessage("Soll die Datei wirklich gelöscht werden?","Datei löschen?",["Ok","Abbrechen"]).then(function(e){"Ok"===e&&i.deleteFile(g()).then(function(){t.trigger("caps:file:deleted",g()),S.navigateBack()})})},moment:a,utils:o,server:l};return S});
...
define('modules/contentfile/viewmodels/index',["ko","durandal/system","durandal/app","../module","../datacontext","infrastructure/virtualListModel","infrastructure/filterModel","infrastructure/listSortModel","jquery","toastr","Q","doubleTap","infrastructure/tagService","./fileListItem","./uploadManager","./fileSearchControl","infrastructure/serverUtil","./fileUploadDialog"],function(e,t,n,i,a,o,s,l,c,d,u,f,h,p,m,v,g,b){function y(e){var n=M;return console.log("loadPage called. pageNumber="+e+", Filter="+n.currentFilter),t.defer(function(t){S(!0),a.searchFiles(n.searchWords(),e,D.itemsPerPage(),n.sortOptions.getOrderBy(),n.currentFilter).then(function(n){D.addPage(n,e),t.resolve()}).fail(t.reject).done(function(){S(!1)})}).promise()}function w(e){function t(){D.selectedItem()===e&&D.resetSelection(),D.removeItem(e)}function r(){n.showMessage("Die Datei konnte nicht gelöscht werden.","Nicht erfolgreich")}return a.deleteFile(e.data()).then(t).fail(r)}function k(){return new m({beforeUpload:function(t,r,i){var o=e.utils.arrayMap(t,function(e){return e.name});a.getFileInfo(o).then(function(t){var r=e.utils.arrayFilter(t,function(e){return e.count>0});if(r.length>0){var a=new b(t);n.showDialog(a).then(function(e){e&&i(e)})}else i()})},uploadStarted:function(e,t,n){var r=n&&"replace"===n.storageAction;r||(e.listItem=D.insertItem(void 0,t),e.listItem.isUploading(!0))},uploadDone:function(e,t){var n=t.listItem||D.findItem(function(t){return t.data()&&t.data().Id()===e.id});a.fetchFile(e.id).then(function(){n&&(n.data(a.localGetFile(e.id)),n.isUploading(!1))}).fail(function(){d.error("Die Datei "+r.FileName+" konnte nicht geladen werden.")})}})}var x,N=!1,D=new o.VirtualList(35,null,p),S=e.observable(!1),C=k(),I=e.observable(!1),F=e.observable(0),M=new v;return i.router.on("router:navigation:attached",function(e){e==x&&I(!0)}),n.on("caps:tags:added",function(e){M.addTagFilter(e)}),n.on("caps:tag:deleted",function(e){M.removeTagFilter(e)}),n.on("caps:file:deleted",function(e){var t=D.findItem(function(t){return t.data().Id()==e.Id()});t&&(D.selectedItem()===t&&D.resetSelection(),D.removeItem(t))}),M.refreshResults=function(){x.refresh()},x={list:D,isLoading:S,uploadManager:C,selectedFile:D.selectedItem,selectedFiles:D.selectedItems,scrollTop:F,isInteractive:I,searchControl:M,server:g,activate:function(){N||(N=!0,y(1))},deactivate:function(){I(!1)},deleteFile:function(e){var t="Datei löschen",r="Abbrechen";n.showMessage("Soll die Datei "+e.data().FileName()+" wirklich gelöscht werden?","Datei löschen",[t,r]).then(function(n){n===t&&w(e)})},deleteSelection:function(){var t=this.selectedFiles();if(0!==t.length){if(1==t.length)return this.deleteFile(t[0]);var r="Auswahl löschen";n.showMessage("Sollen die "+t.length+" ausgewählten Dateien wirklich endgültig gelöscht werden?","Auswahl löschen",[r,"Abbrechen"]).then(function(n){if(n===r){D.suspendEvents=!0;var i=e.utils.arrayMap(t,function(e){return w(e)});u.all(i).then(function(){D.suspendEvents=!1,D.raiseItemsChanged()})}})}},refresh:function(){F(0),D.resetSelection(),D.removeAll(),y(1)},resetSelectedItem:function(){D.resetSelection()},showSelectedFile:function(){this.showDetail(D.selectedItem())},showDetail:function(e){e&&(D.selectItem(e),i.router.navigate("#files/detail/"+e.data().Id()))},loadHandler:function(e,t){function n(e){var n=D.findPage(e);n.isLoaded||n.isLoading||(D.markPageLoading(e),y(e).then(function(){D.markPageLoaded(e),t.pageLoaded(e)}))}if(console.log("loadHandler called. First visible: "+t.firstVisible.index+" (Page #"+t.firstVisible.page+"); Last visible: "+t.lastVisible.index+" (Page #"+t.lastVisible.page+")"),I()){var r=t.firstVisible.viewModel?D.findItemPage(t.firstVisible.viewModel):void 0,i=t.lastVisible.viewModel?D.findItemPage(t.lastVisible.viewModel):void 0;if(r&&i)for(var a=r.index;a<=i.index;a++)n(a+1)}}}});
...
define('modules/draft/datacontext',["durandal/system","entityManagerProvider","ko","infrastructure/userQueryParser","./entities"],function(e,n,r,i,a){function o(){var e=p.from("Drafts");return h.executeQuery(e)}function s(e,t){var n=p.from("Drafts");if(e&&e.length){var r=m.getBreezePredicate(e);r&&(n=n.where(r))}return n=n.orderBy(t||"Created.At desc"),h.executeQuery(n)}function l(e){var t=(new p).from("Drafts").where("Id","==",e).expand("Translations, ContentParts.Resources, Files.Resources.FileVersion.File");return h.executeQuery(t)}function c(n){return e.defer(function(e){var r=(new p).from("DraftTemplates").where("Name","==",n);h.executeQuery(r).then(function(n){n.results&&n.results.length||e.resolve(null);try{t=JSON.parse(n.results[0].TemplateContent()),a.initializeTemplate(t)}catch(r){e.reject(r)}e.resolve(t)}).fail(e.reject)}).promise()}function d(t,n){return n=n||h,e.defer(function(e){u(t,n);var r=new breeze.Predicate("Content.EntityType","==","Draft").and("Content.EntityKey","==",t.toString()),i=(new p).from("SiteMapNodes").where(r).expand("Content, SiteMap, SiteMap.SiteMapNodes, SiteMap.SiteMapNodes.Resources");n.executeQuery(i).then(function(t){e.resolve(t.results)}).fail(e.reject)}).promise()}function u(e,t){t=t||h;var n=new breeze.Predicate("Content.EntityType","==","Draft").and("Content.EntityKey","==",e),r=(new p).from("SiteMapNodes").where(n),i=t.executeQueryLocally(r);i.forEach(function(e){t.detachEntity(e)})}function f(e){var t=(new p).from("DraftFiles").where("Id","==",e.Id()),n=h.executeQueryLocally(t);n&&n.length&&n.forEach(function(e){e.Resources()&&e.Resources().forEach(function(e){h.detachEntity(e)}),h.detachEntity(e)})}var h=n.createManager(),p=breeze.EntityQuery,m=new i;return m.translateColumnName=function(){return"Name"},{getDrafts:o,getDraft:l,getTemplate:c,fetchPublications:d,searchDrafts:s,detachDraftFile:f,isValidUserQuery:function(e){return m.validate(e)}}});
...
define('modules/draft/viewmodels/editor/editorModel',["ko","infrastructure/treeViewModel"],function(e,t){function n(n,r,i,a){function o(e){for(var t=0;t<e.length;t++)e[t].Ranking()!==t+1&&e[t].Ranking(t+1)}var s=new t.TreeNodeViewModel(i,a);return s.entity(n),s.language=r.Language(),s.resource=r,s.nodeType="file",s.fallbackResource=e.computed(function(){return n.getResource("de")}),s.embedSrc=e.computed(function(){return s.resource&&s.resource.FileVersion()?"caps://content-file/"+escape(s.resource.FileVersion().File().FileName()):""}),s.moveUp=function(){var e=s.entity().Draft().orderedFiles().slice(0),t=e.indexOf(s.entity());0>=t||(e.splice(t,1),e.splice(t-1,0,s.entity()),o(e),i.refresh())},s.moveDown=function(){var e=s.entity().Draft().orderedFiles().slice(0),t=e.indexOf(s.entity());t>=e.length-1||(e.splice(t,1),e.splice(t+1,0,s.entity()),o(e),i.refresh())},s.showGroup=e.observable(!1),s.selectGroup=function(){s.showGroup(!0)},s.cancelSelectGroup=function(){s.showGroup(!1)},s.groupNameChanged=function(){i.refresh()},s}function r(t,n){function r(e){for(var t=0;t<e.length;t++)e[t].Ranking()!==t+1&&e[t].Ranking(t+1)}var i=this;i.draftFile=t,i.language=n.Language(),i.resource=n,i.fallbackResource=e.computed(function(){return t.getResource("de")}),i.embedSrc=e.computed(function(){return i.resource&&i.resource.FileVersion()?"caps://content-file/"+escape(i.resource.FileVersion().File().FileName()):""}),i.moveUp=function(){var e=i.draftFile.Draft().orderedFiles().slice(0),t=e.indexOf(i.draftFile);0>=t||(e.splice(t,1),e.splice(t-1,0,i.draftFile),r(e))},i.moveDown=function(){var e=i.draftFile.Draft().orderedFiles().slice(0),t=e.indexOf(i.draftFile);t>=e.length-1||(e.splice(t,1),e.splice(t+1,0,i.draftFile),r(e))},i.showGroup=e.observable(!1),i.selectGroup=function(){i.showGroup(!0)}}function i(t,n){var i=this;i.draft=e.observable(t),i.groupName=e.observable(n),i.groupFilter=e.observable(n),i.isExpanded=e.observable(!0),i.toggleIsExpanded=function(){i.isExpanded(!i.isExpanded())},i.groupName.subscribe(function(e){var t=i.files().slice(0);t.forEach(function(t){t.draftFile.Group(e)}),i.groupFilter(e)}),i.files=e.computed(function(){var t=i.draft(),n=[];return t&&(n=e.utils.arrayMap(t.filesByGroupName(i.groupFilter()),function(e){return new r(e,e.getOrCreateResource("de"))})),n}),i.sortedFiles=e.computed(function(){var e=i.files();return e.sort(function(e,t){if(!(e&&e.draftFile&&t&&t.draftFile))return 0;var n=e.draftFile.Ranking(),r=t.draftFile.Ranking();return n===r?0:r>n?-1:1}),e}),i.groupFilter.subscribe(function(e){var t=i.files().slice(0);t.forEach(function(t){t.draftFile.Group(e)})})}function a(t,n,r){function i(){if(n.entity()){var e=n.entity().template(),r=e.findCell(t.Name());if(r)return r.title}return a.contentPart?a.contentPart.Name():""}var a=this;r=r||i(),a.contentPart=t,a.title=e.observable(r),a.edit=function(){n.showContentPartEditor(t)}}return n.prototype=new t.TreeNodeViewModel,i.prototype.refresh=function(){},{DraftFileViewModel:r,DraftFileGroup:i,DraftFileNode:n,ContentPartViewModel:a}});
define('modules/draft/viewmodels/editor/draftFiles',["durandal/app","../../module","ko","./editorModel","infrastructure/treeViewModel","infrastructure/serverUtil","infrastructure/keyboardHandler"],function(e,t,n,r,i,a,o){function s(s){function c(){var e=s.entity().distinctFileGroupNames();g(n.utils.arrayMap(e,m))}function u(){function e(e){return n.utils.arrayFirst(g(),function(t){return t.name().toLowerCase()===e.toLowerCase()})?!0:!1}var t=s.entity().distinctFileGroupNames(),r=n.utils.arrayFilter(t,function(t){return!e(t)});n.utils.arrayForEach(r,function(e){g.push(m(e))})}function d(){var e=new i.TreeViewModel,t=s.entity();e.keyName("Id"),e.createNode=function(){var t=new i.TreeNodeViewModel(e);return t.templateName=n.observable(),t},e.refresh=function(){var r;v.tree()&&(r=v.tree().saveState()),e.clear(),n.utils.arrayForEach(v.sortedFileGroups(),function(r){var i=f(e,r);e.root.addChildNode(i);var a=t.filesByGroupName(r.name());n.utils.arrayForEach(a,function(t){var n=h(e,t);n&&i.addChildNode(n)})}),r&&v.tree()&&v.tree().restoreState(r)},v.tree(e)}function f(e,t){var r=e.createNode();return r.title=n.observable(t.name()),r.nodeType="group",r.entity(t),r.templateName=n.computed(function(){return r.title().length?"draftfilegroup-label":"draftfilegroup-label-empty"}),r.groupName=n.computed({read:function(){return r.entity().name()},write:function(n){n!==t.name()&&(r.entity().name(n),r.childNodes().forEach(function(e){e.entity().Group(n)}),e.refresh())}}),r}function h(e,t){if(!t)return null;var i=new r.DraftFileNode(t,t.getOrCreateResource("de"),e);return i.title=t.Name(),i.templateName=n.observable("draftfile-label"),i}function p(){if(!v.tree()||!v.tree().selectedNode())return"";var e=v.tree().selectedNode();return"group"===e.nodeType?e.title():e.parentNode().title()}function m(e){var t={name:n.observable(e)};return t.Id=n.computed(function(){return t.name()}),t}var v=this,g=n.observableArray(),b=new o(t);v.name="DraftFiles",v.editor=s,v.server=a,v.determinations=n.observableArray(l),v.tree=n.observable(),v.deactivate=function(){b.deactivate()},s.currentContent.subscribe(function(e){e===v?b.activate():b.deactivate()}),v.editor.entity().Files.subscribe(function(){u(),v.tree().refresh()}),v.groupNames=n.computed(function(){return n.utils.arrayMap(g(),function(e){return e.name()})}),v.sortedFileGroups=n.computed(function(){var e=g();return e.sort(function(e,t){return e.name().toLowerCase().localeCompare(t.name().toLowerCase())}),e}),v.selectFiles=function(){e.selectFiles({module:t,title:"Anhänge hinzufügen"}).then(function(e){if(e.dialogResult){var t=p();n.utils.arrayForEach(e.selectedFiles,function(e){s.createDraftFile(e,t)})}})},v.addGroup=function(){function e(e){var t=n.utils.arrayFilter(v.groupNames(),function(t){var n=new RegExp("^("+e+")(\\s+\\(\\d+\\))?.*$","gi");return n.test(t)});return t.length?e+" ("+t.length+")":e}var t=e("Neue Gruppe");g.push(m(t)),v.tree().refresh();var r=v.tree().findNodeByKey(t);r&&r.selectNode()},v.moveSelectedNodeUp=function(){var e=v.tree().selectedNode();e.moveUp&&e.moveUp()},v.moveSelectedNodeDown=function(){var e=v.tree().selectedNode();e.moveDown&&e.moveDown()},v.removeFile=function(t){var n="Entfernen",r="Abbrechen";e.showMessage("Soll der Anhang "+t.entity().Name()+" wirklich entfernt werden?","Anhang entfernen",[n,r]).then(function(e){e===n&&(t.detachFromParentNode(),t.entity().setDeleted())})},v.contentTemplateName=function(){if(!v.tree()||!v.tree().selectedNode())return"";var e=v.tree().selectedNode();return"group"==e.nodeType?"draftfiles-group-template":"draftfiles-file-template"},v.navigateToFile=function(){if(v.tree()&&v.tree().selectedNode()&&"file"===v.tree().selectedNode().nodeType){var t=v.tree().selectedNode(),n=t.resource.FileVersion().File();e.trigger("caps:contentfile:navigateToFile",n)}},c(),d(),v.tree()&&(v.tree().refresh(),v.tree().expandRootNodes(),v.tree().selectRootNode()),b.keydown=function(e){var t=document.activeElement;v.tree()&&(!t||"INPUT"!=t.tagName&&"TEXTAREA"!=t.tagName)&&v.tree().handleKeyDown(e)}}var l=[{name:"Picture",title:"Bild"},{name:"Download",title:"Download"},{name:"Misc",title:"Sonstiges"}];return s});
...
define('modules/draft/viewmodels/editor/editor',["durandal/app","durandal/system","../../module","../../datacontext","../../entities","entityManagerProvider","breeze","ko","Q","./navigation","./draftTemplate","./draftProperties","./draftFiles","./contentPartEditor","./templateEditor","./draftNotes","./editorModel","authentication"],function(e,t,n,r,i,a,o,s,l,c,u,d,f,h,p,m,v,g){function b(){function l(){y.trigger("forceViewportHeight:refresh")}function v(e){var t=e.Id(),n=s.utils.arrayFilter(E.entity().Files(),function(e){var n=s.utils.arrayFirst(e.Resources(),function(e){return e.FileVersion()&&e.FileVersion().FileId()===t});return null!=n});if(n.length){var r=o.EntityQuery.from("Files").where("Id","==",t).expand("Versions.File");return P.executeQuery(r)}}function b(e,t,n){n=n||"de",r.getTemplate(e).then(function(r){var i=r,a=P.createEntity("Draft",{TemplateName:e,Version:1,OriginalLanguage:n,Status:"NEW"});a.Template(JSON.stringify(i)),a.Created().At(new Date),a.Created().By(g.user().userName()),a.Modified().At(new Date),a.Modified().By(g.user().userName()),t&&t.name&&a.Name(t.name),E.entity(a),i.forEachCell(function(e,n,r){var i=E.getOrCreateContentPart(n);if(i.Ranking(r),n.content){var a=/<%\s*([A-Za-z0-9_\.]+)\s*%>/gi,o=n.content.replace(a,function(e,n){return t&&t[n]?t[n]:w(n)||"Nicht gefunden"});i.getResource("de").Content(o)}})})}function w(e){if(!E.entity()||!E.entity().template())return null;var t=E.entity().template();if(!t.parameters)return null;var n=s.utils.arrayFirst(t.parameters,function(t){return t.name.toLowerCase()===e.toLowerCase()});return n?n.value:null}function k(e){var t=o.EntityQuery.from("Drafts").where("Id","==",e).expand("ContentParts.Resources, Files.Resources.FileVersion.File");return P.executeQuery(t).then(function(e){E.entity(e.results[0])})}function x(){E.entity().setDeleted(),P.saveChanges().then(function(){e.trigger("caps:draft:deleted",E.entity()),E.navigateBack()})}function C(){D=D||new c(E);var e=L.activeInstruction().queryParams;if(e&&e.t)if("DraftProperties"===e.t)E.showProperties();else if("DraftFiles"===e.t)E.showFiles();else{var t=E.entity().findContentPart(e.t);t&&E.showContentPartEditor(t)}E.currentContent()||(F=F||new u(E),E.currentContent(F)),E.currentNavigation(D)}function N(e){var t=s.utils.arrayFirst(_,function(t){return t.contentPart===e});return t||(t=new h(E,e),_.push(t)),t}var D,F,S,I,M,T,E=this,P=a.createManager(),_=[],L=n.router,R=s.observable();E.currentContent=s.observable(),E.currentNavigation=s.observable(),E.entity=s.observable(),E.template=s.computed(function(){return E.entity()?E.entity().template():void 0}),E.isNewDraft=s.observable(!1),E.draftStates=i.supportedDraftStates,E.lastContentPart=s.observable(),P.hasChangesChanged.subscribe(function(e){n.routeConfig.hasUnsavedChanges(e.hasChanges)}),P.validationErrorsChanged.subscribe(function(e){var t=e.entity;R(t.hasValidationErrors.call(t))}),E.activate=function(r,i){return n.on("module:compositionComplete",l),e.on("caps:contentfile:uploadDone",v),t.defer(function(e){r&&/^[0-9]+$/.test(r)?k(r).then(function(){C(),e.resolve()}):(E.isNewDraft(!0),b(r,i),C(),e.resolve())}).promise()},E.canDeactivate=function(){return P.hasChanges()?t.defer(function(t){var n="Speichern",r="Verwerfen",i="Abbrechen";e.showMessage("Sollen die Änderungen gespeichert werden?","Änderungen speichern?",[n,r,i]).then(function(e){if(e===i)t.resolve(!1);else if(e===n){var r=E.saveChanges();r&&r.then?r.then(function(){t.resolve(!0)}):t.resolve(!1)}else t.resolve(!0)})}).promise():!0},E.deactivate=function(){n.routeConfig.hasUnsavedChanges(!1),n.off("module:compositionComplete",l),e.off("caps:contentfile:uploadDone",v),S&&S.deactivate()},E.shouldActivate=function(e,t,n){return t[0]!==n[0]},E.showEditorMain=function(){F=F||new u(E),E.currentContent(F),E.lastContentPart(null)},E.showLayoutArea=function(){E.lastContentPart()?E.showContentPartEditor(E.lastContentPart()):E.showEditorMain()},E.showFiles=function(){S=S||new f(E),E.currentContent(S)},E.showProperties=function(){I=I||new d(E),E.currentContent(I)},E.showContentPartEditor=function(e){var t=N(e);t&&(t.showPreview(!1),E.currentContent(t),E.lastContentPart(e))},E.showTemplateEditor=function(){M=M||new p(E),E.currentContent(M)},E.showDraftNotes=function(){T=T||new m(E),E.currentContent(T)},E.navigateBack=function(){E.showDraftsIndex()},E.showDraftsIndex=function(){n.router.navigate(n.routeConfig.hash)},E.saveChangesAndNavigateBack=function(){E.saveChanges().then(E.navigateBack)},E.saveChanges=function(){if(R())return e.showMessage("Der Inhalt kann noch nicht gespeichert werden. Prüfe die markierten Felder und ergänze oder korrigiere die Eingaben.","Noch nicht komplett",["Ok"]),!1;E.entity().Modified().At(new Date),E.entity().Modified().By(g.user().userName());var t=P.getEntities("DraftFile",o.EntityState.Deleted);return P.saveChanges().then(function(){e.trigger("caps:draft:saved",{entity:E.entity(),isNewDraft:E.isNewDraft(),deletedFiles:t}),n.routeConfig.hasUnsavedChanges(!1)})},E.deleteDraft=function(){var t="Entwurf löschen",n="Abbrechen";e.showMessage("Soll der Entwurf wirklich gelöscht werden?","Entwurf löschen",[t,n]).then(function(e){if(e===t){if(E.isNewDraft())return P.rejectChanges(),E.navigateBack(),void 0;x()}})},E.getOrCreateContentPart=function(e){var t=E.entity().findContentPart(e.name);if(!t){t=P.createEntity("DraftContentPart",{DraftId:E.entity().Id(),Name:e.name,ContentType:e.contentType||"markdown"}),P.addEntity(t);var n=P.createEntity("DraftContentPartResource",{DraftContentPartId:E.entity().Id(),Language:"de",Content:""});P.addEntity(n),t.Resources.push(n),E.entity().ContentParts.push(t)}return t},E.createDraftFile=function(e,t){var n=o.EntityQuery.from("Files").where("Id","==",e.Id()).expand("Versions.File");return P.executeQuery(n).then(function(n){var r=n.results[0],i=P.createEntity("DraftFile",{Name:e.FileName()});e.isImage()&&i.Determination("Picture"),t&&t.length&&i.Group(t),P.addEntity(i);var a=P.createEntity("DraftFileResource",{Language:"de",DbFileVersionId:r.latestVersion().Id()});return P.addEntity(a),i.Resources.push(a),i.DraftId(E.entity().Id()),E.entity().Files.push(i),i})}}var y=$(window);return b});
define('modules/draft/viewmodels/index',["../module","../datacontext","ko","durandal/app","moment","localization","infrastructure/publicationService","../contentGenerator","infrastructure/listSortModel","../commands/deleteDraft","./draftSearchControl","infrastructure/interaction","infrastructure/keyCode","durandal/composition","infrastructure/keyboardHandler","infrastructure/scrollState"],function(e,t,n,r,i,a,o,s,l,c,u,d,f,p,h,m){function v(e){if(e&&D()){var t=e.Content();t&&t.EntityKey()==D().draftId()&&y(D().draftId(),F())}}function g(){var e=T;return I(!0),t.searchDrafts(e.searchWords(),e.sortOptions.getOrderBy()).then(function(e){var t=n.utils.arrayMap(e.results,function(e){return new x(e)});N(t),I(!1)})}function b(e){return t.getDraft(e).then(function(t){var n=t.results[0],r=s.createTemplateContent(t.results[0],"de"),i=new k(n,r);F(i),y(e,F())})}function y(e,r){t.fetchPublications(e).then(function(e){r.publications(n.utils.arrayMap(e,function(e){return new C(r.entity(),e)}))}).fail(function(e){alert(e.message)})}function w(){N().length&&L.selectDraft(N()[0])}function k(t,r){var o=this,s=new a.Language(t.OriginalLanguage());o.entity=n.observable(t),o.template=n.observable(r),o.originalLanguage=s,o.supportedTranslations=a.website.supportedTranslations(s.culture),o.publications=n.observableArray(),o.createdAt=n.computed(function(){return i(t.Created().At()).format("LLLL")}),o.createdFromNow=n.computed(function(){return i(t.Created().At()).fromNow()}),o.modifiedAt=n.computed(function(){return i(t.Modified().At()).format("LLLL")}),o.modifiedFromNow=n.computed(function(){return i(t.Modified().At()).fromNow()}),o.translateDraft=function(n){e.router.navigate("#drafts/translate/"+t.Id()+"/"+n.culture)}}function x(e){var t=this;t.draftId=n.computed(function(){return e.Id()}),t.createdAt=n.computed(function(){return t.formatDate(e.Created().At())}),t.modifiedAt=n.computed(function(){return t.formatDate(e.Modified().At())}),t.title=n.computed(function(){return e.Name()}),t.isSelected=n.computed(function(){return D()&&D().draftId()===t.draftId()}),t.status=n.computed(function(){return e.statusTitle()}),t.scrollIntoViewRequest=new d.InteractionRequest("ScrollIntoView")}function C(e,t){var r=this;r.draft=n.observable(e),r.sitemapNode=n.observable(t),r.title=n.computed(function(){return r.sitemapNode().path()}),r.contentVersion=n.computed(function(){return r.sitemapNode().Content()?"v."+r.sitemapNode().Content().ContentVersion():""}),r.createdAt=n.computed(function(){return i.utc(r.sitemapNode().Created().At()).fromNow()}),r.createdBy=n.computed(function(){return r.sitemapNode().Created().By()}),r.modifiedAt=n.computed(function(){return r.sitemapNode().Content()?i.utc(r.sitemapNode().Content().ContentDate()).fromNow():""}),r.modifiedBy=n.computed(function(){return r.sitemapNode().Content()?r.sitemapNode().Content().AuthorName():""}),r.isOutdated=n.computed(function(){return r.sitemapNode().Content()?r.sitemapNode().Content().ContentVersion()<r.draft().Version():!1}),r.republish=function(){var e=s.createPublicationContent(this.draft());o.republish(this.sitemapNode().Id(),e)}}var N=n.observableArray(),D=n.observable(),F=n.observable(),S=!1,I=n.observable(!1),M=new c,T=new u,E=new h(e),P=new m(e);T.refreshResults=function(){L.refresh()},r.on("caps:draft:saved",function(e){e.deletedFiles&&e.deletedFiles.length&&e.deletedFiles.forEach(function(e){t.detachDraftFile(e)});var n=e.entity;D()&&D().draftId()===n.Id()&&b(D().draftId()),e.isNewDraft?g().then(function(){L.selectDraftById(n.Id())}):L.selectDraftById(n.Id())}),r.on("caps:draft:deleted",function(){g().then(w)}),r.on("caps:publication:created",v),r.on("caps:publication:refreshed",v);var _=$(window);e.on("module:compositionComplete",function(e,t){t===L&&(_.trigger("forceViewportHeight:refresh"),P.activate())});var L={items:N,selectedItem:D,draftPreview:F,isLoading:I,searchControl:T,draftListScrollState:P,activate:function(){S||(S=!0,g().then(function(){w()})),E.activate()},deactivate:function(){E.deactivate(),P.deactivate()},addDraft:function(){e.router.navigate("#drafts/create")},editDraft:function(t){e.router.navigate("#drafts/edit/"+t.draftId())},editSelectedDraft:function(){L.editDraft(D())},selectDraft:function(e){D(e),e&&e.scrollIntoView(),F(null),b(e.draftId())},selectDraftById:function(e){var t=n.utils.arrayFirst(N(),function(t){return t.draftId()===e});t&&L.selectDraft(t)},selectNextDraft:function(){if(D()){var e=N().indexOf(D());e<N().length-1&&L.selectDraft(N()[e+1])}else L.selectDraft(N()[0])},selectPreviousDraft:function(){if(D()){var e=N().indexOf(D());e>0&&L.selectDraft(N()[e-1])}else L.selectDraft(N()[N().length-1])},publishDraft:function(){try{var t=s.createPublicationContent(F().entity());P.deactivate(),r.selectSiteMapNode({module:e,okTitle:"Veröffentlichen"}).then(function(e){e.dialogResult&&o.publish(t,e.selectedNode).fail(function(e){alert(e.message)}),P.activate()})}catch(n){alert(n.message)}},refresh:function(){g()},deleteDraft:function(){M.execute(D().draftId())}};return E.keydown=function(e){var t=e.keyCode;(t===f.keys.UP||t===f.keys.DOWN)&&(e.preventDefault(),t===f.keys.UP&&L.selectPreviousDraft(),t===f.keys.DOWN&&L.selectNextDraft())},x.prototype.scrollIntoView=function(){this.scrollIntoViewRequest.trigger()},x.prototype.formatDate=function(e){return i(e).calendar()},L});
define('modules/draft/viewmodels/templateGallery',["ko","../datacontext","../module","breeze","entityManagerProvider","durandal/system","infrastructure/serverUtil"],function(e,t,n,r,i,a,o){function s(t,n,r,i){var a=this;a.title=t,a.name=n,a.template=r,a.icon=i,a.isSelected=e.computed(function(){return f()===a})}function l(){return a.defer(function(t){c().then(function(n){var r=e.utils.arrayMap(n,function(e){var t=u(e.TemplateContent());return new s(e.Name(),e.Name(),t,o.mapPath("~/App/modules/draft/images/Template 3.png"))}),i=r;d(i),t.resolve()}).fail(t.reject)})}function c(){var e=(new p).from("Websites").expand("DraftTemplates");return h.executeQuery(e).then(function(e){return e.results[0].DraftTemplates()})}function u(e){var t;try{t=JSON.parse(e)}catch(n){a.log(n.message)}return t}var d=e.observableArray(),f=e.observable(),p=r.EntityQuery,h=i.createManager(),m=e.observable();return{activate:function(){m(""),f(null),l()},listItems:d,selectedItem:f,draftName:m,selectTemplate:function(e){f(e)},createDraft:function(){if(f()){var e="#drafts/create/"+f().name,t=[];m()&&t.push("name="+escape(m()));var r=f().template;r.parameters&&r.parameters.forEach(function(e){e.value&&t.push(e.name+"="+escape(e.value))}),t.length&&(e+="?"+t.join("&")),n.router.navigate(e)}},cancel:function(){n.router.navigate("#drafts")}}});
...
define('viewmodels/profile',["durandal/app","authentication","plugins/router","plugins/dialog","./changePasswordDialog","moment","knockout","toastr","infrastructure/screen","Q","./setPasswordDialog"],function(e,t,n,r,i,a,o,s,l,u,c){function d(t){var n=this;n.name=o.observable(t.name),n.login=function(){sessionStorage.state=t.state,sessionStorage.associatingExternalLogin=!0,e.archiveSessionStorageToLocalStorage(),window.location=t.url}}function f(e,n){var r=this,i=o.observable(e.providerKey);r.loginProvider=o.observable(e.loginProvider),r.removing=o.observable(!1),r.canRemove=o.computed(function(){return n.logins().length>1}),r.remove=function(){r.removing(!0),t.removeLogin(r.loginProvider(),i()).then(function(){n.logins.remove(r)})}}var h=t.user,p=o.observableArray(),m=o.observableArray(),v=o.observable(),g={user:h,logins:p,externalLoginProviders:m,activate:function(){return p([]),m([]),t.getAccountManagementInfo(escape("/"),!0).then(function(e){v(e.localLoginProvider),o.utils.arrayForEach(e.logins,function(e){p.push(new f(e,g))}),o.utils.arrayForEach(e.loginProviders,function(e){m.push(new d(e))})})},lastPasswordChangedDateFormatted:o.computed(function(){return h().hasEverChangedPassword()?a.utc(h().lastPasswordChangedDate()).fromNow():"Noch nie"}),changePassword:function(){function e(e){return e?t.changePassword(e).then(function(){s.success("Das Passwort wurde erfolgreich geändert.","Passwort geändert",{positionClass:l.isPhone()?"toast-bottom-full-width":"toast-bottom-right"})}).fail(function(){r.showMessage("Das Passwort konnte nicht geändert werden. Versuche es in einigen Minuten nochmal. Melde das Problem, wenn es weiterhin auftritt","Nicht erfolgreich")}):void 0}i.show().then(e)},addLocalPassword:function(){function e(e){return e?t.setPassword(e).then(function(){p.push(new f({loginProvider:v(),providerKey:h().userName()},g))}):void 0}c.show().then(e)},logOff:function(){t.isAuthenticated()===!0&&t.logoff().then(n.navigate("login",{trigger:!0,replace:!0}))},hasLocalPassword:o.computed(function(){var e=o.utils.arrayFirst(p(),function(e){return e.loginProvider()===v()});return!!e}),moment:a};return g});
