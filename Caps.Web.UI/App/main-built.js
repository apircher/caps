...
define('modules/contentfile/viewmodels/detail',["durandal/system","durandal/app","knockout","../module","../datacontext","moment","infrastructure/utils","infrastructure/tagService","infrastructure/serverUtil","durandal/composition","moment","./uploadManager"],function(e,t,n,r,i,a,o,s,l,d,a,c){function u(){return e.defer(function(e){y(!0),i.fetchFile(m()).then(function(){v(i.localGetFile(m())),e.resolve(v())}).fail(e.fail).done(function(){y(!1)})}).promise()}function f(e){var r=this;r.entity=e,r.isCurrentVersion=n.computed(function(){return g()&&r.entity.Id()===g().entity.Id()}),r.isInUse=n.computed(function(){return r.entity.DraftFileResources().length>0||r.entity.PublicationFileResources().length>0}),r.remove=function(){b.remove(r)},r.select=function(){g(r)},r.navigateToResourceOwner=function(e){t.trigger("caps:contentfile:navigateToResourceOwner",e)}}function h(){return new c({uploadStarted:function(){y(!0)},uploadDone:function(){y(!1),u()}})}function p(){d.current.complete(function(){C.trigger("forceViewportHeight:refresh")})}var m=n.observable(0),v=n.observable(),g=n.observable(),b=n.observableArray(),y=n.observable(!1),w=n.observable(),k=n.observable(!1),x=h(),N=!1;r.on("module:activate",function(){N&&p()}),t.on("caps:sitemapnode:deleted",function(e){var t=e.ContentId();i.detachPublicationFileResources(t)}),t.on("caps:draft:deleted",function(e){i.detachDraftFileResources(e)}),t.on("caps:draft:saved",function(e){e.deletedFiles&&e.deletedFiles.length&&e.deletedFiles.forEach(function(e){i.detachDraftFile(e)})});var D={fileId:m,file:v,fileVersion:g,versions:b,isLoading:y,uploadManager:x,uploadedFromNowBy:n.computed(function(){return g()&&g().entity?a(g().entity.Modified().At()).fromNow()+" von "+g().entity.Modified().By():""}),uploadedAt:n.computed(function(){return g()&&g().entity?a(g().entity.Modified().At()).format("LLLL"):""}),activate:function(e){return v(null),m(e),w(null),k(!1),p(),N=!0,u().then(function(){b(n.utils.arrayMap(v().Versions(),function(e){return new f(e)})),g(b()[0])}).fail(function(e){alert(e.message)})},deactivate:function(){N=!1},refresh:function(){return u()},navigateBack:function(){r.router.navigate(r.routeConfig.hash)},previewTemplate:function(e){return e&&e.File()&&e.File().isImage()?"file-preview-image":"file-preview-general"},addTagUIVisible:k,tagNames:n.computed(function(){return n.utils.arrayMap(s.tags(),function(e){return e.Name()})}),tagName:w,addTag:function(){k(!0);var e=w();e&&e.length&&s.getOrCreateTag(e).then(function(e){return i.addFileTag(v(),e)}).fail(function(e){window.alert(e.message||e.responseText)}).done(function(){t.trigger("caps:tag:added",w()),w("")})},cancelAddTag:function(){w(null),k(!1)},updateTagName:function(e,t,n){w(n.value)},removeTag:function(e){i.removeFileTag(v(),e).then(function(e){var r=n.utils.arrayFilter(e.entities,function(e){return"Tag"==e.entityType.shortName});n.utils.arrayForEach(r,function(e){t.trigger("caps:tag:deleted",e)})}).fail(function(){alert(err.message||err.responseText)}).done(function(){t.trigger("caps:tag:removed",e)})},deleteVersion:function(e){t.showMessage("Soll die Version wirklich gelöscht werden?","Version löschen?",["Ok","Abbrechen"]).then(function(t){"Ok"===t&&i.deleteFileVersion(e.entity).then(function(){if(e.remove(),e.isCurrentVersion()){var t=v().nextVersion(e)||v().previousVersion(e);g(new f(t))}})})},deleteFile:function(){t.showMessage("Soll die Datei wirklich gelöscht werden?","Datei löschen?",["Ok","Abbrechen"]).then(function(e){"Ok"===e&&i.deleteFile(v()).then(function(){t.trigger("caps:file:deleted",v()),D.navigateBack()})})},moment:a,utils:o,server:l},C=$(window);return D});
...
define('modules/draft/viewmodels/editor/navigation',["require","ko","./editorModel"],function(e,t,n){function r(e){var r=this;this.title="Navigation",this.editor=e,this.currentView=t.computed(function(){return r.editor.currentContent()?r.editor.currentContent().name:void 0}),this.contentParts=t.computed(function(){function e(e,t){return e.Ranking()===t.Ranking()||e.Ranking()<t.Ranking()?-1:1}if(r.editor.entity()){var i=r.editor.entity().ContentParts();return i.sort(e),t.utils.arrayMap(i,function(e){return new n.ContentPartViewModel(e,r.editor)})}return[]}),this.title=t.computed(function(){var t="Unbenannt",n=e.entity();return n&&n.Name&&(n.Name().length?t=n.Name():"Added"===n.entityAspect.entityState.name&&(t="Neuer Entwurf")),t}),this.numberOfFiles=t.computed(function(){return r.editor.entity()?r.editor.entity().Files().length:0})}return r});
...
define('modules/draft/viewmodels/editor/editor',["durandal/app","durandal/system","../../module","../../datacontext","../../entities","entityManagerProvider","breeze","ko","Q","./navigation","./draftTemplate","./draftProperties","./draftFiles","./contentPartEditor","./templateEditor","./draftNotes","./editorModel","authentication"],function(e,t,n,r,i,a,o,s,l,u,c,d,f,h,p,m,v,g){function b(){function l(e,t,n){n=n||"de",r.getTemplate(e).then(function(r){var i=r,a=P.createEntity("Draft",{TemplateName:e,Version:1,OriginalLanguage:n,Status:"NEW"});a.Template(JSON.stringify(i)),a.Created().At(new Date),a.Created().By(g.user().userName()),a.Modified().At(new Date),a.Modified().By(g.user().userName()),t&&t.name&&a.Name(t.name),E.entity(a);for(var o=0;o<i.rows.length;o++)for(var s=i.rows[o],l=0;l<s.cells.length;l++){var u=s.cells[l],c=E.getOrCreateContentPart(u);if(u.content){var d=/<%\s*([A-Za-z0-9_\.]+)\s*%>/gi,f=u.content.replace(d,function(e,n){return t&&t[n]?t[n]:v(n)||"Nicht gefunden"});c.getResource("de").Content(f)}}})}function v(e){if(!E.entity()||!E.entity().template())return null;var t=E.entity().template();if(!t.parameters)return null;var n=s.utils.arrayFirst(t.parameters,function(t){return t.name.toLowerCase()===e.toLowerCase()});return n?n.value:null}function b(e){var t=o.EntityQuery.from("Drafts").where("Id","==",e).expand("ContentParts.Resources, Files.Resources.FileVersion.File");return P.executeQuery(t).then(function(e){E.entity(e.results[0])})}function y(){E.entity().setDeleted(),P.saveChanges().then(function(){e.trigger("caps:draft:deleted",E.entity()),E.navigateBack()})}function w(){D=D||new u(E);var e=R.activeInstruction().queryParams;if(e&&e.t)if("DraftProperties"===e.t)E.showProperties();else if("DraftFiles"===e.t)E.showFiles();else{var t=E.entity().findContentPart(e.t);t&&E.showContentPartEditor(t)}E.currentContent()||(F=F||new c(E),E.currentContent(F)),E.currentNavigation(D)}function k(){var e=E.entity();e&&(x(),e.entityAspect.propertyChanged.subscribe(N))}function x(){var e=E.entity();e&&E.template(e.deserializeTemplate())}function N(){n.routeConfig.hasUnsavedChanges(P.hasChanges())}function C(e){var t=s.utils.arrayFirst(_,function(t){return t.contentPart===e});return t||(t=new h(E,e),_.push(t)),t}var D,F,I,M,S,T,E=this,P=a.createManager(),_=[],R=n.router;E.currentContent=s.observable(),E.currentNavigation=s.observable(),E.entity=s.observable(),E.entity.subscribe(k),E.template=s.observable(),E.isNewDraft=s.observable(!1),E.draftStates=i.supportedDraftStates,E.lastContentPart=s.observable(),E.activate=function(e,n){return t.defer(function(t){e&&/^[0-9]+$/.test(e)?b(e).then(function(){w(),t.resolve()}):(E.isNewDraft(!0),l(e,n),w(),t.resolve())}).promise()},E.shouldActivate=function(e,t,n){return t[0]!==n[0]},E.showEditorMain=function(){F=F||new c(E),E.currentContent(F),E.lastContentPart(null)},E.showLayoutArea=function(){E.lastContentPart()?E.showContentPartEditor(E.lastContentPart()):E.showEditorMain()},E.showFiles=function(){I=I||new f(E),E.currentContent(I)},E.showProperties=function(){M=M||new d(E),E.currentContent(M)},E.showContentPartEditor=function(e){var t=C(e);t&&(E.currentContent(t),E.lastContentPart(e))},E.showTemplateEditor=function(){S=S||new p(E),E.currentContent(S)},E.showDraftNotes=function(){T=T||new m(E),E.currentContent(T)},E.navigateBack=function(){E.showDraftsIndex()},E.showDraftsIndex=function(){n.routeConfig.hasUnsavedChanges(!1),n.router.navigate(n.routeConfig.hash)},E.saveChanges=function(){E.entity().Modified().At(new Date),E.entity().Modified().By(g.user().userName());var t=P.getEntities("DraftFile",o.EntityState.Deleted);P.saveChanges().then(function(){e.trigger("caps:draft:saved",{entity:E.entity(),isNewDraft:E.isNewDraft(),deletedFiles:t}),E.showDraftsIndex()})},E.deleteDraft=function(){var t="Entwurf löschen",n="Abbrechen";e.showMessage("Soll der Entwurf wirklich gelöscht werden?","Entwurf löschen",[t,n]).then(function(e){e===t&&y()})},E.getOrCreateContentPart=function(e){var t=E.entity().findContentPart(e.name);if(!t){t=P.createEntity("DraftContentPart",{DraftId:E.entity().Id(),Name:e.name,ContentType:e.contentType||"markdown"}),P.addEntity(t);var n=P.createEntity("DraftContentPartResource",{DraftContentPartId:E.entity().Id(),Language:"de",Content:""});P.addEntity(n),t.Resources.push(n),E.entity().ContentParts.push(t)}return t},E.createDraftFile=function(e,t){var n=o.EntityQuery.from("Files").where("Id","==",e.Id()).expand("Versions.File");return P.executeQuery(n).then(function(n){var r=n.results[0],i=P.createEntity("DraftFile",{Name:e.FileName()});e.isImage()&&i.Determination("Picture"),t&&t.length&&i.Group(t),P.addEntity(i);var a=P.createEntity("DraftFileResource",{Language:"de",DbFileVersionId:r.latestVersion().Id()});return P.addEntity(a),i.Resources.push(a),i.DraftId(E.entity().Id()),E.entity().Files.push(i),i})}}return b});
define('modules/draft/viewmodels/index',["../module","../datacontext","ko","durandal/app","moment","localization","infrastructure/publicationService","../contentGenerator","infrastructure/listSortModel","../commands/deleteDraft","./draftSearchControl","infrastructure/interaction","infrastructure/keyCode","durandal/composition"],function(e,t,n,r,i,a,o,s,l,u,c,d,f,p){function h(e){if(e&&F()){var t=e.Content();t&&t.EntityKey()==F().draftId()&&g(F().draftId(),I())}}function m(){var e=E;return S(!0),t.searchDrafts(e.searchWords(),e.sortOptions.getOrderBy()).then(function(e){var t=n.utils.arrayMap(e.results,function(e){return new N(e)});C(t),S(!1)})}function v(e){return t.getDraft(e).then(function(t){var n=t.results[0],r=s.createTemplateContent(t.results[0],"de"),i=new x(n,r);I(i),g(e,i)})}function g(e,r){t.fetchPublications(e).then(function(e){r.publications(n.utils.arrayMap(e,function(e){return new D(r.entity(),e)}))}).fail(function(e){alert(e.message)})}function b(){C().length&&_.selectDraft(C()[0])}function y(){$(window).on("keydown",_.handleKeyDown)}function w(){$(window).off("keydown",_.handleKeyDown)}function k(){p.current.complete(function(){R.trigger("forceViewportHeight:refresh")})}function x(t,r){var o=this,s=new a.Language(t.OriginalLanguage());o.entity=n.observable(t),o.template=n.observable(r),o.originalLanguage=s,o.supportedTranslations=a.website.supportedTranslations(s.culture),o.publications=n.observableArray(),o.createdAt=n.computed(function(){return i(t.Created().At()).format("LLLL")}),o.createdFromNow=n.computed(function(){return i(t.Created().At()).fromNow()}),o.modifiedAt=n.computed(function(){return i(t.Modified().At()).format("LLLL")}),o.modifiedFromNow=n.computed(function(){return i(t.Modified().At()).fromNow()}),o.translateDraft=function(n){e.router.navigate("#drafts/translate/"+t.Id()+"/"+n.culture)}}function N(e){var t=this;t.draftId=n.computed(function(){return e.Id()}),t.createdAt=n.computed(function(){return t.formatDate(e.Created().At())}),t.modifiedAt=n.computed(function(){return t.formatDate(e.Modified().At())}),t.title=n.computed(function(){return e.Name()}),t.isSelected=n.computed(function(){return F()&&F().draftId()===t.draftId()}),t.status=n.computed(function(){return e.statusTitle()}),t.scrollIntoViewRequest=new d.InteractionRequest("ScrollIntoView")}function D(e,t){var r=this;r.draft=n.observable(e),r.sitemapNode=n.observable(t),r.title=n.computed(function(){return r.sitemapNode().path()}),r.contentVersion=n.computed(function(){return r.sitemapNode().Content()?"v."+r.sitemapNode().Content().ContentVersion():""}),r.createdAt=n.computed(function(){return i.utc(r.sitemapNode().Created().At()).fromNow()}),r.createdBy=n.computed(function(){return r.sitemapNode().Created().By()}),r.isOutdated=n.computed(function(){return r.sitemapNode().Content()?r.sitemapNode().Content().ContentVersion()<r.draft().Version():!1}),r.republish=function(){var e=s.createPublicationContent(this.draft());o.republish(this.sitemapNode().Id(),e)}}var C=n.observableArray(),F=n.observable(),I=n.observable(),M=!1,S=n.observable(!1),T=new u,E=new c,P=!1;E.refreshResults=function(){_.refresh()},r.on("caps:draft:saved",function(e){var t=e.entity;F()&&F().draftId()===t.Id()&&v(F().draftId()),e.isNewDraft&&m().then(function(){_.selectDraftById(t.Id())})}),r.on("caps:draft:deleted",function(){m().then(b)}),r.on("caps:publication:created",h),r.on("caps:publication:refreshed",h),e.on("module:activate",function(){P&&(y(),k())}),e.on("module:deactivate",function(){P&&w()});var _={items:C,selectedItem:F,draftPreview:I,isLoading:S,searchControl:E,activate:function(){M||(M=!0,m().then(b)),y(),k(),P=!0},deactivate:function(){P=!1,w()},addDraft:function(){e.router.navigate("#drafts/create")},editDraft:function(t){e.router.navigate("#drafts/edit/"+t.draftId())},editSelectedDraft:function(){_.editDraft(F())},selectDraft:function(e){F(e),e&&e.scrollIntoView(),I(null),v(e.draftId())},selectDraftById:function(e){var t=n.utils.arrayFirst(C(),function(t){return t.draftId()===e});t&&_.selectDraft(t)},selectNextDraft:function(){if(F()){var e=C().indexOf(F());e<C().length-1&&_.selectDraft(C()[e+1])}else _.selectDraft(C()[0])},selectPreviousDraft:function(){if(F()){var e=C().indexOf(F());e>0&&_.selectDraft(C()[e-1])}else _.selectDraft(C()[C().length-1])},publishDraft:function(){try{var t=s.createPublicationContent(I().entity());r.selectSiteMapNode({module:e,okTitle:"Veröffentlichen"}).then(function(e){e.dialogResult&&o.publish(t,e.selectedNode).fail(function(e){alert(e.message)})})}catch(n){alert(n.message)}},refresh:function(){m()},deleteDraft:function(){T.execute(F().draftId())},handleKeyDown:function(e){var t=e.keyCode;(t===f.keys.UP||t===f.keys.DOWN)&&(e.preventDefault(),t===f.keys.UP&&_.selectPreviousDraft(),t===f.keys.DOWN&&_.selectNextDraft())}},R=$(window);return N.prototype.scrollIntoView=function(){this.scrollIntoViewRequest.trigger()},N.prototype.formatDate=function(e){return i(e).calendar()},_});
define('modules/draft/viewmodels/templateGallery',["ko","../datacontext","../module","breeze","entityManagerProvider","durandal/system","infrastructure/serverUtil"],function(e,t,n,r,i,a,o){function s(e,t,n,r){this.title=e,this.name=t,this.template=n,this.icon=r}function l(){return a.defer(function(n){var r=t.getTemplates();u().then(function(t){var i=e.utils.arrayMap(t,function(e){var t=c(e.TemplateContent());return new s(e.Name(),e.Name(),t,o.mapPath("~/App/modules/draft/images/Template 3.png"))}),a=e.utils.arrayMap(r,function(e){var t=o.mapPath("~/App/modules/draft/images/"+e.name+".png");return new s(e.name,e.name,e,t)}),l=a.concat(i);d(l),n.resolve()}).fail(n.reject)})}function u(){var e=(new p).from("Websites").expand("DraftTemplates");return h.executeQuery(e).then(function(e){return e.results[0].DraftTemplates()})}function c(e){var t;try{t=JSON.parse(e)}catch(n){a.log(n.message)}return t}var d=e.observableArray(),f=e.observable(),p=r.EntityQuery,h=i.createManager(),m=e.observable();return{activate:function(){m(""),f(null),l()},listItems:d,selectedItem:f,draftName:m,selectTemplate:function(e){f(e)},createDraft:function(){if(f()){var e="#drafts/create/"+f().name,t=[];m()&&t.push("name="+escape(m()));var r=f().template;r.parameters&&r.parameters.forEach(function(e){e.value&&t.push(e.name+"="+escape(e.value))}),t.length&&(e+="?"+t.join("&")),n.router.navigate(e)}},cancel:function(){n.router.navigate("#drafts")}}});
...
define('modules/sitemap/viewmodels/index',["../module","ko","plugins/router","durandal/system","durandal/app","localization","./siteMapViewModel","./publicationViewModel","infrastructure/publicationService","authentication","../datacontext","durandal/composition","moment"],function(e,t,n,r,i,a,o,s,l,u,c,d,f){function p(e){w(e)&&c.fetchSiteMapNode(e.Id()).then(function(){E()&&E().refreshTree(),v()})}function h(e){P(null),e&&e.fetchTree().then(function(){if(P()){var t=e.tree().findNodeByKey(P().Id());if(t)return t.selectNode(),void 0}e.selectRootNode()})}function m(e){R(null),v(),g(e)}function v(){_(null),P()&&P().ContentId()&&c.fetchPublication(P().ContentId()).then(function(){var e=new s(P());_(e)}).fail(k)}function g(e){L(null),e&&L(new S(e))}function b(e){var n=t.utils.arrayFirst(O.siteMapVersions(),function(t){return t.entity()===e});E(n)}function y(e){var t=new o(e);return t.selectedNodeChanged=function(e){e&&P(e.entity())},t}function w(e){return E()&&E().containsNode(e)}function k(e){r.log(e.message),alert(e.message)}function x(e){var t=E();if(t&&e){var n=e.nextNode()||e.previousNode()||e.ParentNode();c.deleteSiteMapNode(e).then(function(){t.refreshTree(),n&&t.selectNodeByKey(n.Id()),i.trigger("caps:sitemapnode:deleted",e)}).fail(k)}}function N(){$(window).on("keydown",O.handleKeyDown)}function C(){$(window).off("keydown",O.handleKeyDown)}function D(){d.current.complete(function(){U.trigger("forceViewportHeight:refresh")})}function F(){c.fetchFirstWebsite().then(function(e){T(e.results[0]),b(T().latestSiteMap())}).fail(k)}function I(e){c.fetchSiteMapNodeByContentId(e).then(function(e){if(!e.results.length)return F(),void 0;var t=e.results[0],n=t.SiteMap();T(n.Website()),b(n),P(t)}).fail(k)}function M(e){var n=this;n.entity=e,n.isSelected=t.computed(function(){return R()===n}),n.selectTeaser=function(){R(n),g(n.entity)}}function S(n){var r=this;r.entity=n,r.supportedTranslations=a.website.supportedTranslations(),r.edit=function(){n&&e.router.navigate("#sitemap/edit/"+n.Id())},r.editTranslation=function(t){n&&e.router.navigate("#sitemap/translate/"+n.Id()+"/"+t.culture)},r.createTeaser=function(){if(n){var e=n.SiteMap().Id(),t=n.SiteMap().rootNodes()[0].Id();l.createTeaser(e,t,n.Id())}},r.canCreateTeaser=function(){return n?"ROOT"==n.NodeType()||n.hasTeasers()?!1:n.isTeaser()?!1:!0:!1},r.deleteTeaser=function(){var e="Aufmacher löschen",t="Abbrechen";i.showMessage('Soll der Aufmacher "'+r.entity.localeTitle("de")+'" wirklich gelöscht werden?',"Aufmacher löschen",[e,t]).then(function(t){t===e&&x(r.entity)})},r.hasOptions=t.computed(function(){return r.entity.isTeaser()||r.canCreateTeaser()}),r.hasContent=t.computed(function(){return n&&n.Content()}),r.contentSummary=t.computed(function(){if(!n.ContentId())return"Kein Inhalt festgelegt";var e=n.Content();return e?e.EntityType()+" #"+e.EntityKey()+" (v."+e.ContentVersion()+")":""}),r.authorSummary=t.computed(function(){if(!n.ContentId()||!n.Content())return"";var e=n.Content();return e.AuthorName()+" "+f(e.ContentDate()).fromNow()}),r.selectContent=function(){function t(e){l.setNodeContent(r.entity.Id(),e).fail(function(e){alert(e.message)})}V=!1,i.selectContent({module:e}).then(function(e){e.dialogResult&&t(e.selectedContent)}).finally(function(){V=!0})},r.editContent=function(){n.ContentId()&&n.Content()&&i.editContent(n.Content().EntityType(),n.Content().EntityKey())}}var T=t.observable(),E=t.observable(),P=t.observable(),_=t.observable(),R=t.observable(),L=t.observable(),A=!1,V=!1;E.subscribe(h),P.subscribe(m),i.on("caps:sitemapnode:saved",function(e){w(e)&&c.fetchSiteMapNode(e.Id())}),i.on("caps:publication:created",p),i.on("caps:publication:refreshed",p),e.on("module:activate",function(){V&&(N(),D())}),e.on("module:deactivate",function(){V&&C()});var O={website:T,siteMapVersions:t.computed(function(){var e=T()?T().sortedSiteMapVersions():[];return t.utils.arrayMap(e,y)}),selectedSiteMap:E,selectedNode:P,selectedPublication:_,properties:L,teasers:t.computed(function(){if(!P())return[];var e=t.utils.arrayFilter(P().childNodes(),function(e){return e.isTeaser()});return t.utils.arrayMap(e,function(e){return new M(e)})}),activate:function(e){A||(A=!0,e&&e.p||F()),e&&e.p&&I(e.p),N(),D(),V=!0},shouldActivate:function(){return!0},deactivate:function(){C(),V=!1},createSiteMapVersion:function(){c.createNewSiteMapVersion(T()).then(b).fail(k)},deleteSiteMapVersion:function(){var e="Sitemap-Version verwerfen",t="Abbrechen",n=E().entity();n&&i.showMessage("Soll diese Version wirklich verworfen werden?","Sitemap-Version verwerfen?",[e,t]).then(function(t){if(t===e){var r=n.nextVersion()||n.previousVersion();b(r),c.deleteSiteMapVersion(n).fail(k)}})},publishSiteMapVersion:function(){c.publishSiteMap(E().entity(),u.user().userName())},createSiteMapNode:function(){E()&&P()&&c.createSiteMapNode(E().entity(),P()).then(function(e){siteMap.refreshTree(),siteMap.selectNodeByKey(e.Id())}).fail(k)},deleteSiteMapNode:function(){var e="Seite löschen",t="Abbrechen";i.showMessage('Soll die Seite "'+P().localeTitle("de")+'" wirklich gelöscht werden?',"Seite löschen",[e,t]).then(function(t){t===e&&x(P())})},editWebsite:function(){n.navigate("#website")},moveSelectedNodeUp:function(){P()&&(P().moveUp(),c.saveChanges().then(function(){E()&&E().refreshTree()}))},moveSelectedNodeDown:function(){P()&&(P().moveDown(),c.saveChanges().then(function(){E()&&E().refreshTree()}))},moveSelectedNode:function(){function t(e){return!e.isTeaser()&&e.Id()!==P().Id()}if(E()){var n=E(),r=P();i.selectSiteMapNode({module:e,nodeFilter:t,siteMapId:n.entity().Id(),canSelectSiteMap:!1}).then(function(e){e.dialogResult&&e.selectedNode&&e.selectedNode.Id()!==r.ParentNodeId()&&(r.reparent(e.selectedNode),c.saveChanges().then(function(){n.refreshTree(),n.tree().selectedNode().ensureVisible()}))})}},handleKeyDown:function(e){V&&E().tree().handleKeyDown(e)}},U=$(window);return O});
