...
define('modules/sitemap/viewmodels/index',["../module","ko","infrastructure/datacontext","plugins/router","entityManagerProvider","breeze","durandal/system","durandal/app","localization","infrastructure/contentReferences","infrastructure/urlHelper","infrastructure/treeViewModel","moment","./siteMapViewModel","infrastructure/publicationService","authentication"],function(e,t,n,r,i,a,o,s,l,u,c,d,f,p,h,m){function v(e){w(e)&&x(e.Id()).then(function(){M()&&M().refreshTree(),g()})}function g(){if(T(null),I()&&I().ContentId()){var e=(new N).from("Publications").where("Id","==",I().ContentId()).expand("Translations, ContentParts.Resources, Files.Resources.FileVersion.File");D.executeQuery(e).then(function(){var e=new C(I());T(e)}).fail(function(e){alert(e.message)})}b()}function b(){if(S(null),I()){var e=t.utils.arrayFilter(I().childNodes(),function(e){return"teaser"===e.NodeType().toLowerCase()});S(e)}}function y(e){return t.utils.arrayFirst(L.sitemaps(),function(t){return t.entity()===e})}function w(e){var t=M();return e&&t&&e.SiteMapId()===t.entity().Id()}function k(){var e=(new N).from("Websites").expand("SiteMapVersions").take(1);return D.executeQuery(e)}function x(e){var t=(new N).from("SiteMapNodes").where("Id","==",e).expand("Resources");return D.executeQuery(t)}function C(e){var n=this;n.sitemapNode=e,n.template=t.observable(),e&&e.Content()&&n.template(e.Content().template()),n.findContentPart=function(e){if(I()&&I().Content()){var t=I().Content().getContentPart(e.name);if(t){var n=I().Content(),r=t.getResource("de").Content();return _.replaceReferences(n,r,"de")}}return""}}var D=i.createManager(),N=a.EntityQuery,F=t.observable(),M=t.observable(),I=t.observable(),S=t.observableArray(),T=t.observable(),E=l.website.supportedTranslations(),P=!1,_=new u({replaceFileReference:function(e,t){var n=e.context,r=n.findFile(e.fileName),i=r.getResource(t),a=null!==i?i.FileVersion():void 0;return c.getFileUrl(e.fileName,a,e.query)},replacePublicationReference:function(e,t){return c.getPublicationUrl(e.id,t,e.query)}});M.subscribe(function(e){I(null),e&&e.fetchTree().then(function(){e.entity().rootNodes().length&&e.selectNodeByKey(e.entity().rootNodes()[0].Id())})}),I.subscribe(g),s.on("caps:sitemapnode:saved",function(e){w(e)&&x(e.Id())}),s.on("caps:publication:created",v),s.on("caps:publication:refreshed",v);var L={website:F,sitemaps:t.computed(function(){var e=F()?F().sortedSiteMapVersions():[];return t.utils.arrayMap(e,function(e){var t=new p(e,D);return t.selectedNodeChanged=function(e){e&&I(e.entity())},t})}),selectedSiteMap:M,selectedNode:I,teasers:S,supportedTranslations:E,contentPreview:T,activate:function(){P||(P=!0,k().then(function(e){F(e.results[0]),M(y(F().latestSiteMap()))}))},createSiteMapVersion:function(){function e(e){var t=e.createEntity("DbSiteMap",{WebsiteId:F().Id(),Version:n}),r=e.createEntity("DbSiteMapNode",{NodeType:"ROOT",Name:"HOME"}),i=r.getOrCreateResource("de",e);return r.SiteMapId(t.Id()),i.Title("Startseite"),e.addEntity(r),t}try{if(F()){var t=F().latestSiteMap(),n=t?t.Version()+1:1,r=t?t.createNewVersion(n,D):e(D);D.saveChanges().then(function(){M(y(r))}).fail(function(e){o.log(e)})}}catch(i){alert(i.message)}},deleteSiteMapVersion:function(){var e="Sitemap-Version verwerfen",t="Abbrechen";s.showMessage("Soll diese Version wirklich verworfen werden?","Sitemap-Version verwerfen?",[e,t]).then(function(t){if(t===e){var n=M().entity();if(n){var r=n.nextVersion()||n.previousVersion();try{n.setDeleted(),M(y(r))}catch(i){alert("Die Version konnte nicht gelöscht werden.")}D.saveChanges().fail(function(e){alert(e.message)})}}})},publishSiteMapVersion:function(){M().entity().PublishedFrom(new Date),M().entity().PublishedBy(m.user().userName()),D.saveChanges()},createSiteMapNode:function(){var e=M();if(e&&I()){var t=D.createEntity("DbSiteMapNode",{NodeType:"PAGE"});D.addEntity(t),t.ParentNodeId(I().Id()),t.SiteMapId(e.entity().Id());var n=t.getOrCreateResource("de",D);n.Title("Seite "+(new Date).toLocaleTimeString()),D.saveChanges().then(function(){e.refreshTree(),e.selectNodeByKey(t.Id())}).fail(function(e){alert(e.message)})}},deleteSiteMapNode:function(){function e(e){return e.setDeleted(),D.saveChanges()}var t=M();if(t&&I()){var n="Seite löschen",r="Abbrechen";s.showMessage("Soll die Seite wirklich gelöscht werden?","Seite löschen",[n,r]).then(function(r){if(r===n){var i=I(),a=i.nextNode()||i.previousNode()||i.ParentNode();e(i).then(function(){t.refreshTree(),a&&t.selectNodeByKey(a.Id())}).fail(function(e){alert(e.message)})}})}},editWebsite:function(){r.navigate("#website")},editTranslation:function(t){I()&&e.router.navigate("#sitemap/translate/"+I().Id()+"/"+t.culture)},editSiteMapNode:function(){I()&&e.router.navigate("#sitemap/edit/"+I().Id())},moveSelectedNodeUp:function(){I()&&(I().moveUp(),D.saveChanges().then(function(){M()&&M().refreshTree()}))},moveSelectedNodeDown:function(){I()&&(I().moveDown(),D.saveChanges().then(function(){M()&&M().refreshTree()}))},moveSelectedNode:function(){function t(e){return e.Id()!==I().Id()}if(M()){var n=M(),r=I();s.selectSiteMapNode({module:e,nodeFilter:t,siteMapId:n.entity().Id(),canSelectSiteMap:!1}).then(function(e){e.dialogResult&&e.selectedNode&&e.selectedNode.Id()!==r.ParentNodeId()&&(r.reparent(e.selectedNode),D.saveChanges().then(function(){n.refreshTree(),n.tree().selectedNode().ensureVisible()}))})}},createTeaser:function(){if(I()){var e=M().entity().Id(),t=M().tree().root.childNodes()[0].entity().Id();h.createTeaser(e,t,I().Id())}}};return L});
